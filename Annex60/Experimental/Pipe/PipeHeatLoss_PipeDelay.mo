...
equation
  ...
  connect(reverseHeatLoss.tau, pDETime_massFlow.tau) annotation (Line(
      points={{-64,10},{-64,18},{22,18},{22,-42},{11,-42}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(pDETime_massFlow.tau, heatLoss.tau) annotation (Line(
      points={{11,-42},{22,-42},{22,18},{44,18},{44,10}},
      color={0,0,127},
      smooth=Smooth.None));
