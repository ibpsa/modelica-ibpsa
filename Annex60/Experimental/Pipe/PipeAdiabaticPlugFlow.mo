...
equation
  ...
  connect(port_a, vol1.ports[1])
    annotation (Line(points={{-100,0},{-72,0},{-72,6}}, color={0,127,255}));
  connect(res.port_a, vol1.ports[2])
    annotation (Line(points={{-40,0},{-68,0},{-68,6}}, color={0,127,255}));
  connect(senTemDelay.port_b, vol.ports[1])
    annotation (Line(points={{50,0},{68,0},{68,4}}, color={0,127,255}));
  connect(port_b, vol.ports[2]) annotation (Line(points={{100,0},{88,0},{72,0},
          {72,4}}, color={0,127,255}));
  annotation (
