...
package Events "Checking specific implementations for number of events"
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Example to compare the amount of events created and CPU time for pipes with delay tracking in each heat loss operator (more CPU-time required) and on the pipe level. This example used to contain the component with single delay tracker.</span></p>
</html>",   revisions="<html>
<ul>
<li>November 11, 2015 by Bram van der Heijde:<br>First implementation of event and CPU time comparison</li>
</ul>
</html>"),
      __Dymola_experimentSetupOutput);
  end DelayInPipe;

  model DelayInHeatloss
    "For comparison of events generated and CPU time in A60 implementation"
    import Annex60;
    extends Modelica.Icons.Example;
  ...
  __Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Experimental/PipeAdiabatic/PipeAdiabatic_TStep.mos"
      ...
      Documentation(info="<html>
<p>Example to compare the amount of events created and CPU time for pipes with delay tracking in each heat loss operator (more CPU-time required) and on the pipe level. This example used to contain the component with duplicated delay tracker.</p>
</html>",   revisions="<html>
<ul>
