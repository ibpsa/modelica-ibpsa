...
package Components "Wrappers for supply, pipe and demand elements in Aachen Use Case"
  ...
  model SupplySource "A simple supply model with source"
    ...
    Annex60.Fluid.Sensors.TemperatureTwoPort T_supply(redeclare package Medium =
          Medium, m_flow_nominal=1) "Supply flow temperature"
...
public
    Annex60.Fluid.Sensors.TemperatureTwoPort senTem_a(redeclare package Medium =
          Medium, m_flow_nominal=m_flow_nominal) "Temperature at pipe's port a"
      annotation (Placement(transformation(extent={{-86,-10},{-66,10}})));
    Annex60.Fluid.Sensors.TemperatureTwoPort senTem_b(redeclare package Medium =
          Medium, m_flow_nominal=m_flow_nominal) "Temperature at pipe's port b"
...
<li>December 12, 2016 by Marcus Fuchs:<br>First implementation. </li>
  ...
  model DemandSink "Simple demand model"
    ...
    Annex60.Fluid.Sensors.TemperatureTwoPort senT_supply(
      redeclare package Medium = Medium,
      m_flow_nominal=m_flow_nominal,
      tau=1) "Incoming supply temperature from DH network"
