...
model AachenGeneric_small_vec
  ...
  Components.SupplySource supplysupply(
   ...
   Annex60.Experimental.Pipe.PipeHeatLossMod
                      pipe65136519(
    redeclare package Medium = Medium,
    ...
    nPorts=1)
     ...
     Annex60.Experimental.Pipe.PipeHeatLossMod pipe65136541(
    redeclare package Medium = Medium,
    ...
    nPorts=1)
     ...
     Annex60.Experimental.Pipe.PipeHeatLossMod pipe65136520(
    redeclare package Medium = Medium,
    ...
    nPorts=1)
     ...
     Annex60.Experimental.Pipe.PipeHeatLossMod pipe64146415(
    redeclare package Medium = Medium,
