...
model Validation3Rooms
  ...
  Annex60.Airflow.Multizone.MediumColumn colOutTop(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=Airflow.Multizone.Types.densitySelection.fromBottom)
  ...
  Annex60.Airflow.Multizone.MediumColumn colEasInBot(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=Airflow.Multizone.Types.densitySelection.fromTop)
...
equation
  ...
  connect(conEas.port_b, volEas.heatPort) annotation (Line(
      ...
      color={191,0,0},
      smooth=Smooth.None));
  connect(sine.y, dooOpeClo.y) annotation (Line(
      points={{-21,-8},{-12,-8},{-12,-44},{-2,-45}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation (
