...
model Floor
  ...
  parameter SI.Temperature TRoom = 298.15
    "Indoor air temperature of room in K";
  parameter SI.Temperature THallway = 293.15
    "Indoor air temperature of hallway in K";
  parameter SI.Temperature TStaircase = 293.15
    "Indoor air temperature of staircase in K";
  parameter SI.Height heightRooms = 3 "Height of rooms in m";

  parameter SI.Length lengthZone = 5 "Length of room in m";
  parameter SI.Length widthZone = 5 "Width of room in m";
  parameter SI.Length widthHallway = 3 "Width of room in m";
