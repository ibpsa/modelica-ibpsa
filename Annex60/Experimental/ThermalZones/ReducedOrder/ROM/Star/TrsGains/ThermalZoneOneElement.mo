...
equation
  ...
  connect(intGainsRad, temperatureSensor.port) annotation (Line(points={{230,100},
          {110,100},{-8,100},{-8,50},{4,50},{4,60}}, color={191,0,0}));
  connect(radHeatSol.port, temperatureSensor.port) annotation (Line(points={{-158,
          146},{-90,146},{-10,146},{-10,44},{6,44},{6,60},{4,60}}, color={191,0,
          0}));
