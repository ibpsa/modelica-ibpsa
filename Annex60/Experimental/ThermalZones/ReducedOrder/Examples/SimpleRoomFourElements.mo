...
equation
  ...
  connect(aggWindow.y, thermalZoneFourElements.solRad) annotation (Line(points=
          {{48.7,56},{54,56},{54,44},{40,44},{40,30.8},{45,30.8}}, color={0,0,
          127}));
  ...
  connect(weaBus.TBlaSky, eqAirTemp.TBlaSky) annotation (Line(
      ...
      index=-1,
      extent={{-6,3},{-6,3}}));
  connect(machinesConv.port, thermalZoneFourElements.intGainsConv) annotation (
      Line(points={{68,-74},{82,-74},{96,-74},{96,19.8},{91,19.8}}, color={191,
          0,0}));
  connect(personsConv.port, thermalZoneFourElements.intGainsConv) annotation (
  ...
  connect(TSoil.y, prescribedTemperatureFloor.T) annotation (Line(points={{79.6,
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
            -100},{100,100}})), Documentation(info="<html>
              ...
              <a href=\"Annex60.Experimental.ThermalZones.ReducedOrder.ROM.ThermalZoneFourElements\">ThermalZoneFourElements</a> 
              in combination with 
