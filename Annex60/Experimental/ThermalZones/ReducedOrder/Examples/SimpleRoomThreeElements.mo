...
model SimpleRoomThreeElements "Illustrates the use of ThermalZoneThreeElements"
  ...
  ReducedOrderZones.ThreeElements thermalZoneThreeElements(
    VAir=52.5,
    alphaExt=2.7,
    alphaWin=2.7,
    gWin=1,
...
equation
  ...
  <a href=\"Annex60.Experimental.ThermalZones.ReducedOrder.ROM.ThermalZoneThreeElements\">
  Annex60.Experimental.ThermalZones.ReducedOrder.ROM.ThermalZoneThreeElements</a>
  in combination with
