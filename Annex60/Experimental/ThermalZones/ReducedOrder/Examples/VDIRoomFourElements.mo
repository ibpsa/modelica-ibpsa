...
model VDIRoomFourElements "VDI 6007 Test Case 2 model with 4 element model"

  ROM.ThermalZoneFourElements thermalZoneTwoElements(
    VAir=52.5,
    alphaExt=2.7,
    alphaWin=2.7,
    gWin=1,
...
equation
  ...
  connect(thermalConductorWall.solid, thermalZoneTwoElements.roof) annotation (
      Line(points={{36,1},{40,1},{40,48},{66,48},{66,33},{66.8,33}}, color={191,
          0,0}));
