...
model SimpleRoomOneElement
  "Illustrates the use of ThermalZoneOneElement"
...
equation
  ...
  connect(aggWindow.y, thermalZoneOneElement.solRad)
    annotation (Line(points={{
  ...
  connect(const.y, eqAirTemp.sunblind)
    annotation (Line(points={{-13.7,17},{-12,
  ...
  connect(solRad.y, eqAirTemp.HSol)
    annotation (Line(points={{-27.5,11},{-26,11},
  ...
  <a href=\"Annex60.Experimental.ThermalZones.ReducedOrder.ROM.ThermalZoneOneElement\">ThermalZoneOneElement</a>
  in combination with
