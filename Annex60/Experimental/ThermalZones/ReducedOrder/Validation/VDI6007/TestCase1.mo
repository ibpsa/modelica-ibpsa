...
equation
  ...
  connect(thermalZoneTwoElements.intGainsConv, machinesConv.port) annotation (
      Line(points={{91,19.8},{96,19.8},{96,-74},{68,-74}}, color={191,0,0}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
            -100},{100,100}})), Documentation(info="<html>
<p><span style=\"font-family: MS Shell Dlg 2;\">Test Case 1 of the VDI6007 Part 1: <a name=\"result_box\">C</a>alculation of indoor air temperature excited by a convective heat source for room version S.</span></p>
...
<p><br><span style=\"font-family: MS Shell Dlg 2;\">This test case is thought to test basic functionalities.</span></p>
</html>"),
    experiment(
      StopTime=5.184e+006,
      Interval=3600,
