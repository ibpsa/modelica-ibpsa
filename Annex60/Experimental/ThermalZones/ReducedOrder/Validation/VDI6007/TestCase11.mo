...
model TestCase11 "VDI 6007 Test Case 11 model"
  ...
  Modelica.Blocks.Sources.CombiTimeTable reference(
    ...
    table=[3600,22,0; 7200,22,0; 10800,22,0; 14400,22,0; 18000,22,0; 21600,24.9,
        500; 25200,25.2,500; 28800,25.6,500; 32400,25.9,500; 36000,26.2,500;
        39600,26.5,500; 43200,26.8,500; 46800,27,464; 50400,27,397; 54000,27,
        333; 57600,27,272; 61200,27,215; 64800,25.3,-500; 68400,25.2,-500;
...
equation
  ...
  connect(setTemp.y[1], hea.TSet)
    annotation (Line(points={{-33.2,-20},{-32,-20},
    {-32,-36},{-26,-36}},color={0,0,127}));
