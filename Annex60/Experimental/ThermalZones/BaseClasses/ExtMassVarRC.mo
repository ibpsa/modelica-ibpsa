...
model ExtMassVarRC "Wall consisting of variable number of RC elements"
  ...
  parameter Modelica.SIunits.ThermalResistance RExt[n]
    "Vector of resistances for each RC-element, from port_a to port_b" annotation(Dialog(group="Thermal mass"));
  parameter Modelica.SIunits.ThermalResistance RExtRem
    "Resistance of remaining resistor RExtLast between capacitance n and port_b"
                                                                                 annotation(Dialog(group="Thermal mass"));
  parameter Modelica.SIunits.HeatCapacity CExt[n]
    "Vector of heat capacity of thermal masses for each RC-element, from port_a to port_b"
                                                                                           annotation(Dialog(group="Thermal mass"));
