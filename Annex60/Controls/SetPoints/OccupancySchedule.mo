...
block OccupancySchedule "Occupancy schedule with look-ahead"
  ...
  parameter SI.Time period =   86400 "End time of periodicity";
...
protected
  ...
  output SI.Time offSet=integer(time/period)*period
  ...
  output SI.Time tOcc "Time when next occupancy starts";
  output SI.Time tNonOcc "Time when next non-occupancy starts";
