...
package Water "Package with model for liquid water with constant density"
  ...
  redeclare model BaseProperties "Base properties"
    ...
    SI.Density d=d_const "Density of medium";
    SI.MassFraction[nX] X={1}
      "Mass fractions (= (component mass)/total mass  m_i/m)";
    final SI.SpecificHeatCapacity R=0
      "Gas constant (of mixture if applicable)";
    final SI.MolarMass MM=MM_const
...
<a href=\"modelica://Annex60.Media.Specialized.Water.TemperatureDependentDensity\">
Annex60.Media.Specialized.Water.TemperatureDependentDensity</a> which may have considerably higher computing time.
</p>
<p>
...
<code>SI.Temperature</code> to <code>Temperature</code>.
