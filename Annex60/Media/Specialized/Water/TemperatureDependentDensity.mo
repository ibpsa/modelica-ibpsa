...
package TemperatureDependentDensity
  ...
  constant SI.SpecificHeatCapacity cp_const = 4184
...
protected
  final constant SI.SpecificHeatCapacity cv_const = cp_const
    "Specific heat capacity at constant volume";

  constant SI.VelocityOfSound a_const=1484
    "Constant velocity of sound";
  constant SI.MolarMass MM_const=0.018015268 "Molar mass";
...
function kinematicViscosity "Return the kinematic viscosity"
  ...
  input SI.Temperature T "Temperature";
  output SI.KinematicViscosity kinVis "Kinematic viscosity";
algorithm
  kinVis := smooth(1,
  if T < 278.15 then
