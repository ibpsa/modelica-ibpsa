within Annex60.Media.Specialized.Water.Examples;
model WaterProperties_pT
  ...
  extends Annex60.Media.Examples.BaseClasses.FluidProperties(
    redeclare package Medium =
      Annex60.Media.Specialized.Water.ConstantProperties_pT (
...
equation
  ...
  basPro.state.T=T;
   ...
   __Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Media/Specialized/Water/Examples/WaterProperties_pT.mos"
        "Simulate and plot"),
