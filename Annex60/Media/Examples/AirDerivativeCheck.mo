...
model AirDerivativeCheck "Model that tests the derivative implementation"
  extends Modelica.Icons.Example;
   ...
   package Medium = Annex60.Media.Air;
    ...
    SI.MassFraction X[1] "Water vapor mass fraction";

    SI.SpecificEnthalpy hLiqSym "Liquid phase enthalpy";
    SI.SpecificEnthalpy hLiqCod "Liquid phase enthalpy";
    SI.SpecificEnthalpy hSteSym "Water vapor enthalpy";
    SI.SpecificEnthalpy hSteCod "Water vapor enthalpy";
    SI.SpecificEnthalpy hAirSym "Dry air enthalpy";
    SI.SpecificEnthalpy hAirCod "Dry air enthalpy";
