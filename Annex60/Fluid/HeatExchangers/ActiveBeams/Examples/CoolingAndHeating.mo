...
model CoolingAndHeating
  ...
  Annex60.Controls.Continuous.LimPID conHea(
    yMax=0.094,
    Td=0,
    reverseAction=false,
    Ti=100,
  ...
  Annex60.Controls.Continuous.LimPID conCoo(
    yMax=0.094,
    reverseAction=true,
    Td=0,
    k=0.5,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -120},{120,120}})),experiment(Tolerance=1e-6, StartTime=0.0, StopTime=172800),__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/CoolingAndHeating.mos"
        "Simulate and plot"),
