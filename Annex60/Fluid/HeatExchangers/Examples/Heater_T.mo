...
model Heater_T
  ...
  extends Annex60.Fluid.HeatExchangers.Examples.BaseClasses.Heater(vol(
...
First implementation.
    ...
    __Dymola_Commands(file= "modelica://Annex60/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/Heater_T.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-05));
