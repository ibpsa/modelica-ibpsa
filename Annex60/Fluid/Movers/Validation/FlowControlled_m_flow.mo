...
model FlowControlled_m_flow
 ...
 extends Annex60.Fluid.Movers.Validation.BaseClasses.FlowMachine_ZeroFlow(
    ...
    redeclare Annex60.Fluid.Movers.FlowControlled_m_flow floMacDyn(
      redeclare package Medium = Medium,
      m_flow_nominal=m_flow_nominal,
      filteredSpeed=false,
      energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial));
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Movers/Validation/FlowControlled_m_flow.mos"
        "Simulate and plot"),
