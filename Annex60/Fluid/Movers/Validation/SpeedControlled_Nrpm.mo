...
model SpeedControlled_Nrpm "Fan with zero mass flow rate and speed as input"
 ...
 extends Annex60.Fluid.Movers.Validation.BaseClasses.FlowMachine_ZeroFlow(
    gain(k=1500),
    redeclare Annex60.Fluid.Movers.SpeedControlled_Nrpm floMacSta(
      redeclare package Medium = Medium,
      per(pressure(V_flow={0,m_flow_nominal,2*m_flow_nominal}/1.2,
                  dp={2*dp_nominal,dp_nominal,0})),
      filteredSpeed=false,
      energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial),
    redeclare Annex60.Fluid.Movers.SpeedControlled_Nrpm floMacDyn(
      redeclare package Medium = Medium,
      per(pressure(V_flow={0,m_flow_nominal,2*m_flow_nominal}/1.2,
                   dp={2*dp_nominal,dp_nominal,0})),
      filteredSpeed=false,
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Movers/Validation/SpeedControlled_Nrpm.mos"
        "Simulate and plot"),
