...
model PumpCurveConstruction
  ...
  parameter SI.VolumeFlowRate V_flow_nominal = m_flow_nominal/1000
    "Nominal mass flow rate at zero pump head";

  parameter SI.Pressure dp_nominal = 10000
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Movers/Validation/PumpCurveConstruction.mos"
        "Simulate and plot"),
