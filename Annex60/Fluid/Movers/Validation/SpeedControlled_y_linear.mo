...
model SpeedControlled_y_linear
  ...
  Annex60.Fluid.Sources.Boundary_pT sou1(
    ...
    nPorts=1) annotation (Placement(transformation(extent={{-10,-10},{10,10}},
          rotation=180,
        origin={128,90})));
  Annex60.Fluid.FixedResistances.FixedResistanceDpM dp1(
    redeclare package Medium = Medium,
  ...
  Annex60.Fluid.Sources.Boundary_pT sou3(
    redeclare package Medium = Medium,
    use_p_in=false,
    p(displayUnit="Pa") = 300000 + 0.01*dp_nominal,
    T=293.15,
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Movers/Validation/SpeedControlled_y_linear.mos"
        "Simulate and plot"),
