...
partial model PowerInterface
  ...
  input Modelica.SIunits.Efficiency eta(min=0, max=1) "Global efficiency";
  input Modelica.SIunits.Efficiency etaHyd(min=0, max=1) "Hydraulic efficiency";
  input Modelica.SIunits.Efficiency etaMot(min=0, max=1) "Motor efficiency";
