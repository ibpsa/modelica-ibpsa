within Annex60.Fluid.Movers.BaseClasses.Validation;
model PowerInterface "Simple model to validate PowerInterface"
  extends Modelica.Icons.Example;
  Annex60.Fluid.Movers.BaseClasses.PowerInterface powCoo(
  ...
  Annex60.Fluid.Movers.BaseClasses.PowerInterface powNonCoo(
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/PowerInterface.mos"
        "Simulate and plot"));
end PowerInterface;
