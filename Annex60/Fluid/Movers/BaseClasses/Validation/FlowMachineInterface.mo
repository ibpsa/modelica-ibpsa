...
model FlowMachineInterface "Simple model to validate FlowMachineInterface"
  ...
  Annex60.Fluid.Movers.BaseClasses.FlowMachineInterface eff(
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/FlowMachineInterface.mos"
        "Simulate and plot"));
