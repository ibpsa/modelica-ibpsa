...
model ControlledFlowMachine "Fans with different control signals as input"
  ...
  extends Annex60.Fluid.Movers.Examples.BaseClasses.ControlledFlowMachine(
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Movers/Examples/ControlledFlowMachine.mos"
        "Simulate and plot"),
