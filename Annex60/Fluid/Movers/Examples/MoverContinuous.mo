...
model MoverContinuous
  ...
  extends MoverParameter(
    pump_Nrpm(inputType=Annex60.Fluid.Types.InputType.Continuous),
    pump_m_flow(inputType=Annex60.Fluid.Types.InputType.Continuous),
    pump_y(inputType=Annex60.Fluid.Types.InputType.Continuous),
    pump_dp(inputType=Annex60.Fluid.Types.InputType.Continuous));
