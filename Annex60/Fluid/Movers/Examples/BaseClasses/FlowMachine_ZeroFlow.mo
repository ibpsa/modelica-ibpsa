...
partial model FlowMachine_ZeroFlow
  ...
  Annex60.Fluid.FixedResistances.FixedResistanceDpM dpSta(
    redeclare package Medium = Medium,
  ...
  Annex60.Fluid.FixedResistances.FixedResistanceDpM dpDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Pressure drop"
  ...
  Annex60.Fluid.FixedResistances.FixedResistanceDpM dpSta1(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Pressure drop"
    annotation (Placement(transformation(extent={{-20,70},{0,90}})));
  Annex60.Fluid.FixedResistances.FixedResistanceDpM dpDyn1(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Pressure drop"
