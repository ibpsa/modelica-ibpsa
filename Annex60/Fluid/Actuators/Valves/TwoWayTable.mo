...
model TwoWayTable "Two way valve with linear flow characteristics"
  ...
  // Since the flow model Annex60.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow computes
...
initial equation
  ...
  assert(Annex60.Utilities.Math.Functions.isMonotonic(
...
Annex60.Fluid.Actuators.Valves.TwoWayLinear</a> provides a more
