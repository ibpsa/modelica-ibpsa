 ...
 package Medium = Annex60.Media.Air
  ...
  Dampers.MixingBox mixBox(
    ...
    redeclare package Medium = Medium) "mixing box"
            ...
            -22},{34,-2}}, rotation=0)));
    Annex60.Fluid.Sources.Boundary_pT bouIn(             redeclare package
      Medium = Medium, T=273.15 + 10,
    use_p_in=true,
    nPorts=2)                                             annotation (Placement(
        transformation(extent={{-60,2},{-40,22}},  rotation=0)));
    Annex60.Fluid.Sources.Boundary_pT bouSup(             redeclare package
      Medium = Medium, T=273.15 + 26,
    use_p_in=true,
    nPorts=1)                                                                       annotation (Placement(
        transformation(extent={{68,-10},{48,10}}, rotation=0)));
    Annex60.Fluid.Sources.Boundary_pT bouRet(             redeclare package
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
            -100},{100,100}})),
             __Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/MixingBox.mos"
        "Simulate and plot"),
