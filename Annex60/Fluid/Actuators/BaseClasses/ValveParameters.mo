...
partial model ValveParameters "Model with parameters for valves"
  ...
  parameter Annex60.Fluid.Types.CvTypes CvData=Annex60.Fluid.Types.CvTypes.OpPoint
    "Selection of flow coefficient"
   annotation(Dialog(group = "Flow Coefficient"));
  parameter Real Kv(
    fixed= if CvData==Annex60.Fluid.Types.CvTypes.Kv then true else false)
    "Kv (metric) flow coefficient [m3/h/(bar)^(1/2)]"
  annotation(Dialog(group = "Flow Coefficient",
                    enable = (CvData==Annex60.Fluid.Types.CvTypes.Kv)));
  parameter Real Cv(
    fixed= if CvData==Annex60.Fluid.Types.CvTypes.Cv then true else false)
  ...
  parameter Modelica.SIunits.Area Av(
   ...
   annotation(Dialog(group = "Flow Coefficient",
                     enable = (CvData==Annex60.Fluid.Types.CvTypes.Av)));
...
protected
  ...
  annotation(Dialog(group = "Flow Coefficient",
                    enable = (CvData==Annex60.Fluid.Types.CvTypes.OpPoint)));
initial equation
  if  CvData == Annex60.Fluid.Types.CvTypes.OpPoint then
  ...
  elseif CvData == Annex60.Fluid.Types.CvTypes.Cv then
    ...
    assert(CvData == Annex60.Fluid.Types.CvTypes.Av, "Invalid value for CvData.
...
<code>Kv</code>,
<code>Cv</code>, or, if
<code>CvData = Annex60.Fluid.Types.CvTypes.OpPoint</code>, based on
<code>m_flow_nominal</code> and <code>dpValve_nominal</code>.
Conversely, if
<code>CvData &lt;&gt; Annex60.Fluid.Types.CvTypes.OpPoint</code>, then
<code>dpValve_nominal</code> is computed based on
<code>Av</code>,
<code>Kv</code>, or
<code>Cv</code>, and the nominal mass flow rate <code>m_flow_nominal</code>.
Therefore, if
<code>CvData &lt;&gt; Annex60.Fluid.Types.CvTypes.OpPoint</code>,
...
<a href=\"modelica://Annex60.Fluid.Actuators.Valves.Examples.TwoWayValveTable\">
Annex60.Fluid.Actuators.Valves.Examples.TwoWayValveTable</a>,
