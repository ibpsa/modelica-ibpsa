...
partial model PartialThreeWayValve "Partial three way valve"
  extends Annex60.Fluid.BaseClasses.PartialThreeWayResistance(
    final mDyn_flow_nominal = m_flow_nominal,
      ...
      Annex60.Fluid.Actuators.BaseClasses.PartialTwoWayValve res1
        constrainedby Annex60.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
          deltaM=deltaM,
          ...
          final CvData=Annex60.Fluid.Types.CvTypes.OpPoint,
      ...
      redeclare replaceable
      Annex60.Fluid.Actuators.BaseClasses.PartialTwoWayValve res3
        constrainedby Annex60.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
          deltaM=deltaM,
          dp(start=dpValve_nominal/2),
          from_dp=from_dp,
