...
model IdealMotor "Ideal motor model with hysteresis"
  ...
  parameter SI.Time tOpe(min=0) = 120 "Opening time";
  parameter SI.Time tClo(min=0) = tOpe "Closing time";
...
the model <a href=\"modelica://Annex60.Fluid.Examples.TwoWayValves\">
Annex60.Fluid.Examples.TwoWayValves</a> sets <code>y=3</code>
