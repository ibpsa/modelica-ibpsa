within Annex60.Fluid.Actuators.Motors.Examples;
model IdealMotor "Test model for IdealMotor"
  extends Modelica.Icons.Example;
  Annex60.Fluid.Actuators.Motors.IdealMotor mot(tOpe=60) "Motor model"
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Actuators/Motors/Examples/IdealMotor.mos"
        "Simulate and plot"),
