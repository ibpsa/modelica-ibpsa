...
model InvertingBasicFlowFunction_dp
 ...
 parameter SI.MassFlowRate m_flow_nominal = 1.5
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Validation/InvertingBasicFlowFunction_dp.mos"
        "Simulate and plot"),
