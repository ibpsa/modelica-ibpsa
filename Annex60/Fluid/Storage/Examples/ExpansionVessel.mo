...
// package Medium = Modelica.Media.Water.WaterIF97OnePhase_ph "Medium model";
 package Medium = Annex60.Media.Water "Medium model";
  ...
  Annex60.Fluid.Storage.ExpansionVessel expVes(
...
equation
  ...
  connect(vol.ports[1], expVes.port_a) annotation (Line(
      ...
      smooth=Smooth.None));
  annotation (
  __Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Storage/Examples/ExpansionVessel.mos"
        "Simulate and plot"),
