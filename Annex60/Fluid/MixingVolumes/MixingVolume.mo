...
<h4>Options</h4>
<ul>
<li>Parameter <code>mSenFactor</code> can be used to increase the thermal mass of this model
...
lump the pipe thermal mass to the fluid volume. By default <code>mSenFactor = 1</code>, hence
