within Annex60.Fluid.HeatPumps.Examples;
model Carnot_TCon
 ...
 package Medium2 = Annex60.Media.Water "Medium model";
  ...
  Annex60.Fluid.HeatPumps.Carnot_TCon heaPum(
...
equation
  ...
  connect(TConLvg.y, heaPum.TSet) annotation (Line(points={{-35,42},{-26,42},{
          -26,9},{-12,9}},
                     color={0,0,127}));
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/HeatPumps/Examples/Carnot_TCon.mos"
        "Simulate and plot"),
    Documentation(
info="<html>
<p>
