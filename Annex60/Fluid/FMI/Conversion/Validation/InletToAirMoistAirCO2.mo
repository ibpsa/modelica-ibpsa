...
model InletToAirMoistAirCO2
  ...
  extends Annex60.Fluid.FMI.Conversion.Validation.InletToAirDryAir(
    redeclare package Medium = Annex60.Media.Air(extraPropertiesNames={"CO2"}));
...
It is identical to
<a href=\"modelica://Annex60.Fluid.FMI.Conversion.Validation.InletToAirMoistAir\">
Annex60.Fluid.FMI.Conversion.Validation.InletToAirMoistAir</a>
except that
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirMoistAirCO2.mos"
        "Simulate and plot"),
