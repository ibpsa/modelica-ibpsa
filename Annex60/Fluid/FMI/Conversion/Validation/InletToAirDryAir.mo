...
model InletToAirDryAir
  ...
  extends Annex60.Fluid.FMI.Conversion.Validation.InletToAirMoistAir(
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirDryAir.mos"
        "Simulate and plot"),
