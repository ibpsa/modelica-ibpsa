...
model HumidifierPrescribed
 ...
 parameter Modelica.SIunits.MassFlowRate mWat_flow_nominal = 0.001
  ...
  Annex60.Fluid.MassExchangers.HumidifierPrescribed hea1(redeclare package
      Medium =
        Medium,
    m_flow_nominal=0.5,
  ...
  Annex60.Fluid.Sources.Boundary_pT sin_1(                       redeclare
    ...
    offset=0) "Control signal"
            ...
            194}}, rotation=0)));
  Annex60.Fluid.MassExchangers.HumidifierPrescribed hea2(
  ...
  Annex60.Fluid.MassExchangers.HumidifierPrescribed hea3(redeclare package
      Medium =
        Medium,
    m_flow_nominal=0.5,
    mWat_flow_nominal=mWat_flow_nominal,
    ...
    m_flow_nominal=0.5)
          ...
          rotation=0)));
  Annex60.Fluid.MassExchangers.HumidifierPrescribed hea4(
                                                 redeclare package Medium =
        Medium,
    m_flow_nominal=0.5,
    mWat_flow_nominal=mWat_flow_nominal,
  ...
  Annex60.Fluid.MixingVolumes.MixingVolume mix1(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
          ...
          rotation=0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass1(                startTime=
        0.3, threShold=0.05)
  ...
  Modelica.Blocks.Sources.RealExpression y2(y=hea1.sta_b.T)
    annotation (Placement(transformation(extent={{40,130},{140,150}}, rotation=
            0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass2(                startTime=
        0.3, threShold=0.05)
  ...
  Annex60.Utilities.Diagnostics.AssertEquality ass3(                startTime=
        0.3, threShold=0.05)
  ...
  Annex60.Utilities.Diagnostics.AssertEquality ass4(                startTime=
        0.3, threShold=0.05)
  ...
  Annex60.Fluid.MassExchangers.HumidifierPrescribed hea5(redeclare package
      Medium =
        Medium,
    m_flow_nominal=0.5,
    mWat_flow_nominal=mWat_flow_nominal,
    ...
    m_flow_nominal=0.5)
          ...
          rotation=0)));
  Annex60.Fluid.MassExchangers.HumidifierPrescribed hea6(
                                                 redeclare package Medium =
        Medium,
    m_flow_nominal=0.5,
    mWat_flow_nominal=mWat_flow_nominal,
  ...
  Annex60.Fluid.MassExchangers.HumidifierPrescribed hea7(redeclare package
      Medium =
        Medium,
    m_flow_nominal=0.5,
    mWat_flow_nominal=mWat_flow_nominal,
    ...
    m_flow_nominal=0.5)
          ...
          rotation=0)));
  Annex60.Fluid.MassExchangers.HumidifierPrescribed hea8(
                                                 redeclare package Medium =
        Medium,
    m_flow_nominal=0.5,
    mWat_flow_nominal=mWat_flow_nominal,
  ...
  Annex60.Fluid.MixingVolumes.MixingVolume mix2(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
            ...
            -160}}, rotation=0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass5(                startTime=
        0.3, threShold=0.05)
  ...
  Modelica.Blocks.Sources.RealExpression y10(
    ...
    annotation (Placement(transformation(extent={{40,-72},{140,-52}}, rotation=
            0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass6(                startTime=
        0.3, threShold=0.05)
  ...
  Modelica.Blocks.Sources.RealExpression y12(
    ...
    annotation (Placement(transformation(extent={{40,-112},{140,-92}}, rotation=
           0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass7(                startTime=
        0.3, threShold=0.05)
  ...
  Modelica.Blocks.Sources.RealExpression y14(
    ...
    annotation (Placement(transformation(extent={{40,-174},{140,-154}},
          rotation=0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass8(                startTime=
        0.3, threShold=0.05)
  ...
  Modelica.Blocks.Sources.RealExpression y16(
    ...
    annotation (Placement(transformation(extent={{40,-214},{140,-194}},
          rotation=0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass9(                startTime=
        0.3, threShold=0.05)
  ...
  Modelica.Blocks.Sources.RealExpression y18(y=hea5.sta_b.T)
    annotation (Placement(transformation(extent={{40,-310},{140,-290}},
          rotation=0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass10(                startTime=
        0.3, threShold=0.05)
  ...
  Modelica.Blocks.Sources.RealExpression y20(y=hea7.sta_a.T)
    annotation (Placement(transformation(extent={{40,-270},{140,-250}},
          rotation=0)));
  Annex60.Utilities.Diagnostics.AssertEquality ass11(threShold=1E-2, startTime=
        0.3)
