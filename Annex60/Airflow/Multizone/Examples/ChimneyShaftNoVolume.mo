...
model ChimneyShaftNoVolume
  ...
  Annex60.Airflow.Multizone.Orifice oriChiTop(
    m=0.5,
    redeclare package Medium = Medium,
  ...
  Annex60.Airflow.Multizone.MediumColumn sha(redeclare package Medium = Medium,
      densitySelection=Annex60.Airflow.Multizone.Types.densitySelection.actual) "Shaft of chimney"
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},
            {140,100}})),
    __Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ChimneyShaftNoVolume.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06),
