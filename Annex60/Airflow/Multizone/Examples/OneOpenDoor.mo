...
model OneOpenDoor "Model with one open and one closed door"
  ...
  Annex60.Airflow.Multizone.DoorDiscretizedOpen dooOpe(redeclare package Medium
  ...
  Modelica.Blocks.Math.Gain Gain1(k=100) annotation (Placement(transformation(
          extent={{-20,60},{0,80}})));
  Annex60.Airflow.Multizone.DoorDiscretizedOperable dooOpeClo(redeclare package
