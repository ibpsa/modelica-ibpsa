...
equation
  ...
  for i in 1:nCom loop
    dV_flow[i] = Annex60.Airflow.Multizone.BaseClasses.powerLaw(
      k=kVal,
      dp=dpAB[i],
      m=m,
...
if the door is open.
Use the model
<a href=\"modelica://Annex60.Airflow.Multizone.DoorDiscretizedOpen\">
Annex60.Airflow.Multizone.DoorDiscretizedOpen</a>
