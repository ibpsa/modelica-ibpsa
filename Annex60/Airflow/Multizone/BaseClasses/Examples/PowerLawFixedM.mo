within Annex60.Airflow.Multizone.BaseClasses.Examples;
model PowerLawFixedM "Test model for power law function"
  ...
  parameter SI.Pressure dp_turbulent(min=0)=5
...
equation
  dp = 10*(-1+2*time);
  V_flow = Annex60.Airflow.Multizone.BaseClasses.powerLaw(
    dp=dp,
    k=k,
    m=m,
    dp_turbulent=dp_turbulent);
  VFixed_flow = Annex60.Airflow.Multizone.BaseClasses.powerLawFixedM(
    k=k,
    dp=dp,
    m=m,
    a=a,
...
experiment(StopTime=1.0),
  __Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Airflow/Multizone/BaseClasses/Examples/PowerLawFixedM.mos"
