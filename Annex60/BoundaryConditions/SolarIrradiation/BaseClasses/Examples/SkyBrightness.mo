...
model SkyBrightness "Test model for sky brightness"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.BaseClasses.RelativeAirMass relAirMas
    "Relative air mass"
     annotation (Placement(transformation(extent={{10,20},{30,40}})));
  Annex60.BoundaryConditions.SolarGeometry.ZenithAngle zen(
    lat=0.34906585039887) "Zenith angle"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  Annex60.BoundaryConditions.SolarIrradiation.BaseClasses.SkyBrightness skyBri
    "Sky brightness"
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/BaseClasses/Examples/SkyBrightness.mos"
        "Simulate and plot"));
end SkyBrightness;
