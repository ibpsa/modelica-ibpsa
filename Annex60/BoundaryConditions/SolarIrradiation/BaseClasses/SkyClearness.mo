...
equation
  tmp1 =  k*zen^3;
  HDifHorBou = Annex60.Utilities.Math.Functions.smoothMax(
                 x1 = HDifHor,
                 x2 = hSmall,
                 deltaX = deltaX);
  ...
  skyCle = Annex60.Utilities.Math.Functions.smoothLimit(
...
<p>
In the <code>Annex60</code> library, <code>HGloHor</code>
