within Annex60.BoundaryConditions.SolarIrradiation.Examples;
model DiffusePerez
  ...
  parameter SI.Angle azi=0.3 "Azi angle";
  parameter SI.Angle til=0.5 "Tilted angle";
  ...
  Annex60.BoundaryConditions.WeatherData.Bus weaBus annotation (Placement(
        transformation(extent={{1,-1},{21,21}}), iconTransformation(extent={{20,
            20},{21,21}})));
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifRoo(
    til=Annex60.Types.Tilt.Ceiling,
    lat=0.6457718232379,
    azi=0.78539816339745) "Diffuse irradiation on roof"
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifFlo(
    til=Annex60.Types.Tilt.Floor,
    lat=0.6457718232379,
    azi=0.78539816339745) "Diffuse irradiation on floor"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifWal(
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/Examples/DiffusePerez.mos"
        "Simulate and plot"),
