within Annex60.BoundaryConditions.SkyTemperature.Examples;
model BlackBody "Test model for black body sky temperature"
  ...
  Annex60.BoundaryConditions.SkyTemperature.BlackBody TBlaSky
  ...
  Annex60.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
      ...
      Placement(transformation(extent={{0,0},{20,20}}), iconTransformation(
          extent={{0,0},{2,2}})));
  Annex60.BoundaryConditions.SkyTemperature.BlackBody TBlaSkyIrr(calTSky=
        Annex60.BoundaryConditions.Types.SkyTemperatureCalculation.HorizontalRadiation)
