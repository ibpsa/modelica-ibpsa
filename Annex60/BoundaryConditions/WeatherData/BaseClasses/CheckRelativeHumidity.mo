...
equation
  relHumOut = Annex60.Utilities.Math.Functions.smoothLimit(
    relHumIn,
    relHumMin,
    relHumMax,
    delta/10);
...
First implementation.
    ...
    Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,
            100}}), graphics={Bitmap(extent={{-74,74},{76,-78}}, fileName=
              "modelica://Annex60/Resources/Images/BoundaryConditions/WeatherData/BaseClasses/relativeHumidity.png")}));
