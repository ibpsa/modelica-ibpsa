...
model SolarTime "Test model for solar time"
  ...
  Annex60.BoundaryConditions.WeatherData.BaseClasses.SolarTime solTim
    "Block that computes the solar time"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  Annex60.BoundaryConditions.WeatherData.BaseClasses.EquationOfTime eqnTim
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/SolarTime.mos"
        "Simulate and plot"));
end SolarTime;
