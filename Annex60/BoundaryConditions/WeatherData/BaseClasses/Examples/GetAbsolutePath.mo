...
model GetAbsolutePath "Test model to get the absolute path of a URI"
  ...
  parameter String f = "modelica://Annex60/package.mo"
   "Name of a file that exists";
  parameter String fAbs=
    Annex60.BoundaryConditions.WeatherData.BaseClasses.getAbsolutePath(uri=f)
    "Absolute path of f";
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/GetAbsolutePath.mos"
        "Simulate and plot"),
