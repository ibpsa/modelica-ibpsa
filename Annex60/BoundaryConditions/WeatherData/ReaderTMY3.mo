within Annex60.BoundaryConditions.WeatherData;
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput pAtm_in(
    ...
    final unit="Pa",
    displayUnit="Pa") if (pAtmSou == Annex60.BoundaryConditions.Types.DataSource.Input)
    "Input pressure"
    annotation (Placement(transformation(extent={{-240,254},{-200,294}}),
        iconTransformation(extent={{-240,254},{-200,294}})));
  //--------------------------------------------------------------
  // Ceiling height
  parameter Annex60.BoundaryConditions.Types.DataSource ceiHeiSou=Annex60.BoundaryConditions.Types.DataSource.File
  ...
  final parameter Modelica.SIunits.Time timZon(displayUnit="h")=
    Annex60.BoundaryConditions.WeatherData.BaseClasses.getTimeZoneTMY3(absFilNam)
    "Time zone";
  ...
  parameter Annex60.BoundaryConditions.Types.SkyTemperatureCalculation
    calTSky=Annex60.BoundaryConditions.Types.SkyTemperatureCalculation.TemperaturesAndSkyCover
...
protected
  ...
  Annex60.BoundaryConditions.WeatherData.BaseClasses.ConvertRelativeHumidity
  ...
  Annex60.BoundaryConditions.WeatherData.BaseClasses.LocalCivilTime locTim(
  ...
  Annex60.BoundaryConditions.WeatherData.BaseClasses.ConvertTime conTim1
...
equation
  ...
  if pAtmSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    pAtm_in_internal = pAtm;
  elseif pAtmSou == Annex60.BoundaryConditions.Types.DataSource.File then
  ...
  if ceiHeiSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    ceiHei_in_internal = ceiHei;
  elseif ceiHeiSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  if totSkyCovSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    totSkyCov_in_internal = totSkyCov;
  elseif totSkyCovSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  if opaSkyCovSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    opaSkyCov_in_internal = opaSkyCov;
  elseif opaSkyCovSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  if TDewPoiSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    TDewPoi_in_internal = TDewPoi;
  elseif TDewPoiSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  if TDryBulSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    TDryBul_in_internal = TDryBul;
  elseif TDryBulSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  elseif relHumSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  if winSpeSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    winSpe_in_internal = winSpe;
  elseif winSpeSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  if winDirSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    winDir_in_internal = winDir;
  elseif winDirSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  if HSou ==  Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
    connect(HGloHor_in, HGloHor_in_internal)
      "Get HGloHor using user input file";
  elseif HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
  ...
  if HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
     connect(HDifHor_in, HDifHor_in_internal)
      "Get HDifHor using user input file";
  elseif  HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
  ...
  if HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor or HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
  ...
  if HInfHorSou == Annex60.BoundaryConditions.Types.DataSource.Parameter then
    HInfHor_in_internal = HInfHor;
  elseif HInfHorSou == Annex60.BoundaryConditions.Types.DataSource.Input then
  ...
  annotation (
    ...
    Icon(coordinateSystem(
        ...
        Text(
          ...
          lineColor={0,0,255}),
        Text(
          visible=(pAtmSou == Annex60.BoundaryConditions.Types.DataSource.Input),
          extent={{-190,216},{-164,184}},
          lineColor={0,0,127},
          textString="p"),
        Text(
          visible=(TDryBulSou == Annex60.BoundaryConditions.Types.DataSource.Input),
          extent={{-194,162},{-118,118}},
          lineColor={0,0,127},
          textString="TDryBul"),
        Text(
          visible=(relHumSou == Annex60.BoundaryConditions.Types.DataSource.Input),
          extent={{-190,92},{-104,66}},
          lineColor={0,0,127},
          textString="relHum"),
        Text(
        visible=(winSpeSou == Annex60.BoundaryConditions.Types.DataSource.Input),
          extent={{-196,44},{-110,2}},
          lineColor={0,0,127},
          textString="winSpe"),
        Text(
          visible=(winDirSou == Annex60.BoundaryConditions.Types.DataSource.Input),
          extent={{-192,-18},{-106,-60}},
          lineColor={0,0,127},
          textString="winDir"),
        Text(
        visible=(HSou ==  Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor),
        extent={{-202,-88},{-112,-108}},
          lineColor={0,0,127},
          textString="HGloHor"),
        Text(visible=(HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor),
        extent={{-202,-142},{-116,-164}},
          lineColor={0,0,127},
          textString="HDifHor"),
        Text(
        visible=(HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor or HSou == Annex60.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor),
...
<li>
Add the file to <code>Annex60/Resources/weatherdata</code> (or to any directory
...
by the model
<a href=\"modelica://Annex60.BoundaryConditions.WeatherData.ReaderTMY3\">
Annex60.BoundaryConditions.WeatherData.ReaderTMY3</a>.
</li>
</ol>
<!-- ============================================== -->
...
<a href=\"modelica://Annex60.BoundaryConditions.Types.RadiationDataSource\">
Annex60.BoundaryConditions.Types.RadiationDataSource</a>,
...
the weather data files in the Annex60 library do not use the data entry from
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://Annex60/Resources/Images/BoundaryConditions/WeatherData/RadiationTimeShift.png\"
border=\"1\" />
</p>
<h4>References</h4>
<ul>
...
<a href=modelica://Annex60.BoundaryConditions.SkyTemperature.Examples.BlackBody>TBlaSky</a> 
are consistent.
This is for
...
<code>file://</code>, <code>modelica://</code> and <code>modelica://Annex60</code>
...
as long as the <code>Annex60</code> library
