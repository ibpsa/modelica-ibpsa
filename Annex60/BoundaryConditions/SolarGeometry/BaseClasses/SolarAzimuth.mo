...
protected
  ...
  constant SI.Time day=86400 "Number of seconds in a day";
  constant SI.Angle polarCircle = 1.1617
...
First implementation.
    ...
    Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,
        ...
        Bitmap(extent={{-90,90},{90,-92}}, fileName=
              "modelica://Annex60/Resources/Images/BoundaryConditions/SolarGeometry/BaseClasses/SolarAzimuth.png")}));
end SolarAzimuth;
