...
model SolarAzimuth "Test model for zenith angle"
  ...
  Annex60.BoundaryConditions.SolarGeometry.BaseClasses.ZenithAngle zen(lat=lat)
    "Zenith angle"
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/SolarAzimuth.mos"
        "Simulate and plot"));
end SolarAzimuth;
