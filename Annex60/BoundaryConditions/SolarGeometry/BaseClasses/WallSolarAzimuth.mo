...
protected
  constant SI.Angle delta = 1*Modelica.Constants.pi/180
    "Small angle";
  constant SI.Angle ninety= Modelica.Constants.pi/2-delta
    "+89 degree";
...
equation
  alt_c=Modelica.Math.cos(Annex60.Utilities.Math.Functions.smoothLimit(
  ...
  verAzi=Modelica.Math.acos(
       Annex60.Utilities.Math.Functions.smoothLimit(x=rat, l=-1+deltaX, u=1-deltaX, deltaX=deltaX/10));

  annotation (Icon(graphics={Bitmap(extent={{-92,92},{92,-92}}, fileName=
              "modelica://Annex60/Resources/Images/BoundaryConditions/SolarGeometry/BaseClasses/WallSolarAzimuth.png")}),
...
<a href=\"modelica://Annex60.HeatTransfer.Windows.BaseClasses.Examples.Overhang\">
Annex60.HeatTransfer.Windows.BaseClasses.Examples.Overhang</a>.
</li>
<li>
