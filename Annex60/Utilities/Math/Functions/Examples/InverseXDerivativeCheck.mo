...
equation
  x = time^3*gain;
  y = Annex60.Utilities.Math.Functions.inverseXRegularized(
    x=  x,
    delta=  delta);
  der(y_comp) = Annex60.Utilities.Math.Functions.BaseClasses.der_inverseXRegularized(x=x,delta=delta,x_der=der(x));
  err = y-y_comp;
...
experiment(
      ...
      StopTime=1,
      Tolerance=1e-08),
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/InverseXDerivativeCheck.mos"
        "Simulate and plot"),
...
<a href=\"modelica://Annex60.Utilities.Math.Functions.BaseClasses.der_smoothTransition\">
Annex60.Utilities.Math.Functions.BaseClasses.der_smoothTransition</a>.
...
<a href=\"modelica://Annex60.Utilities.Math.Functions.BaseClasses.der_inverseXRegularized\">
Annex60.Utilities.Math.Functions.BaseClasses.der_inverseXRegularized</a>. 
</li>
<li>
