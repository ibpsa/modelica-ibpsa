...
algorithm
  psat := Annex60.Media.PerfectGases.MoistAirUnsaturated.saturationPressure(T);
...
Set the medium model to <code>Annex60.Media.PerfectGases.MoistAirUnsaturated</code>.
