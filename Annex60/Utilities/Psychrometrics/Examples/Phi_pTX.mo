...
model Phi_pTX "Model to test the relative humidity computation"
 ...
 package Medium = Annex60.Media.Air "Medium model"
  ...
  Annex60.Utilities.Psychrometrics.Phi_pTX phi "Relative humidity"
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/Phi_pTX.mos"
        "Simulate and plot"),
