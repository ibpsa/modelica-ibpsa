...
equation
  if approximateWetBulb then
    ...
    XiDryBul =Annex60.Utilities.Psychrometrics.Functions.X_pSatpphi(
      ...
      phi=   phi);
    (TWetBul-Annex60.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * Annex60.Utilities.Psychrometrics.Constants.cpAir +
              XiSatRefIn * Annex60.Utilities.Psychrometrics.Constants.cpSte +
              (XiDryBul-XiSatRefIn) * Annex60.Utilities.Psychrometrics.Constants.cpWatLiq)
    =
    (TDryBul-Annex60.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * Annex60.Utilities.Psychrometrics.Constants.cpAir +
              XiDryBul * Annex60.Utilities.Psychrometrics.Constants.cpSte)  +
    (XiDryBul-XiSatRefIn) * Annex60.Utilities.Psychrometrics.Constants.h_fg;
...
<a href=\"modelica://Annex60.Utilities.Psychrometrics.Examples.TWetBul_TDryBulPhi\">
Annex60.Utilities.Psychrometrics.Examples.TWetBul_TDryBulPhi</a>.
</p>
<p>
