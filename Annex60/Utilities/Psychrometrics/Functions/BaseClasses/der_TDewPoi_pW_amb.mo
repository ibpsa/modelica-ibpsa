within Annex60.Utilities.Psychrometrics.Functions.BaseClasses;
function der_TDewPoi_pW_amb "Derivative of function TDewPoi_pW_amb"
  extends Modelica.Icons.Function;

  input SI.Pressure p_w "Water vapor partial pressure";
  input Real dp_w "Differential of water vapor partial pressure";
  output Real dT "Differential of dew point temperature";

protected
  constant SI.Temperature T1=283.15 "First support point";
  constant SI.Temperature T2=293.15 "Second support point";
  constant SI.Pressure p1=1227.97 "First support point";
  constant SI.Pressure p2=2338.76 "Second support point";
...
Removed <code>extends Annex60.Utilities.Psychrometrics.Functions.BaseClasses.pW_TDewPoi_amb</code>
