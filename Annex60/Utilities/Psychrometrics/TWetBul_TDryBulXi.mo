...
equation
  if approximateWetBulb then
    ...
    rh_per       = 100 * p/
         Annex60.Utilities.Psychrometrics.Functions.saturationPressure(TDryBul)
         *Xi[iWat]/(Xi[iWat] +
    ...
    (TWetBul-Annex60.Utilities.Psychrometrics.Constants.T_ref) * (
              ...
              (Xi[iWat]-XiSatRefIn) * Annex60.Utilities.Psychrometrics.Constants.cpWatLiq)
    =
    (TDryBul-Annex60.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-Xi[iWat]) * Annex60.Utilities.Psychrometrics.Constants.cpAir +
              Xi[iWat] * Annex60.Utilities.Psychrometrics.Constants.cpSte)  +
    (Xi[iWat]-XiSatRefIn) * Annex60.Utilities.Psychrometrics.Constants.h_fg;
    TDryBul_degC = 0;
    rh_per       = 0;
  end if;
