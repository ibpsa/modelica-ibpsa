...
equation
  ...
  VABpOpeClo_flow[1] = if Modelica.Math.isEqual(mOpe, 0.5, 1E-10)
    then
      IBPSA.Airflow.Multizone.BaseClasses.powerLaw05(
        C=CVal,
      ...
      IBPSA.Airflow.Multizone.BaseClasses.powerLawFixedM(
        C=CVal,
        dp=port_a1.p-port_a2.p,
        m=mOpe,
        a=a,
  ...
  VABpOpeClo_flow[2] = IBPSA.Airflow.Multizone.BaseClasses.powerLawFixedM(
    C=CVal,
    dp=port_a1.p-port_a2.p,
    m=mClo,
    a=a,
