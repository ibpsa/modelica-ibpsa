...
equation
  ...
  VFixed_flow = IBPSA.Airflow.Multizone.BaseClasses.powerLawFixedM(C=
      k,
    dp=dp,
    m=m,
    a=a,
...
experiment(Tolerance=1e-6, StopTime=1.0),
  __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Airflow/Multizone/BaseClasses/Examples/PowerLawFixedM.mos"
