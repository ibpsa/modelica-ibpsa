...
<p>The package <span style=\"font-family: Courier New;\">Buildings.Airflow.Multizone</span> contains models for multizone airflow and contaminant transport. </p>
<p>The models can be used to compute the air flow between different rooms and between a room and the exterior environment. In multizone airflow models, typically each room volume is assumed to be completely mixed. The driving force for the air flow are pressure differences that can be induced, e.g., by </p>
<ul>
<li>flow imbalance of the HVAC system, </li>
<li>density difference across large openings such as doors or open windows, </li>
<li>stack effects in high rise buildings, and </li>
<li>wind pressure on the building facade. </li>
</ul>
<p>Wind pressure coefficients for different building configurations can be found in Costola <i>et al.</i> (2009), Persily and Ivy (2001), Swami and Chandra (1987) and Liddament (1996) . </p>
