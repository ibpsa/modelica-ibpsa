...
protected
  ...
  parameter Real kT = CD*AOpe/2*sqrt(2/rho_default)
...
and
<p align=\"center\" style=\"font-style:italic;\">
  &Delta;p<sub>ab,t</sub>(z) = g z (&rho;<sub>a</sub>-&rho;<sub>b</sub>)
...
<p align=\"center\" style=\"font-style:italic;\">
    V&#775;<sub>ab,t</sub>(z) =  C<sub>D</sub> w h (2/&rho;<sub>0</sub>)<sup>0.5</sup> g<sup>m</sup> &rho;<sub>0</sub><sup>m</sup>
      z<sup>m</sup> (T<sub>b</sub>-T<sub>a</sub>)<sup>m</sup> &frasl; T<sub>0</sub><sup>m</sup>.
</p>
<p>
Assuming one airflow paths to represent the top half of the opening and one airflow path to represent the bottom half,
with the flow paths placed at a height of <i>2h/9</i> and <i>-2H/9</i> from the centerline respectively (Dols and Polidoro, 2020),
leads to
</p>
<p align=\"center\" style=\"font-style:italic;\">
V&#775;<sub>ab,t</sub> =  C<sub>D</sub> w h (2/&rho;<sub>0</sub>)<sup>0.5</sup> g<sup>m</sup> &rho;<sub>0</sub><sup>m</sup>
      (2h/9)<sup>m</sup> (T<sub>b</sub>-T<sub>a</sub>)<sup>m</sup> &frasl; T<sub>0</sub><sup>m</sup>.
</p>
...
<li>
<p>
For buoyancy-driven flow, the flow paths are placed at a height of <i>2h/9</i> and <i>-2H/9</i> from the centerline respectively
(Dols and Polidoro, 2020).
</p>
</li>
</ul>
<h4>Notes</h4>
...
<ul>
<li>
W. S. Dols and B. J. Polidoro, <i>CONTAM User Guide and Program Documentation Version 3.4</i>,
National Institute of Standards and Technology, Aug. 2020.
<a href=\"https://www.doi.org/10.6028/NIST.TN.1887r1\">doi:10.6028/NIST.TN.1887r1</a>.
</li>
</ul>
</html>",
revisions="<html>
