...
model ChimneyShaftNoVolume
  ...
  IBPSA.Airflow.Multizone.MediumColumn sha(redeclare package Medium = Medium,
      densitySelection=IBPSA.Airflow.Multizone.Types.densitySelection.actual) "Shaft of chimney"
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},
            {140,100}})),
    __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ChimneyShaftNoVolume.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06),
