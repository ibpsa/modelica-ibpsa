...
equation
  ...
  connect(conv2.terminal_n, ada3to3_n.terminals[1])
    annotation (Line(points={{-10,0},{-30.2,0},{-30.2,-0.266667}},
                                                               color={0,0,0}));
  connect(conv3.terminal_n, ada3to3_n.terminals[2]) annotation (Line(points={{-10,-60},
          {-20,-60},{-20,0},{-30.2,0}},    color={0,0,0}));
