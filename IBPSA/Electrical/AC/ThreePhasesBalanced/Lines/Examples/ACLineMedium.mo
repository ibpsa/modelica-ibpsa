...
<span style=\" font-family:'Courier New,courier'; color:#ff0000;\"> IBPSA.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10</span>
...
record type in order to be <code>IBPSA.Electrical.Transmission.MediumVoltageCables.Generic</code>.
</p>
