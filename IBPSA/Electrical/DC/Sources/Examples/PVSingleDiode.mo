...
equation
  ...
  connect(HGloTil.H, pVSys1Dio120Wp.HGloTil) annotation (Line(points={{-19,70},{
          62,70},{62,56},{69,56},{69,42}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)),
    experiment(StartTime=3600, StopTime=86400, Interval=300, Tolerance=1e-06),
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Electrical/DC/Sources/Examples/PVSingleDiode.mos"
  "Simulate and plot"));
end PVSingleDiode;
