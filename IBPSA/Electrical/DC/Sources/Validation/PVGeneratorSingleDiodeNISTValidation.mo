...
equation
  connect(NISTdata.y[1], from_degC.u)
    annotation (Line(points={{61,-30},{64,-30},{64,0},{46,0},{46,8},{47.2,8}},
                                                   color={0,0,127}));
  connect(from_degC.y, pVSystemSingleDiode.TDryBul) annotation (Line(points={{56.4,8},
  ...
  connect(solHouAng.solHouAng, weaBus1.solHouAng) annotation (Line(points={{19,-32},
          {-14,-32},{-14,6},{-34,6},{-34,30}},      color={0,0,127}));
  connect(solTim.solTim, solHouAng.solTim)
    annotation (Line(points={{1,-70},{0,-70},{0,-46},{-10,-46},{-10,-32},{-4,
          -32}},                                   color={0,0,127}));
  connect(decAng.decAng, weaBus.solDec) annotation (Line(points={{-37,10},{-32,10},
          {-32,16},{18,16},{18,28},{26,28},{26,50}},
                                   color={0,0,127}));
  connect(solHouAng.solHouAng, weaBus.solHouAng) annotation (Line(points={{19,-32},
          {26,-32},{26,50}},
        color={0,0,127}));
  ...
  connect(eqnTim.eqnTim, solTim.equTim)
    annotation (Line(points={{-65,-6},{-16,-6},{-16,-56},{-28,-56},{-28,-64},{
          -22,-64}},                                       color={0,0,127}));
  ...
  connect(calcClockTime.y, locTim.cloTim) annotation (Line(points={{-47,-42},{
          -46,-42},{-46,-30},{-42,-30}},
                                     color={0,0,127}));
  connect(modTim.y, calcClockTime.u1) annotation (Line(points={{-75,-86},{-70,
          -86},{-70,-60},{-82,-60},{-82,-48},{-70,-48}},
                                                    color={0,0,127}));
