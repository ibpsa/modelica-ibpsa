within IBPSA.Controls.SetPoints.Validation;
model OccupancyScheduleNegativeStartTime
  ...
  annotation (experiment(
      ...
      StopTime=207360,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/SetPoints/Validation/OccupancyScheduleNegativeStartTime.mos"
        "Simulate and plot"),
