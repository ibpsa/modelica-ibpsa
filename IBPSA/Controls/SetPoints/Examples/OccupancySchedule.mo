...
model OccupancySchedule "Test model for occupancy schedule with look-ahead"
  ...
  IBPSA.Controls.SetPoints.OccupancySchedule occSchWee(occupancy=3600*{7,19,
  ...
  annotation (experiment(StartTime=-86400, Tolerance=1e-6, StopTime=1.2096e+06),
    __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/SetPoints/Examples/OccupancySchedule.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img src=\"modelica://IBPSA/Resources/Images/Controls/SetPoints/Examples/OccupancySchedule.png\" border=\"1\" alt=\"Time until next occupancy.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
