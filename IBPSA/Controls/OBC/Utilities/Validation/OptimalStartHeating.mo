...
model OptimalStartHeating
  ...
  IBPSA.Controls.OBC.Utilities.OptimalStart optStaHea(
    computeHeating=true,
  ...
  IBPSA.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=10)
  ...
  IBPSA.Controls.OBC.CDL.Reals.MultiplyByParameter QHea(k=500)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-07),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartHeating.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This model is to validate the block
<a href=\"modelica://IBPSA.Controls.OBC.Utilities.OptimalStart\">
IBPSA.Controls.OBC.Utilities.OptimalStart</a> for space heating system.
</p>
<p>
