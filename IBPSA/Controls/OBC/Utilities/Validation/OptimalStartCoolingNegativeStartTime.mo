...
model OptimalStartCoolingNegativeStartTime
  ...
  IBPSA.Controls.OBC.Utilities.OptimalStart optStaCoo(
  ...
  IBPSA.Controls.OBC.CDL.Reals.Sources.Sin TOut(
    amplitude=5,
    freqHz=1/86400,
    offset=28+273.15,
    startTime(
  ...
  IBPSA.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=100)
    "Overall heat loss coefficient"
    annotation (Placement(transformation(extent={{-120,0},{-100,20}})));
  IBPSA.Controls.OBC.CDL.Reals.Subtract dT
    "Temperature difference between zone and outdoor"
    annotation (Placement(transformation(extent={{-160,0},{-140,20}})));
  IBPSA.Controls.OBC.CDL.Reals.Add dTdt
    "Temperature derivative"
    annotation (Placement(transformation(extent={{-80,0},{-60,20}})));
  IBPSA.Controls.OBC.CDL.Reals.MultiplyByParameter QCoo(k=-2000)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-07),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartCoolingNegativeStartTime.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This model is to validate the block
<a href=\"modelica://IBPSA.Controls.OBC.Utilities.OptimalStart\">
IBPSA.Controls.OBC.Utilities.OptimalStart</a> for space cooling system with
