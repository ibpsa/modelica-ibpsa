within IBPSA.Controls.OBC.Utilities.BaseClasses;
block OptimalStartCalculation
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.RealInput TDif(
    final quantity="TemperatureDifference",
    final unit="K")
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanInput staCal
    "Start calculation"
    annotation (Placement(transformation(extent={{-320,20},{-280,60}}),
      iconTransformation(extent={{-140,-20},{-100,20}})));
  IBPSA.Controls.OBC.CDL.Interfaces.RealInput tNexOcc(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.RealOutput tOpt(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanOutput optOn
...
protected
  ...
  IBPSA.Controls.OBC.CDL.Discrete.TriggeredMovingMean samTemSloAve(
    final n=nDay)
    "Calculate the averaged temperature slope over the past n days"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  IBPSA.Controls.OBC.CDL.Discrete.TriggeredSampler dTCalOn
    "Get the sampled temperature difference at the same time each day"
    annotation (Placement(transformation(extent={{-40,70},{-20,90}})));
  IBPSA.Controls.OBC.CDL.Discrete.TriggeredSampler dTHVACOn
  ...
  IBPSA.Controls.OBC.CDL.Reals.Min min
    "Get the final optimal start time"
    annotation (Placement(transformation(extent={{240,-16},{260,4}})));
  IBPSA.Controls.OBC.CDL.Discrete.TriggeredSampler triSam
  ...
  IBPSA.Controls.OBC.CDL.Reals.Switch dTUse
    "dT used in the calculations (to avoid negative dT)"
    annotation (Placement(transformation(extent={{80,70},{100,90}})));
  IBPSA.Controls.OBC.CDL.Reals.GreaterThreshold reqStaUp(
    final t=0,
    final h=0)
    "Output true if optimal startup is needed"
    annotation (Placement(transformation(extent={{10,70},{30,90}})));
  IBPSA.Controls.OBC.CDL.Logical.And triAve
