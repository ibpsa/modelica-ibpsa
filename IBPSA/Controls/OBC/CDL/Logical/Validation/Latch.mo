...
model Latch
  ...
  IBPSA.Controls.OBC.CDL.Logical.Sources.Pulse latInp(
    final width=0.5,
    final period=2)
    "Block that outputs cyclic on and off"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Latch.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Logical.Latch\">
IBPSA.Controls.OBC.CDL.Logical.Latch</a>. Following tests are implemented:
</p>
<ul>
<li>
