...
model Toggle
  ...
  IBPSA.Controls.OBC.CDL.Logical.Sources.Pulse togInp(
    final width=0.5,
    final period=2)
    "Block that outputs cyclic on and off"
    annotation (Placement(transformation(extent={{-160,150},{-140,170}})));
  IBPSA.Controls.OBC.CDL.Logical.Sources.Constant tru(
    final k=true)
    "True clear input"
  ...
  IBPSA.Controls.OBC.CDL.Logical.Sources.Constant fal(
    final k=false)
    "False clear input"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Toggle.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Logical.Toggle\">
IBPSA.Controls.OBC.CDL.Logical.Toggle</a>. Following tests are implemented:
</p>
<ul>
<li>
