...
protected
  ...
  IBPSA.Controls.OBC.CDL.Logical.Edge edg2
    "Rising edge when there is a width change"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  IBPSA.Controls.OBC.CDL.Logical.Pre preBre
    "Break loop"
  ...
  block Cycle
    ...
    IBPSA.Controls.OBC.CDL.Interfaces.BooleanInput go
  ...
  equation
    ...
    t_sta = t0 + IBPSA.Utilities.Math.Functions.round(
...
<p align=\"center\">
<img src=\"modelica://IBPSA/Resources/Images/Controls/OBC/CDL/Logical/VariablePulse.png\"
