...
block TimerAccumulating
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanInput reset
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanOutput passed
...
equation
  // The when constructs below are identical to the ones in IBPSA.Controls.OBC.CDL.Logical.Timer
  when reset then
    entryTime=time;
    passed=t <= 0;
    yAcc=0;
