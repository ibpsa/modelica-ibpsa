...
model IntegerToReal
  ...
  IBPSA.Controls.OBC.CDL.Conversions.IntegerToReal intToRea
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Validation/IntegerToReal.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Conversions.IntegerToReal\">
IBPSA.Controls.OBC.CDL.Conversions.IntegerToReal</a>.
</p>
</html>",
      revisions="<html>
<ul>
