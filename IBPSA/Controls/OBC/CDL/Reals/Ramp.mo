...
block Ramp "Limit the changing rate of the input"
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanInput active
...
way as <a href=\"modelica://IBPSA.Controls.OBC.CDL.Reals.LimitSlewRate\">
IBPSA.Controls.OBC.CDL.Reals.LimitSlewRate</a>. However, the
