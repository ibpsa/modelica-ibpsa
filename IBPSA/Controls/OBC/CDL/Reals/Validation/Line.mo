...
model Line
  ...
  IBPSA.Controls.OBC.CDL.Reals.Line line1
    "Block that out the value of the input x along a line specified by two points"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant x1(
    k=1.0)
    "Block that generate x1"
    annotation (Placement(transformation(extent={{-60,52},{-40,72}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant f1(
    k=0.5)
    "Block that generate f(x1)"
    annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant x2(
    k=2.0)
    "Block that generate x2"
    annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant f2(
    k=1.5)
  ...
  IBPSA.Controls.OBC.CDL.Reals.Line line2(
    limitAbove=true,
    limitBelow=false)
    "Block that out the value of the input x along a line specified by two points"
    annotation (Placement(transformation(extent={{-10,-40},{10,-20}})));
  IBPSA.Controls.OBC.CDL.Reals.Line line3(
    limitBelow=true,
    limitAbove=false)
    "Block that out the value of the input x along a line specified by two points"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Line.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Reals.Line\">
IBPSA.Controls.OBC.CDL.Reals.Line</a>.
</p>
<p>
