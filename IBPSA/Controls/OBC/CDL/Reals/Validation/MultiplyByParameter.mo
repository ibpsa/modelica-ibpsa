...
model MultiplyByParameter "Validation model for the Gain block"
  IBPSA.Controls.OBC.CDL.Reals.MultiplyByParameter gain1(k=2.5)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/MultiplyByParameter.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Reals.MultiplyByParameter\">
IBPSA.Controls.OBC.CDL.Reals.MultiplyByParameter</a>.
</p>
<p>
