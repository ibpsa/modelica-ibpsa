...
model PID
  ...
  IBPSA.Controls.OBC.CDL.Reals.PID limPI(
    Ti=1,
    Td=1,
    yMin=-1,
  ...
  IBPSA.Controls.OBC.CDL.Reals.PID limP(
    Ti=1,
    Td=1,
    yMin=-1,
    controllerType=IBPSA.Controls.OBC.CDL.Types.SimpleController.P)
    "P controller"
    annotation (Placement(transformation(extent={{-30,-60},{-10,-40}})));
  IBPSA.Controls.OBC.CDL.Reals.PID noLimPID(
    Ti=1,
    Td=1,
    yMax=1e15,
    yMin=-1e15,
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PID.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
