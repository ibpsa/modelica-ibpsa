...
model PIDScale
  ...
  IBPSA.Controls.OBC.CDL.Reals.PID pidSca(
  ...
  IBPSA.Controls.OBC.CDL.Reals.PID pidNoSca(
    controllerType=IBPSA.Controls.OBC.CDL.Types.SimpleController.PID,
    k=2,
    Ti=1,
    Td=2,
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PIDScale.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
