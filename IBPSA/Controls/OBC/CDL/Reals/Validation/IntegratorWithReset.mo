...
model IntegratorWithReset
  ...
  IBPSA.Controls.OBC.CDL.Reals.IntegratorWithReset intDef(final
      y_start=-2)
    "Integrator with default values"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  IBPSA.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes1(final
      y_start=-2,
    final k=0.5)
  ...
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant cons(
    final k=10)
    "Constant as source term"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  IBPSA.Controls.OBC.CDL.Logical.Sources.Pulse booleanPulse(
    final width=0.5,
    final period=0.2)
    "Boolean pulse"
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  IBPSA.Controls.OBC.CDL.Logical.Sources.SampleTrigger sampleTrigger(
    final period=0.2)
    "Sample trigger"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/IntegratorWithReset.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Reals.IntegratorWithReset\">
IBPSA.Controls.OBC.CDL.Reals.IntegratorWithReset</a>
