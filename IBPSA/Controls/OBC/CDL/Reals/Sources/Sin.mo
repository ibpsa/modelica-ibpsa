  ...
  y=offset+(
    if time < startTime then
      ...
      amplitude*Modelica.Math.sin(
        2*IBPSA.Controls.OBC.CDL.Constants.pi*freqHz*(time-startTime)+phase));
  annotation (
...
<p>
<img src=\"modelica://IBPSA/Resources/Images/Controls/OBC/CDL/Reals/Sources/Sin.png\"
     alt=\"Sin.png\"/>
</p>
</html>",
      revisions="<html>
...
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Reals.Sin\">
IBPSA.Controls.OBC.CDL.Reals.Sin</a>.<br/>
This is for
