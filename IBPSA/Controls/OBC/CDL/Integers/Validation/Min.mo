...
model Min
  ...
  IBPSA.Controls.OBC.CDL.Integers.Min min1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Min.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.Min\">
IBPSA.Controls.OBC.CDL.Integers.Min</a>.
</p>
</html>",
      revisions="<html>
<ul>
