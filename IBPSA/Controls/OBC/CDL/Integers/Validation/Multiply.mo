...
model Multiply "Validation model for the Multiply block"
  IBPSA.Controls.OBC.CDL.Integers.Multiply product
  ...
  IBPSA.Controls.OBC.CDL.Reals.Sources.TimeTable timTabLin1(
    smoothness=IBPSA.Controls.OBC.CDL.Types.Smoothness.ConstantSegments,
    table=[
      0,0;
      0.35,1;
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Multiply.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.Multiply\">
IBPSA.Controls.OBC.CDL.Integers.Multiply</a>.
</p>
</html>",
revisions="<html>
<ul>
