...
model Subtract "Validation model for the Subtract block"
  IBPSA.Controls.OBC.CDL.Integers.Subtract sub
  ...
  IBPSA.Controls.OBC.CDL.Reals.Round round1(n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-40,10},{-20,30}})));
  IBPSA.Controls.OBC.CDL.Conversions.RealToInteger reaToInt
    "Convert real to integer"
    annotation (Placement(transformation(extent={{0,10},{20,30}})));
  IBPSA.Controls.OBC.CDL.Reals.Round round2(n=0)
    "Round real number to given digits"
...
annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Subtract.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.Subtract\">
IBPSA.Controls.OBC.CDL.Integers.Subtract</a>.
</p>
</html>",
revisions="<html>
<ul>
