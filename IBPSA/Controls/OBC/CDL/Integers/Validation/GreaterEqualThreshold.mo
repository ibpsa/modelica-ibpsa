...
model GreaterEqualThreshold
  ...
  IBPSA.Controls.OBC.CDL.Integers.GreaterEqualThreshold intGreEquThr(
    t=2)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/GreaterEqualThreshold.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.GreaterEqualThreshold\">
IBPSA.Controls.OBC.CDL.Integers.GreaterEqualThreshold</a>.
</p>
</html>",
      revisions="<html>
<ul>
