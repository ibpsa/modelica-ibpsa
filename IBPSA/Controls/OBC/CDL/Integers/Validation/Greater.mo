...
model Greater
  ...
  IBPSA.Controls.OBC.CDL.Integers.Greater intGre
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Greater.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.Greater\">
IBPSA.Controls.OBC.CDL.Integers.Greater</a>.
</p>
</html>",
      revisions="<html>
<ul>
