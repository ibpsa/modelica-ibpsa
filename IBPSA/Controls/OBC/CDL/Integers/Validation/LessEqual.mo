...
model LessEqual
  ...
  IBPSA.Controls.OBC.CDL.Integers.LessEqual intLesEqu
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/LessEqual.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.LessEqual\">
IBPSA.Controls.OBC.CDL.Integers.LessEqual</a>.
</p>
</html>",
      revisions="<html>
<ul>
