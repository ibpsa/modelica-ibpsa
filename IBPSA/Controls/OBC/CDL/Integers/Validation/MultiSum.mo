...
model MultiSum
  ...
  IBPSA.Controls.OBC.CDL.Integers.MultiSum add1(
    nin=3)
  ...
  IBPSA.Controls.OBC.CDL.Reals.Round round2(
    n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
  IBPSA.Controls.OBC.CDL.Conversions.RealToInteger reaToInt1
    "Convert real to integer"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));
  IBPSA.Controls.OBC.CDL.Reals.Round round3(
    n=0)
    "Round real number to given digits"
    annotation (Placement(transformation(extent={{-40,-50},{-20,-30}})));
  IBPSA.Controls.OBC.CDL.Conversions.RealToInteger reaToInt2
    "Convert real to integer"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/MultiSum.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.MultiSum\">
IBPSA.Controls.OBC.CDL.Integers.MultiSum</a>.
</p>
</html>",
      revisions="<html>
<ul>
