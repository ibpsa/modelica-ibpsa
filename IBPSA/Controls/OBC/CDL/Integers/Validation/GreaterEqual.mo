...
model GreaterEqual
  ...
  IBPSA.Controls.OBC.CDL.Integers.GreaterEqual intGreEqu
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/GreaterEqual.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.GreaterEqual\">
IBPSA.Controls.OBC.CDL.Integers.GreaterEqual</a>.
</p>
</html>",
      revisions="<html>
<ul>
