...
model Max
  ...
  IBPSA.Controls.OBC.CDL.Integers.Max max1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Max.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.Max\">
IBPSA.Controls.OBC.CDL.Integers.Max</a>.
</p>
</html>",
      revisions="<html>
<ul>
