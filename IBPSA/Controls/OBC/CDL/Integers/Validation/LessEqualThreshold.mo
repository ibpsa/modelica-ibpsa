...
model LessEqualThreshold
  ...
  IBPSA.Controls.OBC.CDL.Integers.LessEqualThreshold intLesEquThr(
    t=2)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/LessEqualThreshold.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.LessEqualThreshold\">
IBPSA.Controls.OBC.CDL.Integers.LessEqualThreshold</a>.
</p>
</html>",
      revisions="<html>
<ul>
