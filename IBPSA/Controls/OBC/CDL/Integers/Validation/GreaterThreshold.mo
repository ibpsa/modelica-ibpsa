...
model GreaterThreshold
  ...
  IBPSA.Controls.OBC.CDL.Integers.GreaterThreshold intGreThr(
    t=2)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/GreaterThreshold.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.GreaterThreshold\">
IBPSA.Controls.OBC.CDL.Integers.GreaterThreshold</a>.
</p>
</html>",
      revisions="<html>
<ul>
