...
model AddParameter "Validation model for the AddParameter block"
  IBPSA.Controls.OBC.CDL.Integers.AddParameter addPar(p=5)
...
annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/AddParameter.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.AddParameter\">
IBPSA.Controls.OBC.CDL.Integers.AddParameter</a>.
</p>
</html>",
revisions="<html>
<ul>
