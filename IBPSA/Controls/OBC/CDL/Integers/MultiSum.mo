...
block MultiSum
  ...
  parameter Integer k[nin]=fill(1, nin)
    "Input gains";
  IBPSA.Controls.OBC.CDL.Interfaces.IntegerInput u[nin]
...
<p>
See
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Integers.Validation.MultiSum\">
IBPSA.Controls.OBC.CDL.Integers.Validation.MultiSum</a>
for an example.
</p>
</html>",
      revisions="<html>
