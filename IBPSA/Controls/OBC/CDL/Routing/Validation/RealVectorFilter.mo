...
model RealVectorFilter
  ...
  IBPSA.Controls.OBC.CDL.Routing.RealVectorFilter
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/RealVectorFilter.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Routing.RealVectorFilter\">
IBPSA.Controls.OBC.CDL.Routing.RealVectorFilter</a>.
</p>
</html>",
      revisions="<html>
<ul>
