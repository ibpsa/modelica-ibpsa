...
model RealScalarReplicator
  ...
  IBPSA.Controls.OBC.CDL.Routing.RealScalarReplicator reaRep(
    nout=3)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/RealScalarReplicator.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Routing.RealScalarReplicator\">
IBPSA.Controls.OBC.CDL.Routing.RealScalarReplicator</a>.
</p>
</html>",
      revisions="<html>
<ul>
