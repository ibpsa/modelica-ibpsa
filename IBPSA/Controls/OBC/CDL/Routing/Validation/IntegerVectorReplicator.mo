...
model IntegerVectorReplicator
  ...
  IBPSA.Controls.OBC.CDL.Routing.IntegerVectorReplicator
    intRep(nin=2, nout=3)
    "Block that outputs the vector replicating input value"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Ramp ram[2](
    height=fill(5,2),
    duration=fill(1,2),
    offset=fill(-2,2)) "Block that outputs ramp signal"
    annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
  IBPSA.Controls.OBC.CDL.Conversions.RealToInteger reaToInt[2]
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/IntegerVectorReplicator.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Routing.IntegerVectorReplicator\">
IBPSA.Controls.OBC.CDL.Routing.IntegerVectorReplicator</a>.
</p>
</html>",
      revisions="<html>
<ul>
