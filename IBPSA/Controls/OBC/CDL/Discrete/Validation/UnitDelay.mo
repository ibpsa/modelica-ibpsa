...
model UnitDelay
  ...
  IBPSA.Controls.OBC.CDL.Discrete.UnitDelay unitDelay1(
    samplePeriod=0.2)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Validation/UnitDelay.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IBPSA.Controls.OBC.CDL.Discrete.UnitDelay\">
IBPSA.Controls.OBC.CDL.Discrete.UnitDelay</a>.
</p>
</html>",
      revisions="<html>
<ul>
