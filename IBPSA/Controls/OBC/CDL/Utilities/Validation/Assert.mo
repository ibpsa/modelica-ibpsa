...
model Assert
  ...
  IBPSA.Controls.OBC.CDL.Utilities.Assert assert(
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/OBC/CDL/Utilities/Validation/Assert.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
