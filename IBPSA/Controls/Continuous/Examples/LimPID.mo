...
model LimPID "Test model for PID controller with optional reverse action"
  ...
  IBPSA.Utilities.Diagnostics.AssertEquality assertEquality(
    threShold=1e-3)
  ...
  IBPSA.Utilities.Diagnostics.AssertEquality assertEquality1(
    threShold=1e-3)
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Controls/Continuous/Examples/LimPID.mos"
        "Simulate and plot"),
