...
model Case985 "Case 900, but with single heating and cooling setpoint"
  extends IBPSA.ThermalZones.ISO13790.Validation.BESTEST.Cases9xx.Case900(TSetHea(
        table=[0.0,273.15 + 19.9]), TSetCoo(table=[0.0,273.15 + 20.1]));
 annotation (
  __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases9xx/Case985.mos"
        "Simulate and plot"),
        experiment(
      StopTime=3.1536e+07,
      Interval=3600,
