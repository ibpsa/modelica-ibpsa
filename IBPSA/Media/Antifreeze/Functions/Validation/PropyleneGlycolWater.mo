...
model PropyleneGlycolWater "Validation model for antifreeze mixture"
  ...
  constant Real conX_a(unit="1/s") =
    (IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.X_a_max-
     IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.X_a_min)
      "Conversion factor";
...
equation
  phi = conPhi*time;
  X_a = IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.X_a_min+conX_a*time;

  X_a_phi = IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.volumeToMassFraction(
    T=T,
    phi=phi);

  d = IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.density_TX_a(
    T=T,
    X_a=X_a);
  eta = IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.dynamicViscosity_TX_a(
    T=T,
    X_a=X_a);
  Tf = IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.fusionTemperature_TX_a(
    T=T,
    X_a=X_a);
  cp = IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.specificHeatCapacityCp_TX_a(
    T=T,
    X_a=X_a);
  lambda = IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater.thermalConductivity_TX_a(
    T=T,
    X_a=X_a);
  ...
  annotation (
    experiment(
      StopTime=1,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Media/Antifreeze/Functions/Validation/PropyleneGlycolWater.mos"
        "Simulate and plot"),
     Documentation(info="<html>
<p>
Validation model for the functions of
<a href=\"modelica://IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater\">
IBPSA.Media.Antifreeze.Functions.PropyleneGlycolWater</a>.
