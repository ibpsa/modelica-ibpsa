...
model EthyleneGlycolWater
  ...
  extends IBPSA.Media.Antifreeze.Validation.BaseClasses.FluidProperties(
    redeclare package Medium = IBPSA.Media.Antifreeze.Functions.EthyleneGlycolWater,
    nX_a=7,
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Media/Antifreeze/Validation/EthyleneGlycolWater.mos"
        "Simulate and plot"),
