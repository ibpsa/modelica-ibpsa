...
<p>This function represents the short form for tau*tau*(ddalpha_r/(dtau*dtau))_delta=const.</p>
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for delta*(dalpha_r/(ddelta))_tau=const<b>.</b></p>
</html>"));
  end d_fRes_d;
...
protected
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the dew curve specific enthalpy of refrigerant<b>.</b></p>
</html>"));
  end dewEnthalpy;
