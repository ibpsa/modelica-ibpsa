...
protected
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>Thie function calculates the dew curve specific density of refrigerant.</p>
</html>"));
  end dewDensity;
...
protected
  ...
  algorithm
    ...
    annotation(derivative(noDerivative=phase)=density_pT_der,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function computes the density as a function of pressure and temperature.</p>
</html>"));
  end density_pT;
...
protected
    ...
    Real etaHdG
    "Dynamic viscosity for the limit of high density at dew line";
...
protected
  ...
  annotation (Documentation(info="<html>
<p>This function calculates the thermal conductivity of refrigerant.</p>
</html>"));
