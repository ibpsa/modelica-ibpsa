...
<p>The hybrid approach is implemented in the package <a href=\"modelica://IBPSA.Media.Refrigerants.Interfaces.PartialHybridTwoPhaseMediumRecord\">IBPSA.Media.Refrigerants.Interfaces.PartialHybridTwoPhaseMediumRecord </a>and the fitting coefficients are stored in records in the package <a href=\"modelica://IBPSA/Media/Refrigerants/DataBase/package.mo\">IBPSA.Media.Refrigerants.DataBase</a>. In order to allow an easy extension, a template for new refrigerant models using the hybrid approach provided in <a href=\"modelica://IBPSA.Media.Refrigerants.Interfaces.TemplateHybridTwoPhaseMediumRecord\">IBPSA.Media.Refrigerants.Interfaces.TemplateHybridTwoPhaseMediumRecord </a>. Moreover, the hybrid approach is also implented in the package <a href=\"modelica://IBPSA.Media.Refrigerants.Interfaces.PartialHybridTwoPhaseMediumFormula\">IBPSA.Media.Refrigerants.Interfaces.PartialHybridTwoPhaseMediumFormula </a>using the template <a href=\"modelica://IBPSA.Media.Refrigerants.Interfaces.TemplateHybridTwoPhaseMediumFormula\">IBPSA.Media.Refrigerants.Interfaces.TemplateHybridTwoPhaseMediumFormula </a>. Within the second template, no records are used to provide the fitting coefficients. Therefore, the obtained formulas are implemented in an explicit form in order to speed up the simulation. </p>
<p>Currently, the <b>following refrigerants are implemented</b>: </p>
<ol>
<li>R134a</li>
<li>R290 (Restricted area)</li>
...
<ul>
<li>June 6, 2017, by Mirko Engelpracht, Christian Vering:<br>First implementation (see <a href=\"https://github.com/RWTH-EBC/Aixlib/issues/408\">issue 408</a>). </li>
