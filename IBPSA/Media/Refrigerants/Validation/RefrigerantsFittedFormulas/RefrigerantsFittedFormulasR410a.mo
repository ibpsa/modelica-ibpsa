...
model RefrigerantsFittedFormulasR410a
  ...
  extends RefrigerantsFittedFormulasR134a(
    redeclare package MediumInt =
      IBPSA.Media.Refrigerants.R410A.R410A_IIR_P1_48_T233_473_Horner,
    extProp(fileName=Modelica.Utilities.Files.loadResource(
      "modelica://WorkingVersion/Resources/Media/Refrigerants/ValidationFittedFormulasR410a.txt")),
    h_min = 155e3,
    h_max = 600e3,
    s_min = 0.75e3,
    s_max = 2e3,
...
<p>Additionally, the fitted formulas are also calculated with an external media libary (i.e. <a href=\"https://github.com/modelica/ExternalMedia\">ExternalMedia</a>). </p>
<h4>Limitations</h4>
<p>Unfortunately, it is not possible to directly call formulas related to the Helmholtz equation of state for the ExternalMedia library. Thus, these formulas are set to unity and cannot be validated directly in Modelica. Therefore, the parameters are not allowed to change (except for the medium package). </p>
</html>"));
