...
model RefrigerantInversions
  ...
  package Medium =
    IBPSA.Media.Refrigerants.R410A.R410A_IIR_P1_48_T233_340_Record
...
<p>This example model checks the calculation of the <b>refrigerant&apos;s main inversions</b> depending on the independent variables pressure and temperature. Therefore, the user has first to introduce some information about the refrigerant and afterwards the different inversions are calculated. The following <b>refrigerant&apos;s information</b> is required: </p>
<ol>
