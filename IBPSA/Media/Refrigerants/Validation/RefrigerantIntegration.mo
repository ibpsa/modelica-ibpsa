within IBPSA.Media.Refrigerants.Validation;
...
<p>This example model checks the implementation of the<b> refrigerant&apos;s main derivatives</b> wrt. to time. Therefore, the user has first to introduce some information about the refrigerant and afterwards the derivatives are calculated. The following <b>refrigerant&apos;s information</b> is required: </p>
<ol>
...
<p>The following <b>refrigerant&apos;s derivatives </b>are c alculated and checked: </p>
<ol>
