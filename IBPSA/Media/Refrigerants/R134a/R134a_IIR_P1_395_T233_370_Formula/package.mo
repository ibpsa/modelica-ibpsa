...
protected
    SmoothTransition st "Smooth transition";
    SpecificEntropy ds = st.T_ps "Entropy gradient for smooth transition";
  ...
  annotation(derivative(noDerivative=phase)=temperature_ps_der,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates temperature as function of pressure and specific entropy.</p>
</html>"));
  end temperature_ps;
...
protected
    SmoothTransition st "Smooth transition";
    AbsolutePressure dp = st.d_pT "Pressure gradient for smooth transition";
...
IBPSA.Media.Refrigerants.Interfaces.TemplateHybridTwoPhaseMediumFormula
</a>.
</p>
...
IBPSA.Media.Refrigerants.Examples.RefrigerantProperties</a> to external data
