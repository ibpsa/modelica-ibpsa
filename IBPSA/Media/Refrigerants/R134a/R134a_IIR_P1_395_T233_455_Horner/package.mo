...
<p>This function represents the short form for tau*tau*(ddalpha_r/(dtau*dtau))_delta=const.</p>
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for delta*(dalpha_r/(ddelta))_tau=const.</p>
</html>"));
  end d_fRes_d;
...
protected
  ...
  algorithm
    ...
    annotation(derivative(noDerivative=phase)=temperature_ph_der,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the temperature as function of pressure and specific enthalpy.</p>
</html>"));
  end temperature_ph;
...
protected
  ...
  annotation (Documentation(info="<html>
<p>This function calculates the dynamic viscosity of refrigerant.</p>
</html>"));
...
protected
    ...
    Real lambdaCriL
      "Thermal conductivity for the region of the critical point at bubble 
         line";
    Real lambdaCriG
  ...
  annotation (Documentation(info="<html>
<p>This function calculates the calculates thermal conductivity of refrigerant.</p>
</html>"));
