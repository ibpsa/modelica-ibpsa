within IBPSA.Media.Refrigerants.R134a;
...
<p>This record contains ranges to calculate a smooth transition between different regions.</p>
  ...
  algorithm
    f_Idg := log(delta) + (-1.629789) * log(tau^(1)) + (-1.02084672674949) *
      ...
      (-3.92717) * tau^(-0.75);
  annotation (Documentation(info="<html>
<p>This function calculates the dimensionless Helmholtz energy for the ideal gas contribution.</p>
</html>"));
  end f_Idg;
  ...
  annotation (Documentation(info="<html>
<p>This function calculates the dimensionless Helmholtz energy for the residual part.</p>
</html>"));
  end f_Res;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*(dalpha_0/dtau)_delta=const.</p>
</html>"));
  end t_fIdg_t;
  ...
  algorithm
    tt_fIdg_tt := -(-1.629789)*(1) + (-1.02084672674949)*(0)*
      ...
      tau^(-0.75);
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*tau*(ddalpha_0/(dtau*dtau))_delta=const.</p>
</html>"));
  end tt_fIdg_tt;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*(dalpha_r/dtau)_delta=const.</p>
</html>"));
  end t_fRes_t;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*tau*(ddalpha_r/(dtau*dtau))_delta=const.</p>
</html>"));
  end tt_fRes_tt;
  ...
  annotation (Documentation(info="<html>
<p>T<img src=\"modelica://WorkingVersion/Resources/Images/equations/equation-eKyY36rS.png\" alt=\"faf\"/>his function represents the short form for delta*(dalpha_r/(ddelta))_tau=const.</p>
</html>"));
  end d_fRes_d;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for delta*delta(ddalpha_r/(ddelta*delta))_tau=const.</p>
</html>"));
  end dd_fRes_dd;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*delta*(ddalpha_r/(dtau*ddelta)).</p>
</html>"));
  end td_fRes_td;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*tau*tau*(dddalpha_0/(dtau*dtau*dtau))_delta=const.</p>
</html>"));
  end ttt_fIdg_ttt;
  ...
  algorithm
    ttt_fRes_ttt := (0.05586817)*(-0.5)*((-0.5)-1)*((-0.5)-2)*
      ...
      exp(-delta^(4));
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*tau*tau*(dddalpha_r/(dtau*dtau*dtau))_delta=const.</p>
</html>"));
  end ttt_fRes_ttt;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for delta*delta*delta* (dddalpha_r/(ddelta*ddelta*ddelta))_tau=const.</p>
</html>"));
  end ddd_fRes_ddd;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*delta*delta*(dddalpha_r/(dtau*ddelta*ddelta)).</p>
</html>"));
  end tdd_fRes_tdd;
  ...
  annotation (Documentation(info="<html>
<p>This function represents the short form for tau*tau*delta*(dddalpha_r/(dtau*dtau*ddelta)).</p>
</html>"));
  end ttd_fRes_ttd;
...
<p>This function calculates the saturation pressure of refrigerant.</p>
</html>"));
...
protected
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the saturation temperature of refrigerant.</p>
</html>"));
...
protected
    Real x "Regression term for centred scaled saturation temperature";
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the boiling curve specific density of refrigerant.</p>
</html>"));
  end bubbleDensity;
...
protected
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the dew curve specific density of refrigerant.</p>
</html>"));
  end dewDensity;
...
protected
    Real x "Regression term for centred scaled saturation pressure";
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the boiling curve specific enthalpy of refrigerant.</p>
</html>"));
  end bubbleEnthalpy;
...
protected
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the dew curve specific enthalpy of refrigerant.</p>
</html>"));
  end dewEnthalpy;
...
protected
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the boiling curve specific entropy of refrigerant.</p>
</html>"));
  end bubbleEntropy;
...
protected
  ...
  algorithm
    ...
    annotation(smoothOrder = 2,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the dew curve specific entropy of propane.</p>
</html>"));
  end dewEntropy;
...
protected
  ...
  algorithm
    ...
    annotation(derivative(noDerivative=phase)=temperature_ph_der,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates temperature as function of pressure and specific enthalpy.</p>
</html>"));
  end temperature_ph;
...
protected
  ...
  algorithm
    ...
    annotation(derivative(noDerivative=phase)=temperature_ps_der,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function calculates the temperature as function of pressure and specific entropy.</p>
</html>"));
  end temperature_ps;
...
protected
  ...
  algorithm
    ...
    annotation(derivative(noDerivative=phase)=density_pT_der,
          ...
          LateInline=true,
    Documentation(info="<html>
<p>This function computes density as a function of pressure and temperature.</p>
</html>"));
  end density_pT;
...
protected
    ...
    Real BEtaZd
    "Second viscosity virial coefficient for limits of zero density";
    ...
    Real deltaHd "Reduced close-packed density";
    Real etaL
  ...
  algorithm
    ...
    if (state.phase == 1 or phase_dT == 1) then
      ...
      // Calculate the dynamic viscosity at bubble and dew state
...
<p>This function calculates dynamic viscosity of refrigerant.</p>
  ...
  /*The functional form of the thermal conductivity is implented as presented 
    in Perkins et al. (2000), Experimental Thermal Conductivity Values for the
...
protected
    ...
    Real chiRefL
    "Dimensionless susceptibility at reference state at bubble line";
    Real chiRefG
    "Dimensionless susceptibility at reference state at dew line";
    ...
    Real omegaL "Crossover function at bubble line";
    ...
    Real lambdaCriL
      "Thermal conductivity for the region of the critical point at
         bubble line";
    Real lambdaCriG
  ...
  algorithm
    ...
    if (state.phase == 1 or phase_dT == 1) then
      ...
      // Calculate the thermal conductivity for the region of the
      // critical point
...
*/
  ...
  annotation (Documentation(info="<html>
<p>This function calculates surface tension in two phase region of refrigerant.</p>
</html>"));
  end surfaceTension;

  annotation (Documentation(revisions="<html>
<ul>
<li>September 06, 2017, by Mirko Engelpracht:<br>First implementation (see <a href=\"https://github.com/RWTH-EBC/AixLib/issues/408\">issue 408</a>). </li>
