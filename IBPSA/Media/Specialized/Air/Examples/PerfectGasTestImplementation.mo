within IBPSA.Media.Specialized.Air.Examples;
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Media/Specialized/Air/Examples/PerfectGasTestImplementation.mos"
        "Simulate and plot"),
