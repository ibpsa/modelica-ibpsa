within IBPSA;
package ObsoleteModel "Classes that are obsolete and will be removed in later versions"
  extends Modelica.Icons.Package;

  model FixedBoundary "Boundary source component"
    extends IBPSA.ObsoleteModel.BaseClasses.ObsoleteModel;
...
<p>
This package is intended to host classes that are obsolete and will be removed from the
