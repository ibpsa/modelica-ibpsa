...
equation
  ...
  annotation (experiment(Tolerance=1e-8, StopTime=100),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/FlowJunction.mos"
        "Simulate and plot"),
