...
model MSLAIT2elements
  ...
  parameter IBPSA.Fluid.FixedResistances.Types.ThermalResistanceLength R=1/(2*
      lambdaI*Modelica.Constants.pi)*log(0.18/0.0899) + 1/(2*2.4*Modelica.Constants.pi)
      *log(2/0.18);
  parameter IBPSA.Fluid.FixedResistances.Types.ThermalResistanceLength R80=1/(2
      *0.024*Modelica.Constants.pi)*log(0.07/0.0337) + 1/(2*2.4*Modelica.Constants.pi)
      *log(2/0.07);
  parameter IBPSA.Fluid.FixedResistances.Types.ThermalResistanceLength R_old=1/
