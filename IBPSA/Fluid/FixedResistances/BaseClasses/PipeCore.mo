...
model PipeCore
  ...
  IBPSA.Fluid.FixedResistances.BaseClasses.PipeAdiabaticPlugFlow pipeAdiabaticPlugFlow(
...
public
  IBPSA.Fluid.FixedResistances.BaseClasses.HeatLossPipeDelay reverseHeatLoss(
  ...
  IBPSA.Fluid.FixedResistances.BaseClasses.HeatLossPipeDelay heatLoss(
    redeclare package Medium = Medium,
    diameter=diameter,
    length=length,
    C=C,
  ...
  IBPSA.Fluid.FixedResistances.BaseClasses.TimeDelay timeDelay(
    length=length,
    diameter=diameter,
    rho=rho_default,
    initDelay=initDelay,
