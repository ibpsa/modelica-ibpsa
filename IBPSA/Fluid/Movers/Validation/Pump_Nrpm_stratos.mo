...
model Pump_Nrpm_stratos "Model validation using a Wilo Stratos 80/1-12 pump"
  ...
  IBPSA.Fluid.Movers.FlowControlled_m_flow forcedPump1(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
    annotation (Placement(transformation(extent={{38,60},{58,80}})));
  IBPSA.Fluid.Movers.FlowControlled_m_flow forcedPump2(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
    annotation (Placement(transformation(extent={{38,10},{58,30}})));
  IBPSA.Fluid.Movers.FlowControlled_m_flow forcedPump3(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
    annotation (Placement(transformation(extent={{38,-36},{58,-16}})));
  IBPSA.Fluid.Movers.FlowControlled_m_flow forcedPump4(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
    annotation (Placement(transformation(extent={{38,-80},{58,-60}})));
  IBPSA.Fluid.Movers.FlowControlled_m_flow forcedPump5(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Movers/Validation/Pump_Nrpm_stratos.mos"
        "Simulate and plot"),
...
<p>Pump heads:</p>
<p><img src=\"modelica://IBPSA/Resources/Images/Fluid/Movers/Examples/PumpValidationHead.png\"
alt=\"Pump head.\"/>
</p>
<p>Pump electrical power:</p>
<p><img src=\"modelica://IBPSA/Resources/Images/Fluid/Movers/Examples/PumpValidationPower.png\"
alt=\"Pump power.\"/></p>
