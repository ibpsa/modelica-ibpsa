...
model ComparePowerHydraulic
  ...
  extends IBPSA.Fluid.Movers.Validation.BaseClasses.ComparePower(
    redeclare replaceable IBPSA.Fluid.Movers.Data.Fans.Greenheck.BIDW15 per(
    ...
    redeclare IBPSA.Fluid.Movers.SpeedControlled_y mov1(
      redeclare final package Medium = Medium,
      per=per,
      energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
      addPowerToMedium=false,
      use_inputFilter=false),
    redeclare IBPSA.Fluid.Movers.SpeedControlled_y mov2(
      redeclare final package Medium = Medium,
      per(
      ...
      addPowerToMedium=false,
      use_inputFilter=false),
    redeclare IBPSA.Fluid.Movers.SpeedControlled_y mov3(
      redeclare final package Medium = Medium,
      per(
        powerOrEfficiencyIsHydraulic=per.powerOrEfficiencyIsHydraulic,
        pressure=per.pressure,
