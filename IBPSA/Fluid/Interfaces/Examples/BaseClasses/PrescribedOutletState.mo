...
partial model PrescribedOutletState "Test model for prescribed outlet state"
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort THeaHigPowIn(
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort TCooLimPowIn(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort THeaCooUnlIn(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort TSteStaIn(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
