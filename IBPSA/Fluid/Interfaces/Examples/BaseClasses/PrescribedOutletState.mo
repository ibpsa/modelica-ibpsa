within IBPSA.Fluid.Interfaces.Examples.BaseClasses;
partial model PrescribedOutletState "Test model for prescribed outlet state"
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort THeaHigPowInl(
