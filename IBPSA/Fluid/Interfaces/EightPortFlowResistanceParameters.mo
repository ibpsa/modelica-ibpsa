...
record EightPortFlowResistanceParameters
  ...
  parameter Modelica.Units.SI.PressureDifference dp1_nominal(min=0, displayUnit="Pa")
  ...
  parameter Modelica.Units.SI.PressureDifference dp2_nominal(min=0, displayUnit="Pa")
    "Pressure difference" annotation (Dialog(group="Nominal condition"));
  ...
  parameter Modelica.Units.SI.PressureDifference dp3_nominal(min=0, displayUnit="Pa")
    "Pressure difference" annotation (Dialog(group="Nominal condition"));
  ...
  parameter Modelica.Units.SI.PressureDifference dp4_nominal(min=0, displayUnit="Pa")
    "Pressure difference" annotation (Dialog(group="Nominal condition"));
