...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IBPSA/Resources/Images/Fluid/Actuators/threeWayValvePressureDropSeries.png\"/>
</p>
<p>
...
all have a parameter <code>use_input_filter</code>.
This parameter is used as follows:
</p>
<ul>
<li>
If <code>use_input_filter=false</code>, then the actual valve
or damper position is equal to the input signal <code>y</code>.
</li>
<li>
If <code>use_input_filter=true</code>, then the actual valve or damper position
...
response gets changed. Therefore, if the parameter <code>use_input_filter</code>
...
and a valve, configured with <code>use_input_filter=true</code> and <code>riseTime=120</code> seconds.
...
The valve <code>val1</code> is configured with <code>use_input_filter=true</code>
and a rise time <code>riseTime=120</code> seconds.
The grey motor symbol above the control valve <code>val1</code>
indicates that <code>use_input_filter=true</code>.
</p>
<p align=\"center\">
...
<p>
If <code>use_input_filter=true</code>, then the parameter
