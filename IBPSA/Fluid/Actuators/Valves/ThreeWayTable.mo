...
model ThreeWayTable
  "Three way valve with table based characteristics"
...
<p>Three way valve with table-based opening characteristics. A separate characteristic for each path (port_1/port_ 2 and port_3/port_2) is used.</p>
...
<p><br><br>Further details can be found in the model <a href=\"modelica://IBPSA.Fluid.Actuators.TwoWayTable\">IBPSA.Fluid.Actuators.TwoWayTable</a>. </p>
