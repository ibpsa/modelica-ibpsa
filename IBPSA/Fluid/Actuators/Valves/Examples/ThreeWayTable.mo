...
equation
  ...
  connect(sou.ports[1], val.port_1) annotation (Line(points={{-30,0},{-5.55112e-16,
          0}},                  color={0,127,255}));
  ...
  connect(PSou.y, ret.p_in) annotation (Line(
      ...
      color={0,0,127}));
  connect(ret.ports[1], val.port_3) annotation (Line(points={{54,-70},{10,-70},{
...
<p>
Example model for table-specified three way valves.
The main flow path has a linear characteristics, and the bypass has a nonlinear
characteristics.
</p>
</html>", revisions="<html>
<ul>
<li>November 15, 2019, by Alexander K&uuml;mpel:<br/>
