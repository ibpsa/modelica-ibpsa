within IBPSA.Fluid.Sensors.Conversions.Examples;
model To_VolumeFraction "Example problem for conversion model"
  ...
  IBPSA.Fluid.Sensors.VolumeFlowRate senVolFlo(
    redeclare package Medium = Medium,
    m_flow_nominal=0.1)
  ...
  IBPSA.Fluid.Sensors.TraceSubstancesTwoPort senTraSubPeo(m_flow_nominal=0.1,
    redeclare package Medium = Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
    "CO2 concentration in absorptance from people"
    annotation (Placement(transformation(extent={{40,60},{60,80}})));
  IBPSA.Fluid.Sensors.TraceSubstancesTwoPort senTraSubFre(m_flow_nominal=0.1,
    redeclare package Medium = Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
