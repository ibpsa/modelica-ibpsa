...
model EntropyFlowRate "Test model for the entropy flow rate sensors"
  ...
  IBPSA.Fluid.Sensors.EntropyFlowRate  senS_flow(
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Examples/EntropyFlowRate.mos"
