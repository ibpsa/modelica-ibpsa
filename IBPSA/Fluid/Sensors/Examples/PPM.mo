...
model PPM "Test model for the extra property sensor outputting PPM"
  ...
  IBPSA.Fluid.Sources.FixedBoundary sin(redeclare package Medium = Medium, nPorts=2)
    "Exhaust air"
...
public
  ...
  IBPSA.Fluid.Sensors.PPM senPPMVol2(
                                      redeclare package Medium = Medium)
    "PPM sensor for mixing volume"
...
equation
  ...
  connect(mSouSta.ports[1], volSte.ports[3]) annotation (Line(points={{-20,120},
    ...
    annotation (
experiment(Tolerance=1e-6, StartTime=0.0, StopTime=3),
