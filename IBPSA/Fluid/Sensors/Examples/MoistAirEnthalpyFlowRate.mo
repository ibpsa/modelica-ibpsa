...
model MoistAirEnthalpyFlowRate
  ...
  IBPSA.Fluid.Sensors.EnthalpyFlowRate senH_flow(
  ...
  IBPSA.Fluid.Sensors.LatentEnthalpyFlowRate senHLat_flow(
    redeclare package Medium = Medium,
    m_flow_nominal=1) "Latent enthalpy flow rate sensor"
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  IBPSA.Fluid.Sensors.SensibleEnthalpyFlowRate senHSen_flow(
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Examples/MoistAirEnthalpyFlowRate.mos"
        "Simulate and plot"),
    Documentation(
    info="<html>
<p>
