...
model SpecificEntropy "Test model for the entropy flow rate sensors"
  ...
  IBPSA.Fluid.Sensors.SpecificEntropy senFloSou(
    redeclare package Medium = Medium) "Sensor at the flow source"
    annotation (Placement(transformation(extent={{-10,0},{10,20}})));
  IBPSA.Fluid.Sensors.SpecificEntropyTwoPort senStr(
    redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Examples/SpecificEntropy.mos"
