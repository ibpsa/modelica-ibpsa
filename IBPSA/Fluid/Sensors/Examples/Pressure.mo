...
<<<<<<< HEAD:Annex60/Fluid/Sensors/Examples/Pressure.mo
  package Medium = Annex60.Media.Air "Medium model";
=======
  package Medium = IBPSA.Media.Air
    "Medium model";
>>>>>>> ibpsa/master:IBPSA/Fluid/Sensors/Examples/Pressure.mo
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Examples/Pressure.mos"
        "Simulate and plot"),
