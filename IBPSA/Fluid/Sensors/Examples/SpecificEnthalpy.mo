...
model SpecificEnthalpy "Test model for the enthalpy flow rate sensors"
  ...
  IBPSA.Fluid.Sensors.SpecificEnthalpy senFloSou(
    redeclare package Medium = Medium) "Sensor at the flow source"
    annotation (Placement(transformation(extent={{-10,0},{10,20}})));
  IBPSA.Fluid.Sensors.SpecificEnthalpyTwoPort senStr(
    redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Examples/SpecificEnthalpy.mos"
