...
equation
  connect(senTem.port_b, sin_with_T.ports[1])
    annotation (Line(points={{64,0},{68,0},{76,0}},       color={0,127,255}));
  connect(bou.ports[1], senRelHum.port_a) annotation (Line(points={{-44,0},{-37,
  ...
  connect(senMasFra.port_b, senTem.port_a)
    annotation (Line(points={{30,0},{37,0},{44,0}},       color={0,127,255}));
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sources/Examples/MassFlowSourceFromOutside_T.mos"
        "Simulate and plot"),
