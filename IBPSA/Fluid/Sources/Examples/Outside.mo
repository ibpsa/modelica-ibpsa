...
equation
  ...
  connect(senMasFra.port_b, senTem.port_a) annotation (Line(
      ...
      smooth=Smooth.None));
  annotation (
experiment(Tolerance=1e-6, StartTime=0.0, StopTime=3.1536e+07),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sources/Examples/Outside.mos"
        "Simulate and plot"),
