...
model Boundary "Validation model for boundary with different media"
  ...
  Boundary_pT bouWat(redeclare package Medium = Media.Water)
    "Boundary with water"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  Boundary_pT bouProGly(
  ...
  Boundary_pT bouMoiAir(redeclare package Medium = Media.Air)
  ...
  Boundary_pT bouNatGasFix(redeclare package Medium =
