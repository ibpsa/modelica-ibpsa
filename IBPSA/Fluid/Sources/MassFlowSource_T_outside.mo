...
model MassFlowSource_T_outside
  "Ideal flow source that produces a prescribed mass flow with prescribed trace substances and outside temperature, mass fraction"
