...
model MassFlowSourceFromOutside_T
  "Ideal flow source that produces a prescribed mass flow with prescribed 
   trace substances, outside temperature and mass fraction "
...
substances, with temperature and composition from outside:
</p>
<ul>
...
<p>The <a href=\"modelica://IBPSA.Utilities.Psychrometrics.X_pTphi\">IBPSA.
Utilities.Psychrometrics.X_pTphi</a> block is used with the input data 
