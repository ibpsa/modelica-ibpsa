within IBPSA.Fluid.HeatPumps.RefrigerantCycle.Frosting.BaseClasses;
partial model PartialIcingFactor "Partial model to calculate the icing factor"
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
    ...
    \"modelica://IBPSA.Fluid.HeatPumps.RefrigerantCycle.BaseClasses.PartialRefrigerantCycle\">IBPSA.Fluid.HeatPumps.RefrigerantCycle.BaseClasses.PartialRefrigerantCycle</a>
