...
partial model PartialRefrigerantCycle
  ...
  replaceable IBPSA.Fluid.HeatPumps.RefrigerantCycle.Frosting.NoFrosting iceFacCal
  constrainedby
    IBPSA.Fluid.HeatPumps.RefrigerantCycle.Frosting.BaseClasses.PartialIcingFactor
