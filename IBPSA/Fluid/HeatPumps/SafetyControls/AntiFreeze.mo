...
<p>This models takes the minimum of the two temperatures evaporator outlet and 
...
the device to switch off. </p>
<p>Used to prevent freezing of condenser or evaporator side. 
A real device would shut off as well.</p>
<p><br><h4>Assumptions </h4></p>
<p>Assuming that the outlet temperature of an evaporator is always lower 
than the inlet temperature (for the condenser vice versa). </p>
</html>"));
end AntiFreeze;
