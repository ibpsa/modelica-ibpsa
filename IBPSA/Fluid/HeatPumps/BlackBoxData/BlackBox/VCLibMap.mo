...
equation
  ...
  connect(multiplex3_1.u2[1],sigBus.TConInMea)  annotation (Line(points={{0,85.2},
          {0,94},{0,104},{1,104}},           color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(multiplex3_1.u3[1],sigBus.TEvaInMea)  annotation (Line(points={{-4.2,
          85.2},{-4.2,88},{-14,88},{-14,104},{1,104}},     color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
  ...
  connect(switchPel.u2, sigBus.onOffMea) annotation (Line(points={{44,-6.8},{44,
          0},{88,0},{88,94},{1,94},{1,104}},            color={255,0,255}),
      Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
  ...
  connect(switchQCon.u2, sigBus.onOffMea) annotation (Line(points={{-46,-6.8},{
          -46,0},{88,0},{88,94},{0,94},{0,104},{1,104}},           color={255,0,
          255}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
