...
model IcingBlock
  ...
  parameter Integer hourDay=16
                            "Hour of the day";
  parameter IBPSA.Utilities.Time.Types.ZeroTime zerTim=IBPSA.Utilities.Time.Types.ZeroTime.NY2016
  ...
  replaceable function iceFunc =
    ...
    IBPSA.Fluid.HeatPumps.BlackBoxData.Functions.IcingFactor.PartialBaseFct                                                           "Replaceable function to calculate current icing factor" annotation(choicesAllMatching=true);
