...
<p><span style=\"font-family: Courier New; color: #006400;\">Model&nbsp;to&nbsp;use&nbsp;to&nbsp;avoid&nbsp;warnings&nbsp;about&nbsp;partial&nbsp;model&nbsp;must&nbsp;be&nbsp;replaced. Using this model, the heat pump will always be off.</span></p>
</html>"));
end NoHeating;
