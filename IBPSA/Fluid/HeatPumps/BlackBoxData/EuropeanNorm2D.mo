...
(formerly EN255) to calculate <code>QCon</code> and <code>P_el</code>. </p>
<p>To model an inverter controlled heat pump, the relative <b>compressor 
speed <code>ySet</code> is scaled linearly</b> with the ouput of the tables.</p>
<p>Furthermore, the design of a heat pump is modeled via a scaling factor. 
