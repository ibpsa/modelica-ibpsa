...
<li><a href=\"IBPSA.Fluid.HeatPumps.SafetyControls.SafetyControl\">IBPSA.Fluid.HeatPumps.SafetyControls.SafetyControl</a>: Refrigerant machines contain internal safety controls, prohibiting operations in possibly unsafe points. This model account for such typical controls. All options can be disabled, if required. Please look at the model description for more info. </li>
</ol>
<h4>Assumptions </h4>
