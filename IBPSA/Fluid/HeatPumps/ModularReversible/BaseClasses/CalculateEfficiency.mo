...
model CalculateEfficiency
  ...
  IBPSA.Utilities.Math.InverseXRegularized invXReg(delta=PEleMin)
...
equation
  ...
  connect(copCom.u2, invXReg.y) annotation (Line(points={{8,44},{-14,44},{-14,
          30},{-19,30}}, color={0,0,127}));
  connect(invXReg.u, PEle) annotation (Line(points={{-42,30},{-88,30},{-88,-40},
          {-92,-40},{-92,-70},{-120,-70}}, color={0,0,127}));
