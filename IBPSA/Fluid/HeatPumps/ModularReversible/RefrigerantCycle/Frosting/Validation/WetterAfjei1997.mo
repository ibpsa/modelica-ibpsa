within IBPSA.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.Validation;
...
equation
  ...
  annotation (   __Dymola_Commands(file=
     "modelica://IBPSA/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/RefrigerantCycle/Frosting/Validation/WetterAfjei1997.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=35,
