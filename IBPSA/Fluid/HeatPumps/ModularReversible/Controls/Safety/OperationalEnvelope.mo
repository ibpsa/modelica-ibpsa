...
equation
  if use_TConOutHea then
    connect(bouMapHea.TUseSid, sigBus.TConOutMea) annotation (Line(points={{-62.8,
            48},{-104,48},{-104,-61},{-119,-61}},                       color={0,
            0,127}));
  else
    connect(bouMapHea.TUseSid, sigBus.TConInMea) annotation (Line(points={{-62.8,
            48},{-104,48},{-104,-61},{-119,-61}},                       color={0,
            0,127}));
  end if;
  if use_TEvaOutCoo then
    connect(bouMapCoo.TAmbSid, sigBus.TEvaOutMea) annotation (Line(points={{-63.2,
            -40},{-104,-40},{-104,-61},{-119,-61}},
                                                color={0,0,127}));
  else
    connect(bouMapCoo.TAmbSid, sigBus.TEvaInMea) annotation (Line(points={{-63.2,
            -40},{-104,-40},{-104,-61},{-119,-61}},
                                                color={0,0,127}));
  end if;
  if use_TEvaOutHea then
    connect(bouMapHea.TAmbSid, sigBus.TEvaOutMea) annotation (Line(points={{-63.2,
            32},{-104,32},{-104,-60},{-106,-60},{-106,-61},{-119,-61}},
                                                color={0,0,127}));
  else
    connect(bouMapHea.TAmbSid, sigBus.TEvaInMea) annotation (Line(points={{-63.2,
            32},{-104,32},{-104,-60},{-112,-60},{-112,-61},{-119,-61}},
                                                color={0,0,127}));
  end if;
  if use_TConOutCoo then
    connect(bouMapCoo.TUseSid, sigBus.TConOutMea) annotation (Line(points={{-62.8,
            -24},{-104,-24},{-104,-60},{-112,-60},{-112,-61},{-119,-61}},
                                                      color={0,0,127}));
  else
    connect(bouMapCoo.TUseSid, sigBus.TConInMea) annotation (Line(points={{-62.8,
            -24},{-104,-24},{-104,-60},{-112,-60},{-112,-61},{-119,-61}},
                                                      color={0,0,127}));
  end if;
