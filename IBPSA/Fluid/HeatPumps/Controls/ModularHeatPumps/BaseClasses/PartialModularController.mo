within IBPSA.Fluid.HeatPumps.Controls.ModularHeatPumps.BaseClasses;
partial model PartialModularController
  ...
  parameter Boolean reverseAction[nCom] = fill(false,nCom)
    ...
    annotation(Dialog(tab="Controller",group="General"),
               HideResult=true);
  parameter IBPSA.Types.Reset reset[nCom]=
    fill(IBPSA.Types.Reset.Disabled,nCom)
  ...
  //
  IBPSA.Controls.Continuous.LimPID intCon[nCom](
  ...
  IBPSA.Controls.Interfaces.ModularHeatPumpControlBus dataBus
    "Data bus with control signals"
...
<p>
  ...
  \"modelica://IBPSA.Controls.Interfaces.ModularHeatPumpControlBus\">IBPSA.Controls.Interfaces.ModularHeatPumpControlBus</a>,
  ...
  presented in <a href=
  \"modelica://IBPSA.Controls.Continuous.LimPID\">IBPSA.Controls.Continuous.LimPID</a>
