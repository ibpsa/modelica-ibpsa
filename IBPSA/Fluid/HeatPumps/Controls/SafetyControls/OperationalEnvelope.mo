...
model OperationalEnvelope
  ...
  IBPSA.Fluid.HeatPumps.Controls.SafetyControls.BaseClasses.BoundaryMap bouMapHea(
    final tab=tabUppHea,
    final dT=dTHys,
  ...
  IBPSA.Fluid.HeatPumps.Controls.SafetyControls.BaseClasses.BoundaryMap bouMapCoo(
    final tab=tabLowCoo,
    final dT=dTHys,
