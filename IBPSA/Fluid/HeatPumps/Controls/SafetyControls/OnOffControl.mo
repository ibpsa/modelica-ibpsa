...
model OnOffControl
  ...
  IBPSA.Fluid.HeatPumps.Controls.SafetyControls.BaseClasses.RunPerHouBoundary runPerHouBou(final
      maxRunPerHou=maxRunPerHou, final delTim=3600) if use_runPerHou
    "Check number of starts violations"
    annotation (Placement(transformation(extent={{20,-60},{40,-40}})));
  IBPSA.Fluid.HeatPumps.Controls.SafetyControls.BaseClasses.TimeControl locTimCtr(final
  ...
  IBPSA.Fluid.HeatPumps.Controls.SafetyControls.BaseClasses.TimeControl runTimCtr(final
