...
model SafetyControl "Example for usage of all safety controls"
  ...
  IBPSA.Fluid.HeatPumps.Controls.SafetyControls.SafetyControl safCtr(
    mEva_flow_nominal=0.01,
    mCon_flow_nominal=0.01,
    ySet_small=0.01,
    forHeaPum=true,
    redeclare
      IBPSA.Fluid.HeatPumps.Controls.SafetyControls.RecordsCollection.DefaultHeatPumpSafetyControl
      safCtrPar(
      minRunTime=5,
      minLocTime=5,
      use_antFre=true,
...
<p>
  ...
  <a href=\"modelica://IBPSA.Fluid.HeatPumps.Controls.SafetyControls.SafetyControl\">
