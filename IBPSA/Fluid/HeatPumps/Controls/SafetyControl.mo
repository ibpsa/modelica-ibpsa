...
block SafetyControl "Block including all safety levels"
  ...
  IBPSA.Fluid.HeatPumps.Controls.OperationalEnvelope operationalEnvelope(
  ...
  IBPSA.Fluid.HeatPumps.Controls.OnOffControl onOffController(
  ...
  IBPSA.Fluid.HeatPumps.Controls.DefrostControl defrostControl(
  ...
  Modelica.Blocks.Interfaces.RealOutput Pel_deFro if not use_chiller and
    ...
    "Relative speed of compressor. From 0 to 1" annotation (Placement(
        ...
        rotation=180,
        origin={130,80})));
  IBPSA.Fluid.HeatPumps.Controls.AntiFreeze antiFreeze(final TAntFre=TantFre,
