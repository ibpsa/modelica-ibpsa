within IBPSA.Fluid.Delays.Examples;
model Delay
...
// that is used in this model.
 package Medium = IBPSA.Media.Air(X_default={0.001, 0.999});
  ...
  IBPSA.Fluid.Delays.DelayFirstOrder del(         m_flow_nominal=5, redeclare
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Delays/Examples/Delay.mos"
        "Simulate and plot"));
end Delay;
