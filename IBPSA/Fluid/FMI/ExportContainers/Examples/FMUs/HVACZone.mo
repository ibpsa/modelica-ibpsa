...
block HVACZone
  ...
  extends IBPSA.Fluid.FMI.ExportContainers.HVACZone(
  ...
  IBPSA.Fluid.Sources.Outside out(
    redeclare package Medium = MediumA,
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HVACZone.mos"
        "Export FMU"));
end HVACZone;
