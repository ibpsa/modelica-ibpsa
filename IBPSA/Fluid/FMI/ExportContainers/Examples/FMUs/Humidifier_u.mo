...
block Humidifier_u
  "Declaration of an FMU that exports an ideal humidifier"
   extends IBPSA.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final IBPSA.Fluid.MassExchangers.Humidifier_u com(
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/Humidifier_u.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
