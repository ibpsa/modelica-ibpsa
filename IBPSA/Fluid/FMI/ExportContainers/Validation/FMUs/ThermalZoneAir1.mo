...
block ThermalZoneAir1 "Validation of simple thermal zone"
  extends IBPSA.Fluid.FMI.ExportContainers.ThermalZone(
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Validation/FMUs/ThermalZoneAir1.mos"
        "Export FMU"));
end ThermalZoneAir1;
