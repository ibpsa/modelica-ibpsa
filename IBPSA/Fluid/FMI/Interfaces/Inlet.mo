...
connector Inlet "Connector for fluid inlet"
  ...
  IBPSA.Fluid.FMI.Interfaces.PressureInput p if
     use_p_in "Thermodynamic pressure in the connection point";

  input IBPSA.Fluid.FMI.Interfaces.FluidProperties forward(
    redeclare final package Medium = Medium) "Inflowing properties";
  output IBPSA.Fluid.FMI.Interfaces.FluidProperties backward(
