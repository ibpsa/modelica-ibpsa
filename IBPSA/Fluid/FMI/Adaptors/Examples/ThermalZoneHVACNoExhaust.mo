within IBPSA.Fluid.FMI.Adaptors.Examples;
model ThermalZoneHVACNoExhaust
  ...
  IBPSA.Fluid.FMI.Adaptors.HVAC hvacAda(
  ...
  IBPSA.Fluid.FMI.Adaptors.ThermalZone con(
  ...
  Movers.FlowControlled_m_flow mov(
    ...
    use_input_filter=false) "Fan or pump"
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/FMI/Adaptors/Examples/ThermalZoneHVACNoExhaust.mos"
        "Simulate and plot"),
