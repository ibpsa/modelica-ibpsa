...
model InletToAirMoistAir
  ...
  IBPSA.Fluid.FMI.Conversion.InletToAir conAir(
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirMoistAir.mos"
        "Simulate and plot"),
