...
model StratifiedUnloadAtMinimumTemperature
  ...
  Buildings.Controls.OBC.CDL.Logical.OnOffController onOffMid(bandwidth=0.1)
    "Controller for valve at middle of tank"
    annotation (Placement(transformation(extent={{-50,70},{-30,90}})));
  Buildings.Controls.OBC.CDL.Logical.And and2
    "And block to compute control action for middle valve"
    annotation (Placement(transformation(extent={{10,70},{30,90}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal yMid
    "Boolean to real conversion for valve at middle"
    annotation (Placement(transformation(extent={{80,70},{100,90}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal yTop
  ...
  Buildings.Controls.OBC.CDL.Logical.OnOffController onOffHea(bandwidth=0.1)
    "Controller for heater at bottom"
    annotation (Placement(transformation(extent={{-210,-134},{-190,-114}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal yHea(realTrue=150000)
    "Boolean to real for valve at bottom"
    annotation (Placement(transformation(extent={{-180,-134},{-160,-114}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal yBot
...
equation
  ...
  annotation (Diagram(
       ...
       __Dymola_Commands(file=
          "modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Storage/Examples/StratifiedUnloadAtMinimumTemperature.mos"
        "Simulate and plot"),
    experiment(
      StopTime=21600,
      Tolerance=1e-06,
