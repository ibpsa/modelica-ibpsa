...
model FlatPlateNPanels
  ...
  extends IBPSA.Fluid.SolarCollectors.Validation.FlatPlate;
  parameter Integer nPanels = 10 "Number of panels";
  IBPSA.Fluid.SolarCollectors.ASHRAE93
   solCol1(
    redeclare package Medium = Medium,
    shaCoe=0,
    azi=0,
    per=IBPSA.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_TRNSYSValidation(),
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/1073\">#1073</a>.
  ...
  __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/FlatPlateNPanels.mos"
    "Simulate and plot"),
