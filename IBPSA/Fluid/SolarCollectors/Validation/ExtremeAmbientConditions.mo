within IBPSA.Fluid.SolarCollectors.Validation;
model ExtremeAmbientConditions
  "Validation model for to ensure that collectors do not freeze or boil"
  extends Modelica.Icons.Example;

  replaceable package Medium = IBPSA.Media.Water(T_min=273.15, T_max=273.15+100)
  ...
  EN12975 solEn(
    ...
    azi=0.3,
    til=0.5,
    per=IBPSA.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_VerificationModel(),
...
IBPSA.Fluid.SolarCollectors.ASHRAE93</a>
and
<a href=\"modelica://IBPSA.Fluid.SolarCollectors.EN12975\">
IBPSA.Fluid.SolarCollectors.EN12975</a>.
</p>
<p>
Note that the medium has been declared
as <code>IBPSA.Media.Water(T_min=273.15, T_max=273.15+100)</code>
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/ExtremeAmbientConditions.mos"
        "Simulate and plot"),
