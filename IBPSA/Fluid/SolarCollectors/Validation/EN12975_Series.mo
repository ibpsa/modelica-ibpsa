...
model EN12975_Series
  ...
  model Collector
    extends IBPSA.Fluid.SolarCollectors.EN12975(
    redeclare final package Medium = IBPSA.Media.Water,
    final show_T = true,
    final per=IBPSA.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_VerificationModel(),
    final shaCoe=0,
    final azi=0,
    final energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    final rho=0.2,
    final nColType=IBPSA.Fluid.SolarCollectors.Types.NumberSelection.Number,
    nPanels=1,
    final til=0.78539816339745,
    final use_shaCoe_in=false,
    final sysConfig=IBPSA.Fluid.SolarCollectors.Types.SystemConfiguration.Series);
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/1100\">#1100</a>.
    ...
    __Dymola_Commands(file=
          "modelica://IBPSA/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/EN12975_Series.mos"
        "Simulate and plot"),
