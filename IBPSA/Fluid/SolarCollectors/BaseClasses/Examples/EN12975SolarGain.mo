...
model EN12975SolarGain "Example showing the use of EN12975SolarGain"
  ...
  parameter IBPSA.Fluid.SolarCollectors.Data.GenericEN12975 per=
    IBPSA.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_VerificationModel()
    "Performance data"
    annotation (choicesAllMatching=true);
  IBPSA.Fluid.SolarCollectors.BaseClasses.EN12975SolarGain solGai(
    eta0=per.eta0,
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/SolarCollectors/BaseClasses/Examples/EN12975SolarGain.mos"
        "Simulate and plot"),
