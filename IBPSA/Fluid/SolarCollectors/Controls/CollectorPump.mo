within IBPSA.Fluid.SolarCollectors.Controls;
model CollectorPump
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanOutput on
    "Ouputs true if collector pump should be on"
    annotation (Placement(transformation(extent={{100,-20},{140,20}})));

  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data input"
    annotation (Placement(transformation(extent={{-110,40},{-90,60}})));

  IBPSA.Fluid.SolarCollectors.Controls.BaseClasses.GCritCalc criSol(
  ...
  IBPSA.Controls.OBC.CDL.Reals.Add HTotTil(
    u1(final unit="W/m2"),
    u2(final unit="W/m2"),
    y(final unit="W/m2"))
...
Moved old model to <code>IBPSA.Obsolete</code> package.<br/>
This is for
