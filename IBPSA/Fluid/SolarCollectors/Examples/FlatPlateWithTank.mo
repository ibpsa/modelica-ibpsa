within IBPSA.Fluid.SolarCollectors.Examples;
model FlatPlateWithTank
  ...
  replaceable package Medium_2 = IBPSA.Media.Water "Fluid flowing through the collector";
  ...
  IBPSA.Fluid.SolarCollectors.ASHRAE93 solCol(
    ...
    per=IBPSA.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_SolahartKf(),
    nSeg=9,
    final azi=azi,
    final til=til,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort TIn(m_flow_nominal=m_flow_nominal,
    redeclare package Medium = Medium_2) "Temperature sensor"
  ...
  IBPSA.Fluid.Storage.StratifiedEnhancedInternalHex
   tan(
    ...
    annotation (Placement(transformation(
      extent={{-20,-20},{20,20}},
      origin={100,-20})));
  IBPSA.Fluid.SolarCollectors.Controls.CollectorPump pumCon(
    per=IBPSA.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_ThermaLiteHS20(),
    final azi=azi,
    final til=til,
    final rho=rho)
    "Pump controller"
  ...
  IBPSA.Controls.OBC.CDL.Conversions.BooleanToReal booToRea(realTrue=
        m_flow_nominal)
...
equation
  ...
  annotation (
   __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/SolarCollectors/Examples/FlatPlateWithTank.mos"
        "Simulate and plot"),
...
IBPSA.Fluid.Storage.StratifiedEnhancedInternalHex</a> (tan) model is
...
IBPSA.Fluid.Movers.FlowControlled_m_flow</a>, pum), 
passes the water through an expansion tank
(<a href=\"modelica://IBPSA.Fluid.Storage.ExpansionVessel\">
IBPSA.Fluid.Storage.ExpansionVessel</a>, exp),
a temperature sensor
(<a href=\"modelica://IBPSA.Fluid.Sensors.TemperatureTwoPort\">
IBPSA.Fluid.Sensors.TemperatureTwoPort</a>, TIn),
the solar collector
(<a href=\"modelica://IBPSA.Fluid.SolarCollectors.ASHRAE93\">
IBPSA.Fluid.SolarCollectors.ASHRAE93,</a> solCol),
and a second temperature sensor
(<a href=\"modelica://IBPSA.Fluid.Sensors.TemperatureTwoPort\">
IBPSA.Fluid.Sensors.TemperatureTwoPort</a>, TOut)
...
IBPSA.BoundaryConditions.WeatherData.ReaderTMY3</a>, weaDat) which passes
...
(<a href=\"modelica://IBPSA.Fluid.SolarCollectors.Controls.CollectorPump\">
IBPSA.Fluid.SolarCollectors.Controls.CollectorPump</a>, pumCon)
and a gain model.
...
<p>
bou1 (<a href=\"modelica://IBPSA.Fluid.Sources.MassFlowSource_T\">
IBPSA.Fluid.Sources.MassFlowSource_T)</a> provides a constant mass flow
