...
model PipeCore
  ...
  parameter IBPSA.Fluid.PlugFlowPipess.Types.ThermalResistanceLength R=1/(
      lambdaI*2*Modelica.Constants.pi/Modelica.Math.log((diameter/2 +
      thicknessIns)/(diameter/2)));
  parameter IBPSA.Fluid.PlugFlowPipess.Types.ThermalCapacityPerLength C=
  ...
  IBPSA.Fluid.PlugFlowPipess.BaseClasses.PipeAdiabaticPlugFlow pipeAdiabaticPlugFlow(
...
public
  IBPSA.Fluid.PlugFlowPipess.BaseClasses.HeatLossPipeDelay reverseHeatLoss(
  ...
  IBPSA.Fluid.PlugFlowPipess.BaseClasses.HeatLossPipeDelay heatLoss(
    redeclare package Medium = Medium,
    diameter=diameter,
    length=length,
    C=C,
  ...
  IBPSA.Fluid.PlugFlowPipess.BaseClasses.TimeDelay timeDelay(
    length=length,
    diameter=diameter,
    rho=rho_default,
    initDelay=initDelay,
