within IBPSA.Fluid.Chillers.Validation;
...
protected
  model Chiller "Subsystem model with the chiller"
   ...
   replaceable package Medium2 = Modelica.Media.Interfaces.PartialMedium
    ...
    IBPSA.Fluid.Sources.FixedBoundary sin1(redeclare package Medium = Medium2, nPorts=1)
    ...
    IBPSA.Fluid.Sources.FixedBoundary sin2(redeclare package Medium = Medium2, nPorts=1)
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Chillers/Validation/Carnot_TEva_2ndLaw.mos"
        "Simulate and plot"),
