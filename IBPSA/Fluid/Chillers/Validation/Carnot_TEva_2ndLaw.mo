...
protected
  model Chiller "Subsystem model with the chiller"
   ...
   replaceable package Medium2 = Modelica.Media.Interfaces.PartialMedium
    ...
    IBPSA.Fluid.Sources.Boundary_pT sin1(redeclare package Medium = Medium2, nPorts=1)
    ...
    IBPSA.Fluid.Sources.Boundary_pT sin2(redeclare package Medium = Medium2, nPorts=1)
