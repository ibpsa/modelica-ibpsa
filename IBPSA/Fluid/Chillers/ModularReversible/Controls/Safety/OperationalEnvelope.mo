...
equation
  if use_TAmbSidOut then
    connect(bouMapCoo.TAmbSid, sigBus.TConOutMea) annotation (Line(points={{-84.8,
            -62},{-104,-62},{-104,-73},{-119,-73}},
                                              color={0,0,127}));
    connect(bouMapHea.TAmbSid, sigBus.TConOutMea) annotation (Line(points={{-84.8,
            58},{-94,58},{-94,-72},{-104,-72},{-104,-73},{-119,-73}},
                                                                color={0,0,127}));
  else
    connect(bouMapCoo.TAmbSid, sigBus.TConInMea) annotation (Line(points={{-84.8,-62},
            {-104,-62},{-104,-73},{-119,-73}},color={0,0,127}));
    connect(bouMapHea.TAmbSid, sigBus.TConInMea) annotation (Line(points={{-84.8,58},
            {-94,58},{-94,-72},{-104,-72},{-104,-73},{-119,-73}},
                                                                color={0,0,127}));
  end if;
  if use_TUseSidOut then
    connect(bouMapHea.TUseSid, sigBus.TEvaOutMea) annotation (Line(points={{-84.2,
            82},{-94,82},{-94,-73},{-119,-73}},   color={0,0,127}));
    connect(bouMapCoo.TUseSid, sigBus.TEvaOutMea) annotation (Line(points={{-84.2,
            -38},{-104,-38},{-104,-73},{-119,-73}}, color={0,0,127}));
  else
    connect(bouMapHea.TUseSid, sigBus.TEvaInMea) annotation (Line(points={{-84.2,82},
            {-94,82},{-94,-73},{-119,-73}},       color={0,0,127}));
    connect(bouMapCoo.TUseSid, sigBus.TEvaInMea) annotation (Line(points={{-84.2,-38},
            {-104,-38},{-104,-73},{-119,-73}},      color={0,0,127}));
  end if;
  connect(notCoo.y, swiHeaCoo.u2)
    annotation (Line(points={{-39,0},{-6,0}}, color={255,0,255}));
  connect(notCoo.u, sigBus.coo) annotation (Line(points={{-62,0},{-92,0},{-92,-73},
          {-119,-73}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
