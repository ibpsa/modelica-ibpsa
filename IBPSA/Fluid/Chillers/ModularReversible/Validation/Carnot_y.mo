...
equation
  ...
  connect(chi.port_a1, sou1.ports[1]) annotation (Line(points={{-12,6},{-40,6}},
                       color={0,127,255}));
  connect(chi.y, uCom.y)
    annotation (Line(points={{-14,9},{-14,50},{-39,50}}, color={0,0,127}));

  annotation (experiment(Tolerance=1e-6, StopTime=3600),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Validation/Carnot_y.mos"
        "Simulate and plot"),
...
<p>
Validation case for <a href=\"modelica://IBPSA.Fluid.Chillers.Carnot_y\">
IBPSA.Fluid.Chillers.Carnot_y</a>, duplicate of the example
