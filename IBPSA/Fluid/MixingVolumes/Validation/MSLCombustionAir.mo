...
equation
  ...
  experiment(
    Tolerance=1E-6,
    StopTime=1),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MSLCombustionAir.mos"
        "Simulate and plot"),
    Documentation(
info = "<html>
<p>
...
<p>
This medim differs from media in the IBPSA library in that it has no substance <code>water</code>
