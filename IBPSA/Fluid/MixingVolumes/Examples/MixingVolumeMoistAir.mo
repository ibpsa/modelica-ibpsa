within IBPSA.Fluid.MixingVolumes.Examples;
...
experiment(StartTime=0.0, StopTime=600,
           Tolerance=1E-6),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/MixingVolumes/Examples/MixingVolumeMoistAir.mos"
        "Simulate and plot"),
