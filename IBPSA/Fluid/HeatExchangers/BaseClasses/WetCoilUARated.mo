...
model WetCoilUARated
  ...
  replaceable package MediumA=IBPSA.Media.Air
    constrainedby Modelica.Media.Interfaces.PartialMedium
    "Air-side medium";
  replaceable package MediumW=IBPSA.Media.Water
    constrainedby Modelica.Media.Interfaces.PartialMedium
    "Water-side medium";
...
protected
  constant Modelica.Units.SI.SpecificEnthalpy hfg=IBPSA.Utilities.Psychrometrics.Constants.h_fg
  ...
  parameter Modelica.Units.SI.AbsolutePressure pSatTWatIn=
      IBPSA.Utilities.Psychrometrics.Functions.saturationPressure(TWatIn)
    "Saturation pressure of water at the water inlet temperature";
  parameter Modelica.Units.SI.MassFraction X_wSatTWatIn=
      IBPSA.Utilities.Psychrometrics.Functions.X_pSatpphi(
      pSat=pSatTWatIn,
      p=MediumA.p_default,
      phi=1)
  ...
  parameter Modelica.Units.SI.AbsolutePressure pSatTWatOut=
      IBPSA.Utilities.Psychrometrics.Functions.saturationPressure(TWatOut)
