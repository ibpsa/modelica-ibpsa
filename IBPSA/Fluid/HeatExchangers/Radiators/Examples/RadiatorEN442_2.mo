within IBPSA.Fluid.HeatExchangers.Radiators.Examples;
model RadiatorEN442_2 "Test model for radiator"
 ...
 package Medium = IBPSA.Media.Water "Medium model";
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTemRad1Inl(
