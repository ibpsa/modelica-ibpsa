...
model ConstantEffectiveness
 ...
 package Medium2 = IBPSA.Media.Air "Medium model";
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort T_a1(
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/ConstantEffectiveness.mos"
        "Simulate and plot"),
