...
record c8x8_h110_b5_d600_T283
  ...
  extends Records.General(
    pathMod=
        "IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Data.GeneralData.c8x8_h110_b5_d600_T283",
    pathCom=Modelica.Utilities.Files.loadResource(
        "modelica://IBPSA/Fluid/HeatExchangers/GroundHeatExchangers/Data/GeneralData/c8x8_h110_b5_d600_T283.mo"),
    singleUTube = true,
