...
function multipole_ThermalResistances
...
algorithm
  for m in 1:nPip loop
    ...
    TFlu :=
      IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.BaseClasses.BoreholeThermalResistances.multipole_FluidTemperature(
      nPip,
      J,
      xPip,
      yPip,
...
end multipole_ThermalResistances;
