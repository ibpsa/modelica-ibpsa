...
model LoadAggregation_WithHistory
  ...
  GroundTemperatureResponse loaAgg(
    ...
    prevQFilNam="C:/repos/mod-bee/BEE/Resources/Fluid/Geothermal/BoreholeHeatExchangers/BaseClasses/Aggregation/Validation/Data_for_Load_History.txt")
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/HeatExchangers/GroundHeatExchangers/BaseClasses/LoadAggregation/Validation/LoadAggregation_WithHistory.mos"
        "Simulate and plot"));
