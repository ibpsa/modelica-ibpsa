...
__Dymola_Commands(file="modelica://BEE/Resources/Scripts/Dymola/Fluid/Geothermal/BoreholeHeatExchangers/BaseClasses/Aggregation/Validation/LoadAggregation_PrescribedQ.mos"
        "Simulate and plot"));
