...
function saveAggregationMatrix
  ...
  input IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Data.Records.Soil soi
    "Thermal properties of the ground";
  input IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Data.Records.General
  ...
  output Real[1,gen.tBre_d + 1] TResSho
    "Short term response temperature vector of the borefield obtained calling the model IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.BoreHoles.Examples.SingleBoreHoleSerStepLoadScript";
...
The borefield model with this BfData record has not yet been initialized. Please firstly run the following command in the command log: \n"
     + "IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.Scripts.initializeModel("
     + "soi=" + soi.pathMod + "(), " + "fil="
...
************************************************************************************************************************ \n ");
  ...
  if not existShoTerRes or not Modelica.Utilities.Files.exist(pathSave + "Agg" +
    ...
    TWallSteSta :=
      IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.GroundModel.CorrectedBoreFieldWallTemperature(
      gen=gen,
      soi=soi,
      TResSho=TResSho[1, :],
      t_d=gen.tSteSta_d);
    ...
    kappaMat :=
      IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.Aggregation.AggregationMassimo(
      q_max=q_max,
      p_max=p_max,
      gen=gen,
      soi=soi,
    ...
    Borefield2.BaseClasses.Aggregation.transientFrac and GroundHX.CorrectedBoreFieldWallTemperature and saved under the name SHA+Agg or TWallSteSta+lenSim+.mat.</p>
</html>", revisions="<html>
<ul>
<li>
