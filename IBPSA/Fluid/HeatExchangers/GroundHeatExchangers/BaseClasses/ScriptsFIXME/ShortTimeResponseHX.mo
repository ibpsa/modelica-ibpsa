...
function ShortTimeResponseHX
  ...
  input IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Data.Records.General
    gen=
      IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Data.ConfigurationData.c8x1_h110_b5_d3600_T283()
...
protected
  final parameter String modelToSimulate= if gen.singleUTube then "IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.BoreHoles.Examples.SingleBoreHoleUTubeSerStepLoadScript"
 else "IBPSA.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.BoreHoles.Examples.SingleBoreHole2UTubeSerStepLoadScript"
    "model to simulate";
