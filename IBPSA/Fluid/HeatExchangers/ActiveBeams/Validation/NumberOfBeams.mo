within IBPSA.Fluid.HeatExchangers.ActiveBeams.Validation;
model NumberOfBeams
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-200,
   ...
   __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Validation/NumberOfBeams.mos"
        "Simulate and plot"),
