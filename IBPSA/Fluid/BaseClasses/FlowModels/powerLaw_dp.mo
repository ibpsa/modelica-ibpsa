...
annotation (
  ...
  derivative(
    ...
    zeroDerivative=b3,
    zeroDerivative=b5)=
      IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_dp_der,
  inverse(
...
<a href=\"modelica://IBPSA.Fluid.BaseClasses.FlowModels.powerLawData\">
IBPSA.Fluid.BaseClasses.FlowModels.powerLawData</a>
...
IBPSA.Airflow.Multizone.BaseClasses.powerLawFixedM</a> except that it
