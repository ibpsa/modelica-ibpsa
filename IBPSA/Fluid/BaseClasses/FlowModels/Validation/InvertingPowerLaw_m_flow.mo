...
model InvertingPowerLaw_m_flow
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Validation/InvertingPowerLaw_m_flow.mos"
        "Simulate and plot"),
