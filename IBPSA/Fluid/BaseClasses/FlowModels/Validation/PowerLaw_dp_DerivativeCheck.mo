...
experiment(
      ...
      StopTime=2,
      Tolerance=1e-8),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Validation/PowerLaw_dp_DerivativeCheck.mos"
        "Simulate and plot"),
...
<a href=\"modelica://IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_dp_der\">
IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_dp_der</a>.
