...
initial equation
  (dp_turbulent, m, a1, a3, a5, C, b1, b3, b5) =
    IBPSA.Fluid.BaseClasses.FlowModels.powerLawData(
...
equation
  ...
  // in IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_m_flow_der2
  m_flow = time^3/8;

  dp = IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_m_flow(
    m_flow=m_flow,
    k=k,
    n=n,
...
experiment(
      ...
      StopTime=2,
      Tolerance=1e-8),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Validation/PowerLaw_m_flow_DerivativeCheck2.mos"
        "Simulate and plot"),
...
<a href=\"modelica://IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_m_flow_der2\">
IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_m_flow_der2</a>.
