...
equation
  ...
  // in IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_dp_der2
  dp = 1*time^3;

  m_flow = IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_dp(
    dp=dp,
    k=k,
    n=n,
...
experiment(
      ...
      StopTime=2,
      Tolerance=1e-08),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Validation/PowerLaw_dp_DerivativeCheck2.mos"
        "Simulate and plot"),
...
<a href=\"modelica://IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_dp_der2\">
IBPSA.Fluid.BaseClasses.FlowModels.powerLaw_dp_der2</a>.
