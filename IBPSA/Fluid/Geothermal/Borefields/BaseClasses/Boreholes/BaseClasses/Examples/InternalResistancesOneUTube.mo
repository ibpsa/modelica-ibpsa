within IBPSA.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.Examples;
...
equation
  ...
  experiment(StopTime=3600, Tolerance=1e-6),
    __Dymola_Commands(file=
          "modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Examples/InternalResistancesOneUTube.mos"
        "Simulate and plot"),
  Documentation(info="<html>
  This example tests the implementation of
<a href=\"modelica://IBPSA.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalResistancesOneUTube\">
