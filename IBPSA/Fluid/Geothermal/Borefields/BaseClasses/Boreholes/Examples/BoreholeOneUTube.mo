...
model BoreholeOneUTube "Test for the single U-tube borehole model"
  ...
  annotation (
    __Dymola_Commands( file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/Examples/BoreholeOneUTube.mos"
        "Simulate and plot"),
...
<a href=\"modelica://IBPSA.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.OneUTube\">
