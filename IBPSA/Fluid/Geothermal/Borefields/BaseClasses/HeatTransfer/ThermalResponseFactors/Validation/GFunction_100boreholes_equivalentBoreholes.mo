...
model GFunction_100boreholes_equivalentBoreholes
  ...
  parameter Integer n_clusters=5 "Number of clusters to be generated";
...
initial equation
  ...
  (labels, cluster_size) = IBPSA.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.clusterBoreholes(nBor,cooBor,hBor,dBor,rBor,n_clusters);
  (tGFun,gFun) =
    IBPSA.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.gFunction_equivalentBoreholes(
      nBor = nBor,
      cooBor = cooBor,
      hBor = hBor,
      dBor = dBor,
...
end GFunction_100boreholes_equivalentBoreholes;
