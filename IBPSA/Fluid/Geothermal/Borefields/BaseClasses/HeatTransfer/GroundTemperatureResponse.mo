...
protected
  constant Integer maxSiz = 1500 "Max total number of segments in g-function calculation";
  final parameter Integer nSeg = integer(if 12*borFieDat.conDat.nBor<maxSiz then 12 else floor(maxSiz/borFieDat.conDat.nBor));
