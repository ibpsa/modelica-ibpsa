...
initial algorithm
  ...
  assert(not zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom
  ...
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.UnixTimeStampGMT then
    timOff :=timZon;
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2010 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2010 then
      timOff :=timeStampsNewYear[1];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2011 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2011 then
      timOff :=timeStampsNewYear[2];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2012 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2012 then
      timOff :=timeStampsNewYear[3];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2013 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2013 then
      timOff :=timeStampsNewYear[4];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2014 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2014 then
      timOff :=timeStampsNewYear[5];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2015 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2015 then
      timOff :=timeStampsNewYear[6];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2016 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2016 then
      timOff :=timeStampsNewYear[7];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2017 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2017 then
      timOff :=timeStampsNewYear[8];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2018 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2018 then
      timOff :=timeStampsNewYear[9];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2019 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2019 then
      timOff :=timeStampsNewYear[10];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2020 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2020 then
      timOff :=timeStampsNewYear[11];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2021 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2021 then
      timOff :=timeStampsNewYear[12];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2022 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2022 then
      timOff :=timeStampsNewYear[13];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2023 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2023 then
      timOff :=timeStampsNewYear[14];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2024 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2024 then
      timOff := timeStampsNewYear[14];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2025 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2025 then
      timOff := timeStampsNewYear[15];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2026 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2026 then
      timOff := timeStampsNewYear[16];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2027 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2027 then
      timOff := timeStampsNewYear[17];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2028 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2028 then
      timOff := timeStampsNewYear[18];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2029 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2029 then
      timOff := timeStampsNewYear[19];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2030 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2030 then
      timOff := timeStampsNewYear[20];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2031 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2031 then
      timOff := timeStampsNewYear[21];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2032 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2032 then
      timOff := timeStampsNewYear[22];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2033 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2033 then
      timOff := timeStampsNewYear[23];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2034 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2034 then
      timOff := timeStampsNewYear[24];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2035 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2035 then
      timOff := timeStampsNewYear[25];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2036 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2036 then
      timOff := timeStampsNewYear[26];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2037 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2037 then
      timOff := timeStampsNewYear[27];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2038 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2038 then
      timOff := timeStampsNewYear[28];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2039 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2039 then
      timOff := timeStampsNewYear[29];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2040 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2040 then
      timOff := timeStampsNewYear[30];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2041 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2041 then
      timOff := timeStampsNewYear[31];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2042 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2042 then
      timOff := timeStampsNewYear[32];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2043 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2043 then
      timOff := timeStampsNewYear[33];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2044 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2044 then
      timOff := timeStampsNewYear[34];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2045 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2045 then
      timOff := timeStampsNewYear[35];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2046 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2046 then
      timOff := timeStampsNewYear[36];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2047 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2047 then
      timOff := timeStampsNewYear[37];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2048 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2048 then
      timOff := timeStampsNewYear[38];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2049 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2049 then
      timOff := timeStampsNewYear[39];
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.NY2050 or
    zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2050 then
  ...
  assert(time + offset + timOff >= timeStampsNewYear[1],
   ...
   Therefore the simulation startTime must be at least " + String(timeStampsNewYear[1]) + "."
    elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.Custom then
