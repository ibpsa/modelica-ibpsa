...
assert(IBPSA.Utilities.Math.Functions.isMonotonic(x_incStrict, strict=false),
   "Error. Function should have returned true.");
     //not monotonic
assert(false == IBPSA.Utilities.Math.Functions.isMonotonic(x_notMon, strict=false),
   "Error. Function should have returned true.");
     //weakly increasing
assert(IBPSA.Utilities.Math.Functions.isMonotonic(x_incWeak, strict=false),
   "Error. Function should have returned true.");
     //not weakly monotonic
assert(false == IBPSA.Utilities.Math.Functions.isMonotonic(x_notWeak, strict=false),
   "Error. Function should have returned true.");
...
assert(IBPSA.Utilities.Math.Functions.isMonotonic(x_incStrict, strict=true),
   "Error. Function should have returned true.");
     //not monotonic
assert(false == IBPSA.Utilities.Math.Functions.isMonotonic(x_notMon, strict=true),
   "Error. Function should have returned true.");
     //weakly increasing
assert(false == IBPSA.Utilities.Math.Functions.isMonotonic(x_incWeak, strict=true),
   "Error. Function should have returned true.");
     //not weakly monotonic
assert(false == IBPSA.Utilities.Math.Functions.isMonotonic(x_notWeak, strict=true),
   "Error. Function should have returned true.");
