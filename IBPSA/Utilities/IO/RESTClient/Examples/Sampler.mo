...
model Sampler
 ...
 extends Modelica.Icons.Example;
   inner IBPSA.Utilities.IO.RESTClient.Configuration
    ...
    annotation (Placement(transformation(extent={{62,60},{80,80}})));
...
equation
  ...
  connect(sine2.y, sampler.u[2])
    annotation (Line(points={{-59,-40},{-20,-40},{-20,1},{-2,1}},
                                                                color={0,0,127}));
  connect(booleanExpression.y, config.activate)
    annotation (Line(points={{1,78},{36,78},{60.2,78}}, color={255,0,255}));
