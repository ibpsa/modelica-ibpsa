...
model CSVReader "Reader for csv files generated by CSVWriter"
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(
    tableOnFile=true,
    fileName=Modelica.Utilities.Files.loadResource("modelica://IBPSA//Resources/Data/Utilities/IO/Files/Examples/CSVReader/Data.txt"),
    columns={2,3},
  ...
  annotation (
    ...
    experiment(
      ...
      StopTime=10,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/IO/Files/Examples/CSVReader.mos"
        "Simulate and plot"),
...
<a href=\"modelica://IBPSA.Utilities.IO.Files.Examples.CSVWriter\">
