within IBPSA.Utilities.IO.BaseClasses;
partial block PartialSocketClient "The socket client "
  extends Modelica.Blocks.Icons.Block;
  outer IBPSA.Utilities.IO.Configuration Config "Setting configuration";
  ...
  parameter IBPSA.Utilities.IO.Types.LocalActivation activation=
    IBPSA.Utilities.IO.Types.LocalActivation.use_activation
  ...
  Modelica.Blocks.Interfaces.BooleanInput activate if
     (activation == IBPSA.Utilities.IO.Types.LocalActivation.use_input)
...
equation
  if (activation == IBPSA.Utilities.IO.Types.LocalActivation.use_input) then
    connect(activate, activate_internal);
  elseif  (activation == IBPSA.Utilities.IO.Types.LocalActivation.use_activation) then
    activate_internal = Config.active;
  elseif  (activation == IBPSA.Utilities.IO.Types.LocalActivation.always) then
