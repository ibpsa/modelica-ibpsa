...
function sha_hash
  "Return unique string containing the digits from the real number of baseClasses.sha. This is necessary as the Modelica function \"String\" cannot return 60 digits"
   extends Modelica.Icons.Function;
    input String argv=Modelica.Utilities.Files.loadResource("modelica://IBPSA/Constants/package.mo");
...
algorithm
  hash_numb := IBPSA.Utilities.Cryptographics.BaseClasses.sha(argv);
  hash :="";
  for i in 1:19 loop
