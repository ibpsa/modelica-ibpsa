...
equation
  if approximateWetBulb then
    ...
    XiSat  = IBPSA.Utilities.Psychrometrics.Functions.X_pSatpphi(
      pSat = IBPSA.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TWetBul),
      p =    p,
      phi =  1);
    XiDryBul =IBPSA.Utilities.Psychrometrics.Functions.X_pSatpphi(
      p =    p,
      pSat = IBPSA.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TDryBul),
      phi =  phi);
    (TWetBul-IBPSA.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * IBPSA.Utilities.Psychrometrics.Constants.cpAir +
    ...
    =
    (TDryBul-IBPSA.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * IBPSA.Utilities.Psychrometrics.Constants.cpAir +
              XiDryBul * IBPSA.Utilities.Psychrometrics.Constants.cpSte)  +
