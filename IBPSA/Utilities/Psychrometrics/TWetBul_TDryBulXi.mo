...
equation
  if approximateWetBulb then
    ...
    rh_per       = 100 * p/
         ...
         *Xi[iWat]/(Xi[iWat] +
         IBPSA.Utilities.Psychrometrics.Constants.k_mair*(1-Xi[iWat]));
    ...
    (TWetBul-IBPSA.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-Xi[iWat]) * IBPSA.Utilities.Psychrometrics.Constants.cpAir +
    ...
    (TDryBul-IBPSA.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-Xi[iWat]) * IBPSA.Utilities.Psychrometrics.Constants.cpAir +
              Xi[iWat] * IBPSA.Utilities.Psychrometrics.Constants.cpSte)  +
