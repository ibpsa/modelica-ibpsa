...
model System1 "Open loop model"
  ...
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant y1(k=mRad_flow_nominal)
    "Control signal of 1"
    annotation (Placement(transformation(extent={{-120,-80},{-100,-60}})));

  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant y2(k=1)
    "Control signal of 1"
    annotation (Placement(transformation(extent={{100,-210},{120,-190}})));

  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant y3(k=1)
    "Constant control signal of 1"
    annotation (Placement(transformation(extent={{-120,-260},{-100,-240}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant y4(k=1)
    "Control signal of 1"
    annotation (Placement(transformation(extent={{-120,-160},{-100,-140}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant y5(k=mBoi_flow_nominal)
    "Control signal of 1"
...
<a href=\"modelica://IBPSA.Examples.Tutorial.CDL.BaseClasses.PartialOpenLoop\">
IBPSA.Examples.Tutorial.CDL.BaseClasses.PartialOpenLoop</a>,
...
First implementation.
    ...
    __Dymola_Commands(file=
     "modelica://IBPSA/Resources/Scripts/Dymola/Examples/Tutorial/CDL/System1.mos"
        "Simulate and plot"),
    experiment(
      StartTime=1296000,
      StopTime=1382400,
