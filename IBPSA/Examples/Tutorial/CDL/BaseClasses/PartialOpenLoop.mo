within IBPSA.Examples.Tutorial.CDL.BaseClasses;
partial model PartialOpenLoop "Partial model with open loop system"
  extends Modelica.Icons.Example;
  replaceable package MediumA = IBPSA.Media.Air "Medium model for air";
  replaceable package MediumW = IBPSA.Media.Water "Medium model for water";
  ...
  IBPSA.Controls.OBC.CDL.Reals.Sources.TimeTable timTab(
      extrapolation=IBPSA.Controls.OBC.CDL.Types.Extrapolation.Periodic,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort temSup(redeclare package Medium = MediumW,
  ...
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temRoo(
    ...
    "Room temperature" annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        origin={-40,30})));
  IBPSA.Fluid.Movers.FlowControlled_m_flow pumRad(
    redeclare package Medium = MediumW,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  IBPSA.Fluid.FixedResistances.Junction mix(
    redeclare package Medium = MediumW,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  IBPSA.Fluid.FixedResistances.Junction spl2(
    ...
    m_flow_nominal={mRad_flow_nominal,-mRadVal_flow_nominal,-mRad_flow_nominal
        ...
        rotation=270,
        origin={60,-110})));
  IBPSA.Fluid.FixedResistances.Junction mix2(
    redeclare package Medium = MediumW,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    dp_nominal={0,-200,0},
    ...
    "Mixer" annotation (Placement(transformation(
        ...
        rotation=270,
        origin={60,-190})));
  IBPSA.Fluid.FixedResistances.Junction spl4(
    redeclare package Medium = MediumW,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  IBPSA.Fluid.Movers.FlowControlled_m_flow pumBoi(
    redeclare package Medium = MediumW,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  IBPSA.Fluid.Boilers.BoilerPolynomial boi(
    redeclare package Medium = MediumW,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    m_flow_nominal=mBoi_flow_nominal,
    dp_nominal=2000,
    Q_flow_nominal=Q_flow_nominal,
    fue=IBPSA.Fluid.Data.Fuels.HeatingOilLowerHeatingValue()) "Boiler"
    annotation (Placement(transformation(extent={{20,-320},{0,-300}})));

  IBPSA.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valRad(
    redeclare package Medium = MediumW,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  IBPSA.Fluid.Sources.Boundary_pT preSou(redeclare package Medium = MediumW,
      nPorts=1)
    "Source for pressure and to account for thermal expansion of water"
    annotation (Placement(transformation(extent={{92,-320},{72,-300}})));
  IBPSA.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valBoi(
    redeclare package Medium = MediumW,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    m_flow_nominal=mBoi_flow_nominal,
    l={0.01,0.01},
...
<a href=\"modelica://IBPSA.ThermalZones\">IBPSA.ThermalZones</a>,
...
<a href=\"modelica://IBPSA.Examples.Tutorial.Boiler\">
IBPSA.Examples.Tutorial.Boiler</a>
</p>
</html>",
revisions="<html>
<ul>
