within IBPSA.Examples.Tutorial.CDL.Controls.Validation;
model EquipmentOnOff
  "Validation model for the equipment on/off controller"
    extends Modelica.Icons.Example;

  IBPSA.Controls.OBC.CDL.Reals.Sources.Ramp TBoi(
    height=40,
    duration=3600,
    offset=333.15) "Boiler temperature"
    annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
  IBPSA.Examples.Tutorial.CDL.Controls.EquipmentOnOff
    conEquSta "Controller for equipment on/off"
              annotation (Placement(transformation(extent={{-8,-10},{12,10}})));
  IBPSA.Controls.OBC.CDL.Logical.Sources.Pulse onSys(
    period=600)
    "System on signal"
...
__Dymola_Commands(file=
     "modelica://IBPSA/Resources/Scripts/Dymola/Examples/Tutorial/CDL/Controls/Validation/EquipmentOnOff.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06));
