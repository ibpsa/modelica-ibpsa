...
model SystemOnOff
  ...
  IBPSA.Examples.Tutorial.CDL.Controls.SystemOnOff
  ...
  IBPSA.Controls.OBC.CDL.Reals.Sources.Sin TRoo(
    amplitude=4,
    freqHz=1/720,
...
__Dymola_Commands(file=
     "modelica://IBPSA/Resources/Scripts/Dymola/Examples/Tutorial/CDL/Controls/Validation/SystemOnOff.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06));
