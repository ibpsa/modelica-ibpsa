...
model RadiatorSupply
  ...
  IBPSA.Controls.OBC.CDL.Reals.Sources.Ramp TRoo(
    height=-4,
    duration=3600,
    offset=297.15) "Room air temperature"
    annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
  IBPSA.Examples.Tutorial.CDL.Controls.RadiatorSupply
    conRadSup "Controller for radiator supply water temperature"
              annotation (Placement(transformation(extent={{10,-10},{30,10}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Sin TSup(
    amplitude=20,
    freqHz=1/720,
...
__Dymola_Commands(file=
     "modelica://IBPSA/Resources/Scripts/Dymola/Examples/Tutorial/CDL/Controls/Validation/RadiatorSupply.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06));
