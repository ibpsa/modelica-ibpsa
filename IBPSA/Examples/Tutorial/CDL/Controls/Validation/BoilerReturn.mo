...
model BoilerReturn
  ...
  IBPSA.Examples.Tutorial.CDL.Controls.BoilerReturn conBoiRet
    "Controller for boiler return water temperature"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Ramp TRet(
    height=50,
    duration=3600,
...
__Dymola_Commands(file=
     "modelica://IBPSA/Resources/Scripts/Dymola/Examples/Tutorial/CDL/Controls/Validation/BoilerReturn.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06));
