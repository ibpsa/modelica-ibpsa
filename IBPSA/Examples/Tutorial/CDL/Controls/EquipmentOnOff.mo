...
block EquipmentOnOff "Controller for equipment on/off control"
  IBPSA.Controls.OBC.CDL.Interfaces.RealInput TBoi(
    final unit="K",
    displayUnit="degC")
    "Boiler temperature"
    annotation (Placement(transformation(extent={{-140,40},{-100,80}})));
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanInput onSys
    "System on command"
    annotation (Placement(transformation(extent={{-140,-80},{-100,-40}})));
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanOutput onPum
    "Pump on command"
    annotation (Placement(transformation(extent={{100,-80},{140,-40}})));
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanOutput onBoi
    "Boiler on command"
