...
block RadiatorSupply "Controller for mixing valve in radiator loop"
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.RealInput TSup(
    final unit="K",
    displayUnit="degC")
    "Measured supply water temperature"
    annotation (Placement(transformation(extent={{-140,-80},{-100,-40}}),
        iconTransformation(extent={{-140,-80},{-100,-40}})));
  IBPSA.Controls.OBC.CDL.Interfaces.RealOutput yVal(
    final unit="1")
    "Valve control signal"
    annotation (Placement(transformation(extent={{100,-20},{140,20}})));
  IBPSA.Controls.OBC.CDL.Reals.PID conPIDRad(
    final k=k,
    final Ti=Ti,
    final yMax=1,
    final yMin=0,
  ...
  IBPSA.Controls.OBC.CDL.Reals.Line TSetSup
    "Setpoint for supply water temperature"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant TMinSup(
    final k=TSupMin)
    "Minimum heating supply temperature"
    annotation (Placement(transformation(extent={{-50,-40},{-30,-20}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant TMaxSup(
    final k=TSupMax)
    "Maximum heating supply temperature"
    annotation (Placement(transformation(extent={{-50,20},{-30,40}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant TMinRoo(
    final k=TRooMin)
...
This is for
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/1810\">Buildings, issue 1810</a>.
</li>
<li>
