within IBPSA.Examples.Tutorial.CDL.Controls;
block SystemOnOff "Controller for system on/off"
  ...
  IBPSA.Controls.OBC.CDL.Interfaces.RealInput TOut(
    final unit="K",
    displayUnit="degC")
    "Outdoor air temperature"
    annotation (Placement(transformation(extent={{-140,40},{-100,80}})));
  IBPSA.Controls.OBC.CDL.Interfaces.RealInput TRoo(
    final unit="K",
    displayUnit="degC")
    "Room air temperature"
    annotation (Placement(transformation(extent={{-140,-80},{-100,-40}})));
  IBPSA.Controls.OBC.CDL.Interfaces.BooleanOutput onSys
    "System on command"
    annotation (Placement(transformation(extent={{100,-20},{140,20}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant TSetOut(k=TOutLow + 0.5)
    "Set point for outdoor air temperature plus half the dead band"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  IBPSA.Controls.OBC.CDL.Reals.Sources.Constant TSetRoo(k=TRooSet)
    "Set point for room air temperature"
    annotation (Placement(transformation(extent={{-80,-40},{-60,-20}})));
  IBPSA.Controls.OBC.CDL.Logical.And and1
    "And operator to switch boiler on based on temperature and system on command"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  IBPSA.Controls.OBC.CDL.Reals.Subtract sub "Inputs different"
    annotation (Placement(transformation(extent={{-40,50},{-20,70}})));
  IBPSA.Controls.OBC.CDL.Reals.Hysteresis onTOut(
    final uLow=-0.5,
    final uHigh=0.5) "On/off control based on outside air temperature"
    annotation (Placement(transformation(extent={{0,50},{20,70}})));
  IBPSA.Controls.OBC.CDL.Reals.Subtract sub1 "Inputs different"
    annotation (Placement(transformation(extent={{-40,-70},{-20,-50}})));
  IBPSA.Controls.OBC.CDL.Reals.Hysteresis onTRoo(
    final uLow=-0.5,
