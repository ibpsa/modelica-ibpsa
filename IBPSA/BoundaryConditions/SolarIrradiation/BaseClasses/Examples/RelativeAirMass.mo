...
model RelativeAirMass "Test model for relative air mass"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.BaseClasses.RelativeAirMass
    relAirMas annotation (Placement(transformation(extent={{20,10},{40,30}})));
...
equation
  ...
  connect(weaBus.alt, relAirMas.alt) annotation (Line(
      points={{-32,34},{12,34},{12,26},{18,26}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/BaseClasses/Examples/RelativeAirMass.mos"
        "Simulate and plot"));
end RelativeAirMass;
