  ...
  annotation (
    ...
    Icon(coordinateSystem(
        ...
        Text(
          ...
          textString="HGloHor"),
        Text(
          visible=(HSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor),
