...
model CheckSkyCover "Test model for checking sky cover"
  ...
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.CheckSkyCover
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckSkyCover.mos"
        "Simulate and plot"));
end CheckSkyCover;
