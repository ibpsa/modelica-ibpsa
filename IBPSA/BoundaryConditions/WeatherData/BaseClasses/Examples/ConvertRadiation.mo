...
model ConvertRadiation "Test model for ConvertRadiation"
  ...
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.ConvertRadiation
...
__Dymola_Commands(file=
          "modelica://IBPSA/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/ConvertRadiation.mos"
        "Simulate and plot"));
