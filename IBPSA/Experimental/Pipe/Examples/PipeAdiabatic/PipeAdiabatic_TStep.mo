...
model PipeAdiabatic_TStep
  ...
  IBPSA.Experimental.Pipe.PipeAdiabaticPlugFlow pipe50_1(
  ...
  IBPSA.Experimental.Pipe.PipeAdiabaticPlugFlow pipe50_2(
    redeclare package Medium = Medium,
    dh=0.1,
    length=50,
  ...
  IBPSA.Experimental.Pipe.PipeAdiabaticPlugFlow pipe100(
    redeclare package Medium = Medium,
    dh=0.1,
    length=100,
