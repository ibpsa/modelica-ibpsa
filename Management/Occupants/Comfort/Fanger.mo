within IDEAS.Management.Occupants.Comfort;
...
protected
  IDEAS.Building.Zone.PredictedPercentageDissatisfied ppd "PPD calculated"
    annotation (Placement(transformation(extent={{60,-16},{80,4}})));
  IDEAS.Building.Zone.CloValue cloValue "clothing calculation"
    annotation (Placement(transformation(extent={{-54,60},{-34,80}})));
  IDEAS.Building.Zone.CloTemperature cloTemperature(Linear=Linear)
    "clothing surface temperature"
      annotation (Placement(transformation(extent={{-26,26},{-6,46}})));
  IDEAS.Building.Zone.PredictedMeanVote pmv(Linear=Linear) "pmv calculation"
