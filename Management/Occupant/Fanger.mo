...
protected
  IDEAS.Management.Occupant.Elements.PredictedPercentageDissatisfied ppd
    "PPD calculated"
    annotation (Placement(transformation(extent={{60,-16},{80,4}})));
  IDEAS.Management.Occupant.Elements.CloValue cloValue "clothing calculation"
    annotation (Placement(transformation(extent={{-54,60},{-34,80}})));
  IDEAS.Management.Occupant.Elements.CloTemperature cloTemperature(Linear=Linear)
    "clothing surface temperature"
      annotation (Placement(transformation(extent={{-26,26},{-6,46}})));
  IDEAS.Management.Occupant.Elements.PredictedMeanVote pmv(Linear=Linear)
    "pmv calculation"
