within IDEAS.Elements.Meteo.Solar;
...
IDEAS.Elements.Meteo.Solar.Elements.AngleHour hour;
IDEAS.Elements.Meteo.Solar.Elements.Declination dec;

IDEAS.Elements.Meteo.Solar.Elements.AngleSolar aziPlane(
    inc=inc,
    azi=azi,
    lat=lat);
IDEAS.Elements.Meteo.Solar.Elements.AngleSolar aziHoriz(
    inc=0,
    azi=0,
    lat=lat);
IDEAS.Elements.Meteo.Solar.Elements.solradExtraTerra extraTerra;
