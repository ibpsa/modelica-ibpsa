...
protected
  Elements.LocalTime localTime(lon=lon)
    annotation (Placement(transformation(extent={{-10,-6},{10,14}})));
  Elements.SolarTime solarTime
    annotation (Placement(transformation(extent={{30,-10},{50,10}})));
  Elements.CalendarTime calendarTime(ifSolCor=ifSolCor)
    annotation (Placement(transformation(extent={{30,-54},{50,-34}})));
  Elements.SimulationTime simulationTime
    annotation (Placement(transformation(extent={{-90,-30},{-70,-10}})));
  Elements.SimulationDelay simulationDelay(delay=delay)
    annotation (Placement(transformation(extent={{-90,-58},{-70,-38}})));
  Elements.TimeZone timeZone(timZonSta=timZonSta, DST=DST, yr=yr)
