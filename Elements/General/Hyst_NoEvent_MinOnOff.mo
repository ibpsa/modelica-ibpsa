...
// still not working as it should
  ...
  IDEAS.Elements.Time.Timer_NoEvents offTimer(duration=if minOffTime > 0 then
        minOffTime else 666, timerType=Commons.Time.Elements.TimerType.off)
    annotation (Placement(transformation(extent={{-44,28},{-24,48}})));
  IDEAS.Elements.Time.Timer_NoEvents onTimer(duration=if minOnTime > 0 then minOnTime
         else 666, timerType=Commons.Time.Elements.TimerType.on)
  ...
  annotation (
    ...
    Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,100}}),
        ...
        Polygon(
          ...
          fillColor={192,192,192},
          fillPattern=FillPattern.Solid),
        Line(points={{-63,107},{-63,-41}},color={192,192,192}),
        Line(points={{-88,-30},{84,-30}}, color={192,192,192}),
        Polygon(
        ...
        Text(
          ...
          lineColor={0,0,0},
          textString="uLow"),
        Line(points={{-67,50},{-58,50}}, color={160,160,164}),
        Line(
