...
model InteriorLwDistribution "internal longwave radiative heat exchange"
...
extends Modelica.Blocks.Interfaces.BlockIcon;
  ...
  IDEAS.Building.Component.Elements.Zone.RadiativeResistor[nSurf] radRes(R=R);
