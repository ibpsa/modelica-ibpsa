...
//protected
  ...
  IDEAS.Building.Component.Elements.Wall.HeatResistor[nRes] Res(each final A=A,
      each final R=mat.d/mat.k/nRes) "number of resistors in the RC-network";
  IDEAS.Building.Component.Elements.Wall.HeatCapacity[nCap] Cap(each final C=A*
        mat.rho*mat.c*mat.d/nCap) "number of capacitors in the RC-network";
