...
or it is computed for an open system. 
...
is considered to be outside of the system for which conservation of energy is checked. 
When setting <code>openSystemConservationOfEnergy=true</code> 
