...
model EnergyConservationValidation
  ...
  Modelica.Blocks.Sources.RealExpression consEne(y=intQgai.y + (outerWall.layMul.E
         + slabOnGround.layMul.E + zone.E + zone1.E + commonWall.layMul.E +
        commonWall1.layMul.E)/3600000) "Conservaiton of energy"
