...
for i in 1:nHeatingLoads loop
  connect(plugHeatingLoad[i], plugFeeder) annotation (Line(
      points={{-100,40},{0,40},{0,0},{100,0}},
      color={85,170,255},
      smooth=Smooth.None));
end for;
for j in 1:nVentilationLoads loop
  connect(plugVentilationLoad[j], plugFeeder) annotation (Line(
      points={{-100,0},{100,0}},
      color={85,170,255},
      smooth=Smooth.None));
...
for k in 1:nOccupantLoads loop
  connect(plugOccupantLoad[k], plugFeeder) annotation (Line(
      points={{-100,-40},{0,-40},{0,0},{100,0}},
      color={85,170,255},
      smooth=Smooth.None));
