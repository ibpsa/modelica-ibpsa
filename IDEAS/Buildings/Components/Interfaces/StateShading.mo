...
parameter Boolean controled = true;
  ...
  Modelica.Blocks.Interfaces.RealInput solDif
    ...
    annotation (Placement(transformation(extent={{-80,-10},{-40,30}}),
        iconTransformation(extent={{-60,10},{-40,30}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput iSolDif
    "diffuse solar illuminance on surface s"
    annotation (Placement(transformation(extent={{20,-10},{60,30}}),
  ...
  Modelica.Blocks.Interfaces.RealInput angAzi "angle of incidence"
