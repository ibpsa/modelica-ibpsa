...
equation
  ...
  annotation (Diagram(graphics), Icon(graphics={Line(points={{-16,16},{-66,16}},
          ...
          points={{-16,-14},{-26,-8}}, color={191,0,0}),Line(points={{-16,-14},
          {-26,-20}}, color={191,0,0}),Line(points={{68,-30},{16,-30}}, color={
          191,0,0}),Line(points={{68,-30},{58,-24}}, color={191,0,0}),Line(
          points={{68,-30},{58,-36}}, color={191,0,0}),Line(points={{68,30},{16,
          30}}, color={191,0,0}),Line(points={{68,30},{58,36}}, color={191,0,0}),
          Line(points={{68,30},{58,24}}, color={191,0,0}),Line(
          points={{0,80},{0,-80}},
          color={0,0,0},
          smooth=Smooth.None,
          thickness=0.5,
          pattern=LinePattern.Dash),Line(points={{68,0},{16,0}}, color={191,0,0}),
          Line(points={{68,0},{58,6}}, color={191,0,0}),Line(points={{68,0},{58,
          -6}}, color={191,0,0})}));
end SolarShading;
