...
<p>The heat balance of the outer surface in contact to the ground is approximated based on <a href=\"IDEAS.Buildings.UsersGuide.References\">[ISO 13770]</a> based on a steady-state and periodic coupling coefficient. </p>
