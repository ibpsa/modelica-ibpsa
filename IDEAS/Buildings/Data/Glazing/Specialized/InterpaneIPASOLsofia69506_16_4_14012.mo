...
record InterpaneIPASOLsofia69506_16_4_14012 =
...
final mats={ IDEAS.Buildings.Data.Materials.Glass(d=6.0, epsLw_b=0.4),
 ...
 IDEAS.Buildings.Data.Materials.Glass(d=4.0, epsLw_b=0.4)},final SwTrans=[0,0.458;
10,0.461;
20,0.454;
30,0.446;
40,0.434;
...
final U_value=1.31,
final g_value=0.405) "InterpaneIPASOLsofia69506_16_4(U-design =1.31 g-design =0.405)
";
