...
record Ins3Kr = IDEAS.Buildings.Data.Interfaces.Glazing (
    final nLay=5,
    final mats={Materials.Glass(d=0.004),Materials.Krypton(d=0.008, epsLw_a=0.04),
        Materials.Glass(d=0.004),Materials.Krypton(d=0.008, epsLw_a=0.04),
        Materials.Glass(d=0.004)},
    final SwTrans=[0, 0.268; 10, 0.270; 20, 0.263; 30, 0.253; 40, 0.243; 50, 0.223;
        60, 0.183; 70, 0.116; 80, 0.042; 90, 0.000],
    final SwAbs=[0, 0.327, 0.0, 0.066, 0.0, 0.108; 10, 0.330, 0.0, 0.066, 0.0, 0.110;
