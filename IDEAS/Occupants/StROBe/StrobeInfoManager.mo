...
model StrobeInfoManager
  ...
  parameter String FilNam_P = "none.txt"
    "File with (active) plug load profiles"
  annotation (Dialog(group="User behaviour"));
  parameter String FilNam_Q = "none.txt"
    "File with (reactive) plug load profiles"  annotation (Dialog(group="User behaviour"));
  parameter String FilNam_mDHW = "none.txt"
    "File with hot watter tapping profiles"  annotation (Dialog(group="User behaviour"));
  parameter String FilNam_QCon = "none.txt"
    "File with (convective) internal heat gain profiles" annotation (Dialog(group="User behaviour"));
  parameter String FilNam_QRad = "none.txt"
    "File with (radiative) internal heat gain profiles" annotation (Dialog(group="User behaviour"));
  parameter String FilNam_TSet = "none.txt"
    "File with (main) space heating setpoint profiles" annotation (Dialog(group="User behaviour"));
  parameter String FilNam_TSet2 = "none.txt"
    "File with (secondary) space heating setpoint profiles" annotation (Dialog(group="User behaviour"));

  parameter Integer nHp=33 "Number of heat pump profiles to be read"  annotation (Dialog(group="Heat pumps"));
  parameter String FilNam_PHp = "none.txt"
    "File with (active) electric load heat pump profiles" annotation (Dialog(group="Heat pumps"));

protected
  final parameter Boolean If_P = not Modelica.Utilities.Strings.isEqual(FilNam_P, "none.txt") annotation (Dialog(group="User behaviour"));
  final parameter Boolean If_Q = not Modelica.Utilities.Strings.isEqual(FilNam_Q, "none.txt") annotation (Dialog(group="User behaviour"));
  final parameter Boolean If_mDHW = not Modelica.Utilities.Strings.isEqual(FilNam_mDHW, "none.txt") annotation (Dialog(group="User behaviour"));
  final parameter Boolean If_QCon = not Modelica.Utilities.Strings.isEqual(FilNam_QCon, "none.txt") annotation (Dialog(group="User behaviour"));
  final parameter Boolean If_QRad = not Modelica.Utilities.Strings.isEqual(FilNam_QRad, "none.txt") annotation (Dialog(group="User behaviour"));
  final parameter Boolean If_TSet = not Modelica.Utilities.Strings.isEqual(FilNam_TSet, "none.txt") annotation (Dialog(group="User behaviour"));
  final parameter Boolean If_TSet2 = not Modelica.Utilities.Strings.isEqual(FilNam_TSet2, "none.txt") annotation (Dialog(group="User behaviour"));

  final parameter Boolean If_PHp = not Modelica.Utilities.Strings.isEqual(FilNam_PHp, "none.txt") annotation (Dialog(group="User behaviour"));
  final parameter Boolean If_PPv = not Modelica.Utilities.Strings.isEqual(FilNam_PPv, "none.txt") annotation (Dialog(group="User behaviour"));
