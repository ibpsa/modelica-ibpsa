...
model Phi_pTX "Model to test the relative humidity computation"
 ...
 package Medium = IDEAS.Media.Air "Medium model"
  ...
  IDEAS.Utilities.Psychrometrics.Phi_pTX phi "Relative humidity"
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/Phi_pTX.mos"
        "Simulate and plot"),
