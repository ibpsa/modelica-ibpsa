...
model Density_pTX "Model to test the density computation"
 ...
 package Medium = IDEAS.Media.Air "Medium model"
  ...
  IDEAS.Utilities.Psychrometrics.Density_pTX den "Density"
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/Density_pTX.mos"
        "Simulate and plot"),
