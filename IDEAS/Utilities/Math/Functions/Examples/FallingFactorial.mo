...
equation
  ...
  for k in 1:10 loop
    falFac[k] = IDEAS.Utilities.Math.Functions.fallingFactorial(n,k);
  end for;

  annotation (
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/FallingFactorial.mos"
        "Simulate and plot"),
