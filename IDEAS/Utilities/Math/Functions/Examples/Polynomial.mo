...
equation
  x=IDEAS.Utilities.Math.Functions.polynomial(x=time^3-2, a={2, 4, -4, 5});

 annotation(experiment(StopTime=4, Tolerance=1e-06),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/Polynomial.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example verifies the correct implementation of
<a href=\"modelica://IDEAS.Utilities.Math.Functions.polynomial\">
IDEAS.Utilities.Math.Functions.polynomial</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
