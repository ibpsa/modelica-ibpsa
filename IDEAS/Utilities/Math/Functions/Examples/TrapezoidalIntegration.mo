...
algorithm
  y := IDEAS.Utilities.Math.Functions.trapezoidalIntegration(N=7, f=y1, deltaX=1);
 assert(y - 286.0 < 1E-4,
   "Error. Function should have returned 286.");
  annotation (experiment(StopTime=1.0),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/TrapezoidalIntegration.mos"
        "Simulate and plot"),
                     Documentation(info="<html>
<p>
Tests the correct implementation of function
<a href=\"modelica://IDEAS.Utilities.Math.Functions.trapezoidalIntegration\">
IDEAS.Utilities.Math.Functions.trapezoidalIntegration</a>.
</p>
