...
equation
  E1 = IDEAS.Utilities.Math.Functions.exponentialIntegralE1(time);

  annotation (
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/ExponentialIntegralE1.mos"
        "Simulate and plot"),
