...
model IntegratorWithReset "Test model for integrator with reset"
  ...
  IDEAS.Utilities.Math.IntegratorWithReset intWitRes1(
    y_start=5, reset=IDEAS.Types.Reset.Parameter,
    k=0.5,
    y_reset=2)                                      "Integrator with reset"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));

  IDEAS.Utilities.Math.IntegratorWithReset intWitRes2(
    y_reset=10,
    y_start=-5,
  ...
  IDEAS.Utilities.Math.IntegratorWithReset intNoReset(
  ...
  IDEAS.Utilities.Math.IntegratorWithReset intDef
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Examples/IntegratorWithReset.mos"
        "Simulate and plot"),
