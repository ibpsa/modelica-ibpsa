...
model LimPIDReset
  ...
  IDEAS.Controls.Continuous.LimPID limPIDPar(
    yMax=1,
    yMin=-1,
    reset=IDEAS.Types.Reset.Parameter,
    y_reset=0.2,
    Ti=20,
    Td=10,
    k=0.2,
  ...
  IDEAS.Controls.Continuous.LimPID limPIDDef(
  ...
  IDEAS.Controls.Continuous.LimPID limPIDInp(
    y_reset=0.2,
    Td=10,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/Continuous/Validation/LimPIDReset.mos"
        "Simulate and plot"),
...
<a href=\"Modelica://IDEAS.Controls.Continuous.LimPID\">IDEAS.Controls.Continuous.LimPID</a>
