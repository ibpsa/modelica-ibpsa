...
block Hyst_Var_Heating
  "Hysteresis for heating mode WITH events, with Real in- and output, and inputs for uLow and uHigh"
...
equation
  ...
  if rel > 0.5 then
    yy = u < uLow or pre(yy) and u <= uHigh;
  else
    yy = false;
  end if;
  ...
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,
          ...
          color={0,0,0},
          thickness=0.5),Line(
          points={{0,-65},{-10,-70},{0,-75}},
          color={0,0,0},
          thickness=0.5),Line(
          points={{-20,15},{-10,10},{-20,5}},
          color={0,0,0},
          thickness=0.5),Line(
          points={{-55,-30},{-50,-20},{-44,-30}},
          color={0,0,0},
          thickness=0.5),Line(
          points={{25,-19},{30,-30},{35,-19}},
          color={0,0,0},
          thickness=0.5),Text(
          extent={{35,4},{64,20}},
          lineColor={160,160,164},
