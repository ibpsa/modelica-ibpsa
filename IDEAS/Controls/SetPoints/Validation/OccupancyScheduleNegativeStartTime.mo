within IDEAS.Controls.SetPoints.Validation;
model OccupancyScheduleNegativeStartTime
  "Test model for occupancy schedule with look-ahead"
  extends Modelica.Icons.Example;
  IDEAS.Controls.SetPoints.OccupancySchedule occSchDay(occupancy=3600*{7,24})
                                                       "Day schedule"
  ...
  annotation (experiment(
      ...
      StopTime=207360,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/SetPoints/Validation/OccupancyScheduleNegativeStartTime.mos"
        "Simulate and plot"),
