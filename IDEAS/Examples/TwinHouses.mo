...
14: heat elp bed 2")}));
    ...
    model ThermalBridges "Thermal bridges for twinhouses"
    ...
    equation
      prescribedHeatFlow[1].Q_flow = +(0.436+(1.136+0.83+1.034+1.163+0.167)/2)*(Tatt-Tzone[1])+(0.583+(1.136+0.167                               +0.83+1.034+1.163)/2)*(Tbas-Tzone[1]);//(1.113+0.981+0.366+0.091*3.28)*(Te-Tzone[1])
      prescribedHeatFlow[2].Q_flow = (0.359+1.034+0.606+0.359)/2*(Tatt+Tbas-2*Tzone[2]);
      prescribedHeatFlow[3].Q_flow = + (0.511+0.606+0.511)/2*(Tatt+Tbas-2*Tzone[3]);//(0.623)*(Te-Tzone[3])
      prescribedHeatFlow[4].Q_flow = + (0.436+(0.359+0.511+1.163)/2)*(Tatt-Tzone[4])+(0.583+(0.359+0.511+1.163)/2)*(Tbas-Tzone[4]);//(0.685+0.841)*(Te-Tzone[4])
      prescribedHeatFlow[5].Q_flow = + (0.436+(0.665+1.139)/2)*(Tatt-Tzone[5])+(0.583+(0.665+1.139)/2)*(Tbas-Tzone[5]);// (0.644+0.616)*(Te-Tzone[5])
      prescribedHeatFlow[6].Q_flow =  + (0.665+1.136+0.83)/2*(Tatt+Tbas-2*Tzone[6]); //(0.469)*(Te-Tzone[6])
      prescribedHeatFlow[7].Q_flow =+ (0.436+(1.136+0.359+0.511+0.167)/2)*(Tatt-Tzone[7])+(0.583+(1.136+0.359+0.511+0.167)/2)*(Tbas-Tzone[7])
      annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
            coordinateSystem(preserveAspectRatio=false)));// (0.841+742)*(Te-Tzone[7])
