...
model TwinhouseN2 "Twinhouse N2 - Model Based on Excel autogenerated"
  ...
  IDEAS.Buildings.Components.InternalWall W55(
    ...
    AWall=1.6236,
    inc=incWall,
    azi=90) annotation (Placement(transformation(extent={{125,-22},{135,-42}})));
...
equation
  ...
  connect(W27.Ctrl, controlBlind1.y[2]) annotation (Line(points={{-24,6},{-28,6},
          {-28,-86},{-31.8,-86}}, color={0,0,127}));
  connect(W28.Ctrl, controlBlind1.y[3]) annotation (Line(points={{-9,6},{-20,6},
          {-20,-85.3333},{-31.8,-85.3333}}, color={0,0,127}));
  connect(W29.Ctrl, controlBlind1.y[1]) annotation (Line(points={{6,6},{-14,6},
          {-14,-86.6667},{-31.8,-86.6667}}, color={0,0,127}));
  connect(W30.Ctrl, controlBlind1.y[1]) annotation (Line(points={{21,6},{-4,6},
