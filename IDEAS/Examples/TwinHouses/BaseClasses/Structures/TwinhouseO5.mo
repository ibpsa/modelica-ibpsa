...
AWall=2.014875,inc=incWall,azi = aziNorth)
  ...
  IDEAS.Buildings.Components.Window W27(
    ...
    redeclare BaseClasses.Data.Constructions.PvcInsulated fraType(redeclare IDEAS.Buildings.Components.ThermalBridges.LineLosses briTyp(psi=
          0.05, len=4.62)),
...
connect(W25.T,from_degC[1].y);
  ...
  connect(W28.Ctrl, controlBlind1.y[3]) annotation (Line(points={{-11,6},{-20,6},
  ...
  connect(W30.Ctrl, controlBlind1.y[1]) annotation (Line(points={{21,4},{-4,4},
