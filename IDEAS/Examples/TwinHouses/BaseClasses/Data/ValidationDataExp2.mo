...
Real cellar_AT= data.y[1];
Real kitchen_AT= data.y[2];
Real doorway_AT= data.y[3];
Real parents_AT= data.y[4];
Real living_h010cm_AT= data.y[5];
Real living_h110cm_AT= data.y[6];
Real living_GT= data.y[7];
Real living_rH_h110cm= data.y[8];
Real living_h170cm_AT= data.y[9];
Real corridor_AT= data.y[10];
Real bath_h010_AT= data.y[11];
Real bath_h110_AT= data.y[12];
Real bath_h170_AT= data.y[13];
Real child_h010_AT= data.y[14];
Real child_h110_AT= data.y[15];
Real child_h170_AT= data.y[16];
Real attic_west_h010_AT= data.y[17];
Real attic_west_h110_AT= data.y[18];
Real attic_west_h170_AT= data.y[19];
Real attic_east_h010_AT= data.y[20];
Real attic_east_h110_AT= data.y[21];
Real attic_east_h170_AT= data.y[22];
...
Real vent_SUA_AT= data.y[32];
Real living_SUA_AT= data.y[33];
Real vent_EHA_fan_elP= data.y[34];
Real vent_EHA_VFR= data.y[35];
Real vent_EHA_AT= data.y[36];
Real vent_thP= data.y[37];
Real living_westfacade_S_IS_T= data.y[38];
Real living_facade_west_S_IS_HF= data.y[39];
Real living_westfacade_S_BL1_T= data.y[40];
Real living_facade_west_S_BL1_HF= data.y[41];
Real living_westfacade_S_ES_T= data.y[42];
Real living_window_west_IS_T= data.y[43];
Real living_window_west_S_IS_HF= data.y[44];
Real living_window_south_IS_T= data.y[45];
Real living_window_south_IS_HF= data.y[46];
Real child_facade_south_IS_T= data.y[47];
Real child_facade_south_IS_HF= data.y[48];
Real child_window_south_IS_T= data.y[49];
Real child_window_south_IS_HF= data.y[50];
Real child_facade_east_IS_T= data.y[51];
Real child_facade_east_IS_HF= data.y[52];
Real Ambient_temperature= data.y[53];
...
Real ground_temperature_0cm= data.y[64];
Real ground_temperature_50cm= data.y[65];
Real ground_temperature_100cm= data.y[66];
Real ground_temperature_200cm= data.y[67];
