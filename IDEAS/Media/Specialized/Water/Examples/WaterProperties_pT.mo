...
equation
  ...
  basPro.state.T=T;
   ...
   __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Media/Specialized/Water/Examples/WaterProperties_pT.mos"
        "Simulate and plot"),
      Documentation(info="<html>
<p>
This example checks the thermophysical properties of the medium
<a href=\"modelica://IDEAS.Media.Specialized.Water.Examples.WaterProperties_pT\">
IDEAS.Media.Specialized.Water.Examples.WaterProperties_pT</a>.
</p>
</html>",
revisions="<html>
<ul>
