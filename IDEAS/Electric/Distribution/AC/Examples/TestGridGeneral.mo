...
model TestGridGeneral
  ...
  IDEAS.Electric.Distribution.AC.Examples.Components.SinePower risingflankSingle
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  IDEAS.Electric.Distribution.AC.GridGeneral gridGeneral(
    redeclare IDEAS.Electric.Data.Grids.TestGrid2Nodes grid,
    Phases=1,
    traPre=true)
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  IDEAS.Electric.Distribution.AC.GridGeneral gridGeneral1(
    redeclare IDEAS.Electric.Data.Grids.TestGrid2Nodes grid,
    Phases=3,
    traPre=true)
