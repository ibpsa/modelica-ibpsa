...
model Transformer
  ...
  // Protected variables ///////////////////////////////////////////////////////////////////////////////////////////
protected
  IDEAS.Electric.Distribution.BaseClasses.Branch ZsHV[Phases](each R=
        Modelica.ComplexMath.real(Zs)/2, each X=Modelica.ComplexMath.imag(Zs)/2)
    annotation (Placement(transformation(extent={{-60,30},{-40,50}})));
  IDEAS.Electric.Distribution.BaseClasses.Branch ZsLV[Phases](each R=
        Modelica.ComplexMath.real(Zs)/2, each X=Modelica.ComplexMath.imag(Zs)/2)
    annotation (Placement(transformation(extent={{40,30},{60,50}})));
  IDEAS.Electric.Distribution.BaseClasses.Branch Zp[Phases](each R=
