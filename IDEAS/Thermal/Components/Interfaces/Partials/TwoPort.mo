...
<p>Setting parameter m (mass of medium within pipe) to zero leads to neglection of temperature transient cv*m*der(T).</p>
...
<li>This model includes the energy balance equation as a first order differential equation </li>
</ol></p>
