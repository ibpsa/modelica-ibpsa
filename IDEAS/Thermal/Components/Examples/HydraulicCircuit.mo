...
model HydraulicCircuit
  ...
  IDEAS.Thermal.Components.BaseClasses.Pipe_HeatPort pipe1(medium=
        Data.Media.Water(), m=5)
  ...
  IDEAS.Thermal.Components.BaseClasses.Pipe_HeatPort pipe2(medium=
        Data.Media.Water(), m=5)
  ...
  IDEAS.Thermal.Components.BaseClasses.Pipe pipe3(medium=Data.Media.Water(), m=
        5) annotation (Placement(transformation(extent={{50,4},{70,24}})));
