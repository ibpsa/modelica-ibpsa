...
model ThreeWayValveSwitch3 "Test the new component ThreeWayValveSwitch"
  extends Modelica.Icons.Example;

  BaseClasses.Pump pumpEmission(
  ...
  BaseClasses.Pipe pipe5(
    medium=IDEAS.Thermal.Data.Media.Water(),
    m=100,
    TInitial=291.15)
    annotation (Placement(transformation(extent={{58,-36},{78,-28}})));
  BaseClasses.AbsolutePressure absolutePressure1(p=100000)
  ...
  IDEAS.Thermal.Components.BaseClasses.ThreeWayValveSwitch threeWayValveSwitch
