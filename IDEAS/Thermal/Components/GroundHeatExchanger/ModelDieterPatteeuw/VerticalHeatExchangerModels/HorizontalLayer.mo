...
parameter
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Borehole.Borehole.RecordPipes
    recordPipeCapacitor;
parameter
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Earth.RecordEarthLayer
    recordEarthLayer;
parameter
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Borehole.Fillingmaterial.RecordContactResistanceEarthBoreHole
    recordContactResistanceEarthBoreHole;
parameter
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Borehole.Fillingmaterial.RecordFillingMaterialCapacitor
    recordFillingMaterialCapacitor;
parameter
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Borehole.Fillingmaterial.RecordContactResistanceBorepipeFilling
    recordContactResistanceBorepipeFilling;
parameter
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.AdaptedFluid.Medium
    medium;
...
replaceable
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Borehole.Borehole.PipesOfBorehole
    pieceOfBoreHole(
    recordPipeCapacitor=recordPipeCapacitor,
    medium=medium,
    upwardPipe(T0=TIni),
    downwardPipe(T0=TIni));
IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Earth.EarthLayer
    earthLayer(
    recordEarthLayer=recordEarthLayer,
    numberOfLayer=numberOfLayer,
    offset=offset,
    earthRings(each startTemperature=TIni));
 IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Borehole.Fillingmaterial.FillingMaterial
    fillingMaterial(
