...
model BoreHole "Vertical ground/brine heat exchanger, single borehole"
    ...
    replaceable parameter AlTheParameters alTheParameters                                                             annotation(choicesAllMatching=true);
...
protected
    ...
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Earth.BlockEarth
    blockEarth(recordEarthLayer=allTheRecords.recordEarthLayer, radiusPipe=
        allTheRecords.recordPipeCapacitor.radiusPipe);
    IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.Earth.TopOnGround[
    size(horizontalLayers[1].earthLayer.earthRings, 1)] topOnGround(each
      recordEarthLayer=allTheRecords.recordEarthLayer, index=1:size(
        horizontalLayers[1].earthLayer.earthRings, 1));
...
public
  ...
  IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.AdaptedFluid.FlowPort_a
    flowPort_a(medium=medium)
    annotation (Placement(transformation(extent={{-108,-12},{-88,8}})));
  IDEAS.Thermal.Components.GroundHeatExchanger.ModelDieterPatteeuw.AdaptedFluid.FlowPort_b
