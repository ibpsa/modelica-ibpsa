...
// This variable represents the contact resistance between the earth and the filling material.
 ContactResistanceFillingsideEarth contactResistanceFillingsideEarth(
...
FillingMaterialCapacitor fillingMaterialCapacitor(
...
ContactResistanceFillingsidePipe contactResistanceFillingsideUpwardPipe(
      recordContactResistanceBorepipeFilling=
        recordContactResistanceBorepipeFilling);
// This variable represents the contact resistoance between the filling material and the pipes.
ContactResistanceFillingsidePipe contactResistanceFillingsideDownwardPipe(
      recordContactResistanceBorepipeFilling=
        recordContactResistanceBorepipeFilling);
