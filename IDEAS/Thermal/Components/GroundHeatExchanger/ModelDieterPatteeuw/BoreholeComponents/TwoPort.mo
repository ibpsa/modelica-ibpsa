...
partial model TwoPort "Partial model of two port"
  ...
  parameter IDEAS.Thermal.Data.Interfaces.Medium medium= IDEAS.Thermal.Data.Interfaces.Medium()
...
public
  IDEAS.Thermal.Components.Interfaces.FlowPort_a flowPort_a(final medium=medium, h(min=
          1140947, max=1558647))
    annotation (Placement(transformation(extent={{-110,-10},{-90,10}},
          rotation=0)));
  IDEAS.Thermal.Components.Interfaces.FlowPort_b flowPort_b(final medium=medium, h(min=
          1140947, max=1558647))
