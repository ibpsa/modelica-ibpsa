...
protected
  ...
  VerticalSingleBorehole.BoreholeComponents.CylindricalLayer upperLayer[
    numberLayers](
  ...
  VerticalSingleBorehole.BoreholeComponents.CylindricalLayer mainLayers[
    numberLayers](
    each groundCpCyl=groundCp,
    each groundKCyl=groundK,
    each tempInitial=bhTinitial,
  ...
  VerticalSingleBorehole.BoreholeComponents.CylindricalLayer bottomLayer[
    numberLayers](
    each groundCpCyl=groundCp,
    each groundKCyl=groundK,
    each tempInitial=bhTinitial,
