...
model TwoWayValves "Two way valves with different opening characteristics"
  ...
  TwoWayEqualPercentageLinear valMix(
    redeclare package Medium = Medium,
    use_inputFilter=false,
    m_flow_nominal=1,
    l=0.05,
    dpValve_nominal=10000)
    "Valve with mixed equal percentage / linear characteristic"
...
equation
  ...
  connect(valMix.port_a, sou.ports[6]) annotation (Line(points={{0,-120},{-30,
          -120},{-30,-3.33333},{-50,-3.33333}}, color={0,127,255}));
  connect(valMix.port_b, sin.ports[6]) annotation (Line(points={{20,-120},{40,
          -120},{40,-3.33333},{52,-3.33333}}, color={0,127,255}));
  connect(valMix.y, y.y) annotation (Line(points={{10,-108},{10,-100},{-12,-100},
...
<ul>
<li>
January 29, 2018, by Filip Jorissen:<br/>
Added mixed valve.
</li>
<li>
