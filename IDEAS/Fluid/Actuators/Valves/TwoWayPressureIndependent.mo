...
equation
 ...
 if (dpFixed_nominal > Modelica.Constants.eps) then
   ...
   if homotopyInitialization then
     if from_dp then
         m_flow=homotopy(actual=IDEAS.Utilities.Math.Functions.regStep(
                            x=dp-dp_min,
                            y1= m_flow_set + l2*(dp-dp_min)/dp_nominal*m_flow_nominal,
                            y2= IDEAS.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
                                  dp=dp,
                                  k=k,
                                  m_flow_turbulent=m_flow_turbulent),
         ...
         dp=homotopy(actual=IDEAS.Utilities.Math.Functions.regStep(
                            x=m_flow-m_flow_set,
                            y1= dp_min + (m_flow-m_flow_set)/m_flow_nominal*dp_nominal/l2,
                            y2= IDEAS.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
                                  m_flow=m_flow,
                                  k=k,
                                  m_flow_turbulent=m_flow_turbulent),
     ...
     if from_dp then
       m_flow=IDEAS.Utilities.Math.Functions.regStep(
                            x=dp-dp_min,
                            y1= m_flow_set + l2*(dp-dp_min)/dp_nominal*m_flow_nominal,
                            y2= IDEAS.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
                                  dp=dp,
        ...
        dp=IDEAS.Utilities.Math.Functions.regStep(
                            x=m_flow-m_flow_set,
                            y1= dp_min + (m_flow-m_flow_set)/m_flow_nominal*dp_nominal/l2,
                            y2= IDEAS.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
                                  m_flow=m_flow,
