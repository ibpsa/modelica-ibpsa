...
model HANaturalCylinder "Test model for natural convection outside of a coil"
  ...
  IDEAS.Fluid.HeatExchangers.BaseClasses.HANaturalCylinder hANatCyl(redeclare
...
equation
  ...
  annotation ( __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/HANaturalCylinder.mos"
        "Simulate and plot"),
        experiment(Tolerance=1e-6, StopTime=250),
        Documentation(info="<html>
        <p>
        Test model for <a href=\"modelica://IDEAS.Fluid.HeatExchangers.BaseClasses.HANaturalCylinder\">
