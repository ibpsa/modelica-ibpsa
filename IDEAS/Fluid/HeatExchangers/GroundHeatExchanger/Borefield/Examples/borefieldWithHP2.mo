within IDEAS.Fluid.HeatExchangers.GroundHeatExchanger.Borefield.Examples;
model borefieldWithHP2
  ...
  Extras.GroundCoupledHeatPump groundCoupledHeatPump(lenSim=lenSim, redeclare
      Borefield.Data.BorefieldData.example bfData(geo(hBor=hBor,nbBh=nbBh,cooBh=cooBh),adv(hBor=hBor)))
