...
model Heating_Embedded_DHW_STS
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection[nZones] convectionTabs
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={192,58})));
  IDEAS.Fluid.HeatExchangers.Examples.BaseClasses.NakedTabs[nZones] nakedTabs(
  ...
  IDEAS.Fluid.HeatExchangers.RadiantSlab.EmbeddedPipe emission[nZones](
    redeclare each package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
  ...
  IDEAS.Controls.Control_fixme.Hyst_NoEvent_Var[nZones] heatingControl(each
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemHea_out(redeclare package Medium
      = Medium, m_flow_nominal=sum(m_flow_nominal))
  ...
  IDEAS.Fluid.Storage.StorageTank_OneIntHX tesTank(
    ...
    m_flow_nominal_HX=m_flow_nominal_stoHX) annotation (Placement(
        ...
        rotation=0,
        origin={-18,-20})));
  IDEAS.Fluid.Domestic_Hot_Water.DHW_ProfileReader dHW(
    TDHWSet=TDHWSet,
    TColdWaterNom=TColdWaterNom,
    profileType=3,
    redeclare package Medium = Medium,
    ...
    VDayAvg=sim.nOcc*0.045) annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-53,-19})));
  IDEAS.Fluid.FixedResistances.Pipe_Insulated pipeDHW(
    redeclare package Medium = Medium,
    m=1,
    UA=10,
    m_flow_nominal=m_flow_nominal_DHW)
  ...
  IDEAS.Fluid.Sources.FixedBoundary absolutePressure1(
    ...
    nPorts=1) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={2,-62})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemSto_top(redeclare package Medium
      = Medium, m_flow_nominal=sum(m_flow_nominal))
    "Temperature at the top outlet of the storage tank (port_a)"
    annotation (Placement(transformation(extent={{-30,-2},{-38,6}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemSto_bot(redeclare package Medium
      = Medium, m_flow_nominal=sum(m_flow_nominal))
    "Temperature at the bottom inlet of the storage tank (port_b)"
    annotation (Placement(transformation(extent={{-12,-54},{-22,-44}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemStoHX_out(redeclare package
