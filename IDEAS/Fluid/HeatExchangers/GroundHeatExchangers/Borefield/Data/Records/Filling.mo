...
record Filling "Thermal properties of the borehole filling material"
  ...
  parameter String pathMod = "IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield.Data.Records.Filling"
    "Modelica path of the record";
  parameter String pathCom = Modelica.Utilities.Files.loadResource("modelica://IDEAS/Fluid/HeatExchangers/GroundHeatExchangers/Borefield/Data/Records/Filling.mo")
