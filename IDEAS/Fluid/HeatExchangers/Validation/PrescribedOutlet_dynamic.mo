...
model PrescribedOutlet_dynamic
  ...
  extends IDEAS.Fluid.HeatExchangers.Validation.PrescribedOutlet(
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
    ...
    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/PrescribedOutlet_dynamic.mos"
        "Simulate and plot"),
