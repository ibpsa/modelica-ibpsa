within IDEAS.Fluid.BaseClasses.FlowModels.Examples;
...
__Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Examples/InverseFlowFunction.mos"
        "Simulate and plot"),
