...
protected
  model Chiller "Subsystem model with the chiller"
   ...
   replaceable package Medium2 = Modelica.Media.Interfaces.PartialMedium
    ...
    IDEAS.Fluid.Sources.FixedBoundary sin1(redeclare package Medium = Medium2, nPorts=1)
    ...
    IDEAS.Fluid.Sources.FixedBoundary sin2(redeclare package Medium = Medium2, nPorts=1)
