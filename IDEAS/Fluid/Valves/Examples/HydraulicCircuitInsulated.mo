...
model HydraulicCircuitInsulated
  import IDEAS;
...
public
  ...
  IDEAS.Fluid.FixedResistances.Pipe_Insulated pipe_HeatPort1(
                                                           redeclare package
      Medium = Medium, m_flow_nominal=1,
...
public
  ...
  IDEAS.Fluid.FixedResistances.Pipe_Insulated pipe_HeatPort4(
                                                           redeclare package
      Medium = Medium, m_flow_nominal=1,
    linearizeFlowResistance=true,
    m=1,
...
equation
  ...
  connect(pipe_HeatPort4.port_b, threeWayValveMotor2.port_a2) annotation (Line(
      points={{-100,-212},{-100,-218},{-2,-218},{-2,-190}},
      color={0,127,255},
      smooth=Smooth.None));
