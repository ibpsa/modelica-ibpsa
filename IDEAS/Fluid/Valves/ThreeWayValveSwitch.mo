...
public
  ...
  Modelica.Blocks.Interfaces.BooleanInput switch annotation (Placement(
        ...
        rotation=-90,
        origin={0,80})));
  Movers.Pump pump_option1(
    medium=medium,
    useInput=true,
    m_flowNom=m_flowNom,
    m=0.1,
    TInitial=293.15) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={0,-50})));
//protected
...
parameter Modelica.SIunits.MassFlowRate m_flowNom=100
  ...
  Thermal.Components.BaseClasses.MixingVolume mixingVolume(medium=medium, m=0.1)
