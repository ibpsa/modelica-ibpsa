...
record SandBox_Borefield
  ...
  extends
    IDEAS.Fluid.Geothermal.Borefields.Data.Borefield.Template(
      filDat=IDEAS.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Filling(),
      soiDat=IDEAS.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Soil(),
      conDat=IDEAS.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Configuration());
