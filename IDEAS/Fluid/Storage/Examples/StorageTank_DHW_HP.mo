...
model StorageTank_DHW_HP
  ...
  Fluid.Domestic_Hot_Water.DHW_RealInput dHW(medium=medium, TDHWSet=273.15 + 45)
    annotation (Placement(transformation(extent={{62,6},{82,26}})));
  Fluid.Production.HP_AirWater hP_AWMod(QNom=10000, medium=medium)
  ...
  Thermal.Control.Ctrl_Heating_TES HPControl(
    dTSafetyTop=3,
    dTHPTankSet=2,
    DHW=true,
    TSupNom=313.15,
  ...
  IDEAS.BaseClasses.AbsolutePressure absolutePressure(p=300000)
