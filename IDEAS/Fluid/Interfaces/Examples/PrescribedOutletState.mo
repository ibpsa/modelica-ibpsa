...
model PrescribedOutletState "Test model for prescribed outlet state"
  ...
  IDEAS.Fluid.Interfaces.PrescribedOutletState heaHigPow(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Interfaces.PrescribedOutletState cooLimPow(
    redeclare package Medium = Medium,
    Q_flow_maxCool=-1000,
    m_flow_small=1E-4*abs(m_flow_nominal),
    show_T=true,
  ...
  IDEAS.Fluid.Interfaces.PrescribedOutletState heaCooUnl(
    redeclare package Medium = Medium,
    m_flow_small=1E-4*abs(m_flow_nominal),
    show_T=true,
    m_flow_nominal=m_flow_nominal)
...
__Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/PrescribedOutletState.mos"
        "Simulate and plot"),
