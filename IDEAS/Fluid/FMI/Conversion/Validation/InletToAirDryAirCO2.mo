...
model InletToAirDryAirCO2
  ...
  extends IDEAS.Fluid.FMI.Conversion.Validation.InletToAirMoistAirCO2(
    redeclare package Medium = Modelica.Media.Air.SimpleAir(extraPropertiesNames={"CO2"}));
  annotation (Documentation(info="<html>
<p>
This validation test is identical to
<a href=\"modelica://IDEAS.Fluid.FMI.Conversion.Validation.InletToAirMoistAirCO2\">
IDEAS.Fluid.FMI.Conversion.Validation.InletToAirMoistAirCO2</a>
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirDryAirCO2.mos"
        "Simulate and plot"),
