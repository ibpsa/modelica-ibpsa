...
block HeaterCooler_T
  "Declaration of an FMU that exports an ideal heater or cooler with prescribed outlet temperature"
   extends IDEAS.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final IDEAS.Fluid.HeatExchangers.HeaterCooler_T com(
...
<a href=\"modelica://IDEAS.Fluid.HeatExchangers.HeaterCooler_T\">
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HeaterCooler_T.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
