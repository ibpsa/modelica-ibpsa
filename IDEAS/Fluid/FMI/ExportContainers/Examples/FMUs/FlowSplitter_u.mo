...
block FlowSplitter_u "Declaration of an FMU that exports a flow splitter"
   extends IDEAS.Fluid.FMI.FlowSplitter_u(
...
<a href=\"modelica://IDEAS.Fluid.FMI.FlowSplitter_u\">
IDEAS.Fluid.FMI.FlowSplitter_u</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/FlowSplitter_u.mos"
        "Export FMU"));
end FlowSplitter_u;
