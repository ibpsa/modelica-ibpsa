...
model LosslessPipe "Validation model for lossless pipe"
 ...
 package Medium = IDEAS.Media.Air "Medium model";
  ...
  IDEAS.Fluid.FixedResistances.LosslessPipe res(
    redeclare package Medium = Medium,
    show_T=true,
    m_flow_nominal=1)
    "Fixed resistance"
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/LosslessPipe.mos"
        "Simulate and plot"),
