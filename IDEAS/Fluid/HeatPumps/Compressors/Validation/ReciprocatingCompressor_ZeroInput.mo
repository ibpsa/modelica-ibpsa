within IDEAS.Fluid.HeatPumps.Compressors.Validation;
model ReciprocatingCompressor_ZeroInput
  extends Modelica.Icons.Example;
  IDEAS.Fluid.HeatPumps.Compressors.ReciprocatingCompressor com(
...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/Compressors/Validation/ReciprocatingCompressor_ZeroInput.mos"
        "Simulate and plot"),
    experiment(
