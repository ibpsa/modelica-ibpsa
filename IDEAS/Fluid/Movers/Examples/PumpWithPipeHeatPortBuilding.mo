...
model PumpWithPipeHeatPortBuilding "Example of how a pump can be used"
  import IDEAS;
  import Buildings;
...
//     annotation (__Dymola_choicesAllMatching=true);
  ...
  Buildings.Fluid.FixedResistances.Pipe               dpSta(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    dp_nominal=100,
...
equation
  ...
  connect(sine1.y, prescribedTemperature.T) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(prescribedTemperature.port, dpSta.heatPort) annotation (Line(
      points={{14,76},{30,76},{30,72},{42,72},{42,5}},
      color={191,0,0},
      smooth=Smooth.None));
...
end PumpWithPipeHeatPortBuilding;
