...
model ControlledFlowMachineDynamic
  ...
  extends IDEAS.Fluid.Movers.Examples.BaseClasses.ControlledFlowMachine(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Examples/ControlledFlowMachineDynamic.mos"
        "Simulate and plot"),
