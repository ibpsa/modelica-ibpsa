...
record VitoCal300GBWS301dotA29
  ...
  copData={{0, 268.15,273.15,275.15,283.15,288.15, 293.15, 298.15},
            {308.15, 3.7,4.83,5.06,6,7.01, 7.42, 7.76},
            {318.15, 3.13,3.6,3.82,4.69,5.36, 5.97, 6.62},
            {328.15, 2,2.68,2.86,3.59,4.06, 4.50, 4.94},
            {333.15, 2,2,2.34,3.11,3.54, 3.89, 4.26}},
  powerData={{0, 268.15,273.15,275.15,283.15,288.15, 298.15},
            {308.15, 6970, 5960, 6010, 6200, 6310, 6864},
            {318.15, 7850, 7790, 7780, 7730, 7690, 7627},
            {328.15, 9800, 9750, 9700, 9500, 9380, 9237},
            {333.15, 8300, 8300, 8600, 10300, 10390, 10169}});
