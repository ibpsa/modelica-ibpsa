...
model MixingVolumeTraceSubstanceReverseFlow
  ...
  extends
    IDEAS.Fluid.MixingVolumes.Validation.BaseClasses.MixingVolumeReverseFlow(
...
First implementation.
 ...
 __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeTraceSubstanceReverseFlow.mos"
        "Simulate and plot"),
