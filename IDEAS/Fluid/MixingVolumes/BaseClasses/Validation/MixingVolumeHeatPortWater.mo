...
model MixingVolumeHeatPortWater
  ...
  replaceable IDEAS.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort vol[nEle]
...
__Dymola_Commands(file=
  "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatPortWater.mos"
  "Simulate and plot"));
