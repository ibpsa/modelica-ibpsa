...
model SolarTime "Test model for solar time"
  ...
  IDEAS.BoundaryConditions.WeatherData.BaseClasses.SolarTime solTim
    "Block that computes the solar time"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  IDEAS.BoundaryConditions.WeatherData.BaseClasses.EquationOfTime eqnTim
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/SolarTime.mos"
        "Simulate and plot"));
end SolarTime;
