...
public
  IDEAS.BoundaryConditions.WeatherData.BaseClasses.CheckTemperature cheTemDryBul
    "Check dry bulb temperature "
    annotation (Placement(transformation(extent={{60,20},{80,40}})));
  IDEAS.BoundaryConditions.WeatherData.BaseClasses.CheckTemperature cheTemDewPoi
