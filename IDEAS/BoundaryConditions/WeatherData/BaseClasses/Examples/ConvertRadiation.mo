...
model ConvertRadiation "Test model for ConvertRadiation"
  ...
  IDEAS.BoundaryConditions.WeatherData.BaseClasses.ConvertRadiation conGloRad
    "Convert units for global horizontal radiation"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  IDEAS.BoundaryConditions.WeatherData.BaseClasses.ConvertRadiation conDifRad
