...
protected
  IDEAS.BoundaryConditions.Occupants.Components.BaseClasses.PredictedPercentageDissatisfied
    ppd "PPD calculated"
    annotation (Placement(transformation(extent={{60,-36},{80,-16}})));
  IDEAS.BoundaryConditions.Occupants.Components.BaseClasses.CloValue cloValue
    "clothing calculation"
    annotation (Placement(transformation(extent={{-54,60},{-34,80}})));
  IDEAS.BoundaryConditions.Occupants.Components.BaseClasses.CloTemperature cloTemperature(Linear=
        Linear) "clothing surface temperature"
    annotation (Placement(transformation(extent={{-26,26},{-6,46}})));
  IDEAS.BoundaryConditions.Occupants.Components.BaseClasses.PredictedMeanVote pmv(Linear=
        Linear) "pmv calculation"
