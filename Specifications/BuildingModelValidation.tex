...
\begin{figure}[ht]
\subfigure[Annual heating loads for the low mass and heavy mass buildings.]{\includegraphics[width=\textwidth]{figures/AH_BESTEST.png}\label{fig:AH_BESTEST}}
\subfigure[Annual sensible cooling loads for the low mass and heavy mass buildings.]{\includegraphics[width=\textwidth]{figures/AC_BESTEST.png}\label{fig:AC_BESTEST}}
...
\begin{figure}[ht]
\subfigure[Peak heating loads for the low mass and heavy mass buildings.]{\includegraphics[width=\textwidth]{figures/PH_BESTEST.png}\label{fig:PH_BESTEST}}
\subfigure[Peak sensible cooling loads for the low mass and heavy mass buildings.]{\includegraphics[width=\textwidth]{figures/PC_BESTEST.png}\label{fig:PC_BESTEST}}
