...
\lstdefinelanguage{modelica}{%
	...
	morekeywords=[3]{% functions										% keywords
		...
		initial,noEvent,pre,reinit,sample,sign,sin,sinh,tan,tanh,terminal,Real,SI,MSL},%
	comment=[l]//,% 											% comments
...
\lstset{%
	...
	aboveskip={\baselineskip},						% a bit of space above, the original was 1.5 time baselinskip
